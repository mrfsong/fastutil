...
public abstract class AbstractBooleanBigList extends AbstractBooleanCollection implements BooleanBigList , BooleanStack {
	 ...
	 */
	@Override
	public boolean addAll(final long index, final BooleanBigList l) { return addAll(index, (BooleanCollection)l); }
	 ...
	 */
	@Override
	public boolean addAll(final BooleanBigList l) { return addAll(size64(), l); }
