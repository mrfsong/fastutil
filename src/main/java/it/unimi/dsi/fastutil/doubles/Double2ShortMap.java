...
public interface Double2ShortMap extends Double2ShortFunction , Map<Double,Short> {
	...
	default short replace(final double key, final short value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default short computeIfAbsentNullable(final double key, final java.util.function.DoubleFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final short v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default short computeIfPresent(final double key, final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> remappingFunction) {
	...
	default short compute(final double key, final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default short merge(final double key, final short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
