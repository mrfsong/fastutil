...
public final class DoubleComparators {
	...
	protected static class OppositeComparator implements DoubleComparator , java.io.Serializable {
	 ...
	 protected OppositeComparator(final DoubleComparator c) { comparator = c; }

	 @Override
	 public final int compare(final double a, final double b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static DoubleComparator oppositeComparator(final DoubleComparator c) { return new OppositeComparator (c); }
