...
public final class Double2CharMaps {
	...
	public static class SynchronizedMap extends Double2CharFunctions.SynchronizedFunction implements Double2CharMap , java.io.Serializable {
	 ...
	 @Override
	 public char computeIfAbsentPartial(final double key, final Double2CharFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Double2CharFunctions.UnmodifiableFunction implements Double2CharMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Double2CharMap.Entry > double2CharEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.double2CharEntrySet()); return entries; }
	 ...
	 @Override
	 public char computeIfAbsentPartial(final double key, final Double2CharFunction mappingFunction) { throw new UnsupportedOperationException(); }
