...
public class Double2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	public boolean remove(final double k, final double v) {
	 ...
	 // The starting point.
	 if (( Double.doubleToLongBits(curr = key[pos = (int)it.unimi.dsi.fastutil.HashCommon.mix( Double.doubleToRawLongBits(k) ) & mask]) == 0 )) return false;
	 if (( Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) ) && ( Double.doubleToLongBits(v) == Double.doubleToLongBits(value[pos]) )) {
	  removeEntry(pos);
	  return true;
	 }
	 while(true) {
	...
	final class MapEntry implements Double2DoubleMap.Entry , Map.Entry<Double, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Double.doubleToLongBits(key[index]) == Double.doubleToLongBits((e.getKey()).doubleValue()) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Double.doubleToLongBits(k) == 0 )) return Double2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	  ...
	  // The starting point.
	  if (( Double.doubleToLongBits(curr = key[pos = (int)it.unimi.dsi.fastutil.HashCommon.mix( Double.doubleToRawLongBits(k) ) & mask]) == 0 )) return false;
	  if (( Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) )) return ( Double.doubleToLongBits(value[pos]) == Double.doubleToLongBits(v) );
	  // There's always an unused entry.
	  while(true) {
	   if (( Double.doubleToLongBits(curr = key[pos = (pos + 1) & mask]) == 0 )) return false;
	   if (( Double.doubleToLongBits(k) == Double.doubleToLongBits(curr) )) return ( Double.doubleToLongBits(value[pos]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractDoubleSet {
	 ...
	 @Override
	 public void clear() { Double2DoubleOpenHashMap.this.clear();}
	}
