...
public final class DoublePriorityQueues {
	...
	public static class SynchronizedPriorityQueue implements DoublePriorityQueue {
	 ...
	 @Override
	 public void enqueue(double x) { synchronized(sync) { q.enqueue(x); } }

	 @Override
	 public double dequeueDouble() { synchronized(sync) { return q.dequeueDouble(); } }

	 @Override
	 public double firstDouble() { synchronized(sync) { return q.firstDouble(); } }

	 @Override
	 public double lastDouble() { synchronized(sync) { return q.lastDouble(); } }
	 ...
	 @Override
	 public DoubleComparator comparator() { synchronized(sync) { return q.comparator(); } }
	 ...
	 @Deprecated
	 @Override
	 public Double dequeue() { synchronized(sync) { return q.dequeue(); } }

	 @Deprecated
	 @Override
	 public Double first() { synchronized(sync) { return q.first(); } }

	 @Deprecated
	 @Override
	 public Double last() { synchronized(sync) { return q.last(); } }
	 ...
	 */
	public static DoublePriorityQueue synchronize(final DoublePriorityQueue q) { return new SynchronizedPriorityQueue(q); }
	...
	public static DoublePriorityQueue synchronize(final DoublePriorityQueue q, final Object sync) { return new SynchronizedPriorityQueue(q, sync); }
