...
public class Double2ReferenceOpenHashMap <V> extends AbstractDouble2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Double2ReferenceMap.Entry <V>, Map.Entry<Double, V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Double.doubleToLongBits(key[index]) == Double.doubleToLongBits((e.getKey()).doubleValue()) ) && ( (value[index]) == ((e.getValue())) );
	 }

	 @Override
	 public int hashCode() {
	  return it.unimi.dsi.fastutil.HashCommon.double2int(key[index]) ^ ( (value[index]) == null ? 0 : System.identityHashCode(value[index]) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Double.doubleToLongBits(k) == 0 )) return Double2ReferenceOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractDoubleSet {
	 ...
	 @Override
	 public void clear() { Double2ReferenceOpenHashMap.this.clear();}
	}
