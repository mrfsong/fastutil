	...
	public static class BasicEntry <V> implements Double2ReferenceMap.Entry <V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Double2ReferenceMap.Entry) {
	   ...
	   return ( Double.doubleToLongBits(key) == Double.doubleToLongBits(e.getDoubleKey()) ) && ( (value) == (e.getValue()) );
	  }
	  ...
	  return ( Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double)(key)).doubleValue()) ) && ( (this.value) == ((value)) );
	 }
