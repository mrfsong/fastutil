...
public class Double2ShortOpenHashMap extends AbstractDouble2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Double2ShortMap.Entry , Map.Entry<Double, Short> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Double.doubleToLongBits(key[index]) == Double.doubleToLongBits((e.getKey()).doubleValue()) ) && ( (value[index]) == ((e.getValue()).shortValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Double.doubleToLongBits(k) == 0 )) return Double2ShortOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractDoubleSet {
	 ...
	 @Override
	 public void clear() { Double2ShortOpenHashMap.this.clear();}
	}
