...
public final class Double2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractDouble2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final double k) { return ((short)0); }
	...
	public static class Singleton extends AbstractDouble2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final double k) { return ( Double.doubleToLongBits(key) == Double.doubleToLongBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Double2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public Short apply(final Double key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public short put(final double k, final short v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public short get(final double k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public short remove(final double k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Double2ShortFunction synchronize(final Double2ShortFunction f) { return new SynchronizedFunction (f); }
	...
	public static Double2ShortFunction synchronize(final Double2ShortFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractDouble2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short get(final double k) { return function.get(k); }
	 ...
	 */
	public static Double2ShortFunction unmodifiable(final Double2ShortFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Double2ShortFunction {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Double key, final Short value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Double2ShortFunction primitive(final java.util.function.Function<? super Double, ? extends Short> f) {
	 ...
	 if (f instanceof Double2ShortFunction) return (Double2ShortFunction ) f;

	 if (f instanceof java.util.function.DoubleToIntFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.DoubleToIntFunction ) f).applyAsInt(key));
