...
public final class DoubleBigListIterators {
	 ...
	 */
	public static DoubleBigListIterator unmodifiable(final DoubleBigListIterator i) { return new UnmodifiableBigListIterator (i); }
	...
	public static class BigListIteratorListIterator implements DoubleBigListIterator {
	 ...
	 @Override
	 public void set(double ok) { i.set(ok); }

	 @Override
	 public void add(double ok) { i.add(ok); }
	  ...
	  */
	public static DoubleBigListIterator asBigListIterator(final DoubleListIterator i) { return new BigListIteratorListIterator (i); }
}
