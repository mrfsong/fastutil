...
public interface DoublePriorityQueue extends PriorityQueue<Double> {
	...
	default double lastDouble() { throw new UnsupportedOperationException(); }
	...
	@Deprecated
	@Override
	default void enqueue(final Double x) { enqueue(x.doubleValue()); }
	...
	@Deprecated
	@Override
	default Double dequeue() { return Double.valueOf(dequeueDouble()); }
	...
	@Deprecated
	@Override
	default Double first() { return Double.valueOf(firstDouble()); }
