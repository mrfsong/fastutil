...
public final class Double2ReferenceMaps {
	...
	public static <V> ObjectIterable<Double2ReferenceMap.Entry <V> > fastIterable(Double2ReferenceMap <V> map) {
	 ...
	 return entries instanceof Double2ReferenceMap.FastEntrySet ? new ObjectIterable<Double2ReferenceMap.Entry <V> >() {
	  public ObjectIterator<Double2ReferenceMap.Entry <V> > iterator() { return ((Double2ReferenceMap.FastEntrySet <V>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Double2ReferenceMap.Entry <V> > consumer) { ((Double2ReferenceMap.FastEntrySet <V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <V> extends Double2ReferenceFunctions.Singleton <V> implements Double2ReferenceMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractDouble2ReferenceMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <V> Double2ReferenceMap <V> singleton(final double key, V value) { return new Singleton <>(key, value); }
	...
	public static <V> Double2ReferenceMap <V> singleton(final Double key, final V value) { return new Singleton <>((key).doubleValue(), (value)); }
	...
	public static class SynchronizedMap <V> extends Double2ReferenceFunctions.SynchronizedFunction <V> implements Double2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.double2ReferenceEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public V computeIfAbsentPartial(final double key, final Double2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <V> Double2ReferenceMap <V> synchronize(final Double2ReferenceMap <V> m) { return new SynchronizedMap <>(m); }
	...
	public static <V> Double2ReferenceMap <V> synchronize(final Double2ReferenceMap <V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <V> extends Double2ReferenceFunctions.UnmodifiableFunction <V> implements Double2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final double key, final Double2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <V> Double2ReferenceMap <V> unmodifiable(final Double2ReferenceMap <V> m) { return new UnmodifiableMap <>(m); }
