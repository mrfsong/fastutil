...
public class Double2IntOpenHashMap extends AbstractDouble2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Double2IntMap.Entry , Map.Entry<Double, Integer> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Double.doubleToLongBits(key[index]) == Double.doubleToLongBits((e.getKey()).doubleValue()) ) && ( (value[index]) == ((e.getValue()).intValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Double.doubleToLongBits(k) == 0 )) return Double2IntOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractDoubleSet {
	 ...
	 @Override
	 public void clear() { Double2IntOpenHashMap.this.clear();}
	}
