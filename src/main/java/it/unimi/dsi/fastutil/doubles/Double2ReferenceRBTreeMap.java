...
public class Double2ReferenceRBTreeMap <V> extends AbstractDouble2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Double2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Double2ReferenceMap.Entry <V> > comparator = (Comparator<Double2ReferenceMap.Entry <V> >) (x, y) -> Double2ReferenceRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
	   ...
	   @Override
	   public void clear() { Double2ReferenceRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractDouble2ReferenceSortedMap <V> implements java.io.Serializable {
	 ...
	 public Submap(final double from, final boolean bottom, final double to, final boolean top) {
	  if (! bottom && ! top && Double2ReferenceRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Double2ReferenceMap.Entry <V> >() {
	    ...
	    @Override
	    public Comparator<? super Double2ReferenceMap.Entry <V> > comparator() { return Double2ReferenceRBTreeMap.this.double2ReferenceEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final double k) { return in( k) && Double2ReferenceRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Double2ReferenceRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Double2ReferenceRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
