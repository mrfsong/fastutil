...
public class DoubleOpenCustomHashSet extends AbstractDoubleSet implements java.io.Serializable, Cloneable, Hash {
	...
	public DoubleOpenCustomHashSet(final int expected, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final int expected, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final Collection<? extends Double> c, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final Collection<? extends Double> c, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final DoubleCollection c, final float f, it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	this(c.size(), f, strategy);
	 addAll(c);
	}
	/** Creates a new hash set  with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor
	...
	public DoubleOpenCustomHashSet(final DoubleCollection c, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public DoubleOpenCustomHashSet(final DoubleIterator i, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final DoubleIterator i, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final Iterator<?> i, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final Iterator<?> i, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final double[] a, final int offset, final int length, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final double[] a, final int offset, final int length, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public DoubleOpenCustomHashSet(final double[] a, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
	 ...
	 for(int i = size, pos; i-- != 0;) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) {
	   ...
	   if (! ( Double.doubleToLongBits(key[pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask]) == 0 ))
