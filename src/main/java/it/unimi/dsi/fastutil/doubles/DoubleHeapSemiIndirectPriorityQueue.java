...
public class DoubleHeapSemiIndirectPriorityQueue implements DoubleIndirectPriorityQueue {
	...
	@Override
	public void allChanged() { DoubleSemiIndirectHeaps.makeHeap(refArray, heap, size, c); }
	 ...
	 */
	@Override
	public int front(final int[] a) { return c == null ? DoubleSemiIndirectHeaps.front(refArray, heap, size, a) : DoubleSemiIndirectHeaps.front(refArray, heap, size, a, c); }
