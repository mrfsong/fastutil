...
public final class Double2ReferenceSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Double2ReferenceMap.Entry <V> > fastIterator(Double2ReferenceSortedMap <V> map) {
	 ...
	 return entries instanceof Double2ReferenceSortedMap.FastSortedEntrySet ? ((Double2ReferenceSortedMap.FastSortedEntrySet <V>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <V> ObjectBidirectionalIterable<Double2ReferenceMap.Entry <V> > fastIterable(Double2ReferenceSortedMap <V> map) {
	 final ObjectSortedSet<Double2ReferenceMap.Entry <V> > entries = map.double2ReferenceEntrySet();
	 return entries instanceof Double2ReferenceSortedMap.FastSortedEntrySet ? ((Double2ReferenceSortedMap.FastSortedEntrySet <V>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <V> extends Double2ReferenceMaps.Singleton <V> implements Double2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Double2ReferenceMap.Entry <V> >)entries; }
	...
	public static <V> Double2ReferenceSortedMap <V> singleton(final Double key, V value) { return new Singleton <>((key).doubleValue(), (value));}
	...
	public static <V> Double2ReferenceSortedMap <V> singleton(final Double key, V value, DoubleComparator comparator) { return new Singleton <>((key).doubleValue(), (value), comparator); }
	...
	public static class SynchronizedSortedMap <V> extends Double2ReferenceMaps.SynchronizedMap <V> implements Double2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Double2ReferenceSortedMap <V> subMap(final double from, final double to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Double2ReferenceSortedMap <V> headMap(final double to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Double2ReferenceSortedMap <V> tailMap(final double from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <V> Double2ReferenceSortedMap <V> synchronize(final Double2ReferenceSortedMap <V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <V> Double2ReferenceSortedMap <V> synchronize(final Double2ReferenceSortedMap <V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <V> extends Double2ReferenceMaps.UnmodifiableMap <V> implements Double2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Double2ReferenceSortedMap <V> subMap(final double from, final double to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Double2ReferenceSortedMap <V> headMap(final double to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Double2ReferenceSortedMap <V> tailMap(final double from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <V> Double2ReferenceSortedMap <V> unmodifiable(final Double2ReferenceSortedMap <V> m) { return new UnmodifiableSortedMap <>(m); }
}
