...
public interface DoubleBigListIterator extends DoubleBidirectionalIterator , BigListIterator<Double> {
	...
	default void set(@SuppressWarnings("unused") final double k) { throw new UnsupportedOperationException(); }
	...
	default void add(@SuppressWarnings("unused") final double k) { throw new UnsupportedOperationException(); }
