...
public final class Double2ShortSortedMaps {
	...
	public static class Singleton extends Double2ShortMaps.Singleton implements Double2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2ShortMap.Entry > double2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2ShortMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Double2ShortMap.Entry >)entries; }
	...
	public static Double2ShortSortedMap singleton(final Double key, Short value) { return new Singleton ((key).doubleValue(), (value).shortValue());}
	...
	public static Double2ShortSortedMap singleton(final Double key, Short value, DoubleComparator comparator) { return new Singleton ((key).doubleValue(), (value).shortValue(), comparator); }
