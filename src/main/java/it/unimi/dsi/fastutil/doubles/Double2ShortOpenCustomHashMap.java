...
public class Double2ShortOpenCustomHashMap extends AbstractDouble2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Double2ShortOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public Double2ShortOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public Double2ShortOpenCustomHashMap(final Map<? extends Double, ? extends Short> m, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public Double2ShortOpenCustomHashMap(final Map<? extends Double, ? extends Short> m, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public Double2ShortOpenCustomHashMap(final Double2ShortMap m, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Double2ShortOpenCustomHashMap(final Double2ShortMap m, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Double2ShortOpenCustomHashMap(final double[] k, final short[] v, final float f, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public Double2ShortOpenCustomHashMap(final double[] k, final short[] v, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfAbsentNullable(final double k, final java.util.function.DoubleFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfPresent(final double k, final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public short compute(final double k, final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public short merge(final double k, final short v, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Double2ShortMap.Entry , Map.Entry<Double, Short> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).doubleValue()) ) ) && ( (value[index]) == ((e.getValue()).shortValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Double2ShortMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Double2ShortMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Double2ShortOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Double2ShortMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractDouble2ShortMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Double.doubleToLongBits(key[pos]) == 0 )) consumer.accept(new AbstractDouble2ShortMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractDoubleSet {
	 ...
	 @Override
	 public void clear() { Double2ShortOpenCustomHashMap.this.clear();}
	}
