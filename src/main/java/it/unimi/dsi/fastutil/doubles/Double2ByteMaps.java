...
public final class Double2ByteMaps {
	...
	public static class SynchronizedMap extends Double2ByteFunctions.SynchronizedFunction implements Double2ByteMap , java.io.Serializable {
	 ...
	 @Override
	 public byte computeIfAbsentPartial(final double key, final Double2ByteFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Double2ByteFunctions.UnmodifiableFunction implements Double2ByteMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Double2ByteMap.Entry > double2ByteEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.double2ByteEntrySet()); return entries; }
	 ...
	 @Override
	 public byte computeIfAbsentPartial(final double key, final Double2ByteFunction mappingFunction) { throw new UnsupportedOperationException(); }
