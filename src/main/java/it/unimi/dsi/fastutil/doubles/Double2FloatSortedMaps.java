...
public final class Double2FloatSortedMaps {
	...
	public static class UnmodifiableSortedMap extends Double2FloatMaps.UnmodifiableMap implements Double2FloatSortedMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Double2FloatMap.Entry > double2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable(sortedMap.double2FloatEntrySet()); return (ObjectSortedSet<Double2FloatMap.Entry >)entries; }
