...
public class Double2ShortAVLTreeMap extends AbstractDouble2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Double2ShortMap.Entry > {
	 ...
	 @Override
	 public Double2ShortMap.Entry next() { return nextEntry(); }

	 @Override
	 public Double2ShortMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
	}
	...
	public ObjectSortedSet<Double2ShortMap.Entry > double2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Double2ShortMap.Entry >() {
	   final Comparator<? super Double2ShortMap.Entry > comparator = (Comparator<Double2ShortMap.Entry >) (x, y) -> Double2ShortAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());

	   @Override
	   public Comparator<? super Double2ShortMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Double2ShortMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Double2ShortMap.Entry > iterator(final Double2ShortMap.Entry from) { return new EntryIterator(from.getDoubleKey()); }
	   ...
	   @Override
	   public void clear() { Double2ShortAVLTreeMap.this.clear(); }

	   @Override
	   public Double2ShortMap.Entry first() { return firstEntry; }

	   @Override
	   public Double2ShortMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Double2ShortMap.Entry > subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry to) { return subMap(from.getDoubleKey(), to.getDoubleKey()).double2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Double2ShortMap.Entry > headSet(Double2ShortMap.Entry to) { return headMap(to.getDoubleKey()).double2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Double2ShortMap.Entry > tailSet(Double2ShortMap.Entry from) { return tailMap(from.getDoubleKey()).double2ShortEntrySet(); }
	  };
	...
	@Override
	public Double2ShortSortedMap headMap(double to) { return new Submap((0), true, to, false); }

	@Override
	public Double2ShortSortedMap tailMap(double from) { return new Submap(from, false, (0), true); }

	@Override
	public Double2ShortSortedMap subMap(double from, double to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractDouble2ShortSortedMap implements java.io.Serializable {
	 ...
	 public ObjectSortedSet<Double2ShortMap.Entry > double2ShortEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Double2ShortMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Double2ShortMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Double2ShortMap.Entry > iterator(final Double2ShortMap.Entry from) { return new SubmapEntryIterator(from.getDoubleKey()); }
	    @Override
	    public Comparator<? super Double2ShortMap.Entry > comparator() { return Double2ShortAVLTreeMap.this.double2ShortEntrySet().comparator(); }
	    @Override
