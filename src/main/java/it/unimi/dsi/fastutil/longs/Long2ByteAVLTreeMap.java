...
public class Long2ByteAVLTreeMap extends AbstractLong2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2ByteMap.Entry > {
	 ...
	 @Override
	 public Long2ByteMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2ByteMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry >() {
	   final Comparator<? super Long2ByteMap.Entry > comparator = (Comparator<Long2ByteMap.Entry >) (x, y) -> Long2ByteAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2ByteMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2ByteMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2ByteMap.Entry > iterator(final Long2ByteMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2ByteAVLTreeMap.this.clear(); }

	   @Override
	   public Long2ByteMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2ByteMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2ByteMap.Entry > subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2ByteEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2ByteMap.Entry > headSet(Long2ByteMap.Entry to) { return headMap(to.getLongKey()).long2ByteEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2ByteMap.Entry > tailSet(Long2ByteMap.Entry from) { return tailMap(from.getLongKey()).long2ByteEntrySet(); }
	  };
	...
	@Override
	public Long2ByteSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2ByteSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2ByteSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2ByteSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2ByteMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2ByteMap.Entry > iterator(final Long2ByteMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2ByteMap.Entry > comparator() { return Long2ByteAVLTreeMap.this.long2ByteEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2ByteAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2ByteAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
