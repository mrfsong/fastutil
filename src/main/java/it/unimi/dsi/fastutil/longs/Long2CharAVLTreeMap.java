...
public class Long2CharAVLTreeMap extends AbstractLong2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2CharMap.Entry > {
	 ...
	 @Override
	 public Long2CharMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2CharMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2CharMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry >() {
	   final Comparator<? super Long2CharMap.Entry > comparator = (Comparator<Long2CharMap.Entry >) (x, y) -> Long2CharAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2CharMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2CharMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2CharMap.Entry > iterator(final Long2CharMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2CharAVLTreeMap.this.clear(); }

	   @Override
	   public Long2CharMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2CharMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2CharMap.Entry > subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2CharMap.Entry > headSet(Long2CharMap.Entry to) { return headMap(to.getLongKey()).long2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2CharMap.Entry > tailSet(Long2CharMap.Entry from) { return tailMap(from.getLongKey()).long2CharEntrySet(); }
	  };
	...
	@Override
	public Long2CharSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2CharSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2CharSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2CharSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2CharMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2CharMap.Entry > iterator(final Long2CharMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2CharMap.Entry > comparator() { return Long2CharAVLTreeMap.this.long2CharEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2CharAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2CharAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
