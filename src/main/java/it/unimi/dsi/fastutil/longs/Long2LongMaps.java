...
public final class Long2LongMaps {
	...
	public static class SynchronizedMap extends Long2LongFunctions.SynchronizedFunction implements Long2LongMap , java.io.Serializable {
	 ...
	 @Override
	 public long computeIfAbsentPartial(final long key, final Long2LongFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Long2LongFunctions.UnmodifiableFunction implements Long2LongMap , java.io.Serializable {
	 ...
	 @Override
	 public long computeIfAbsentPartial(final long key, final Long2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }
