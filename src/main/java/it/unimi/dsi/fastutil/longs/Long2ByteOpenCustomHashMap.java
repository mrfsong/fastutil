...
public class Long2ByteOpenCustomHashMap extends AbstractLong2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Long2ByteOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ByteOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ByteOpenCustomHashMap(final Map<? extends Long, ? extends Byte> m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ByteOpenCustomHashMap(final Map<? extends Long, ? extends Byte> m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ByteOpenCustomHashMap(final Long2ByteMap m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Long2ByteOpenCustomHashMap(final Long2ByteMap m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Long2ByteOpenCustomHashMap(final long[] k, final byte[] v, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ByteOpenCustomHashMap(final long[] k, final byte[] v, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfPresent(final long k, final java.util.function.BiFunction<? super Long, ? super Byte, ? extends Byte> remappingFunction) {
	...
	final class MapEntry implements Long2ByteMap.Entry , Map.Entry<Long, Byte> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).longValue()) ) ) && ( (value[index]) == ((e.getValue()).byteValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Long2ByteMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Long2ByteMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Long2ByteOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Long2ByteMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractLong2ByteMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractLong2ByteMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2ByteOpenCustomHashMap.this.clear();}
	}
