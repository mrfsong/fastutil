...
public final class Long2ShortFunctions {
	...
	public static class Singleton extends AbstractLong2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public Short apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	...
	public static class PrimitiveFunction implements Long2ShortFunction {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Long key, final Short value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2ShortFunction primitive(final java.util.function.Function<? super Long, ? extends Short> f) {
	 ...
	 if (f instanceof Long2ShortFunction) return (Long2ShortFunction ) f;

	 if (f instanceof java.util.function.LongToIntFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.LongToIntFunction ) f).applyAsInt(key));
