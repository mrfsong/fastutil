...
public interface LongPriorityQueue extends PriorityQueue<Long> {
	...
	default long lastLong() { throw new UnsupportedOperationException(); }
	...
	@Deprecated
	@Override
	default void enqueue(final Long x) { enqueue(x.longValue()); }
	...
	@Deprecated
	@Override
	default Long dequeue() { return Long.valueOf(dequeueLong()); }
	...
	@Deprecated
	@Override
	default Long first() { return Long.valueOf(firstLong()); }
