...
public final class Long2DoubleFunctions {
	...
	public static class EmptyFunction extends AbstractLong2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double get(final long k) { return (0); }
	...
	public static class Singleton extends AbstractLong2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2DoubleFunction , java.io.Serializable {
	 ...
	 @Override
	 public Double apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public double put(final long k, final double v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public double get(final long k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public double remove(final long k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Long2DoubleFunction synchronize(final Long2DoubleFunction f) { return new SynchronizedFunction (f); }
	...
	public static Long2DoubleFunction synchronize(final Long2DoubleFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractLong2DoubleFunction implements java.io.Serializable {
	 ...
	 @Override
	 public double put(final long k, final double v) { throw new UnsupportedOperationException(); }

	 @Override
	 public double get(final long k) { return function.get(k); }

	 @Override
	 public double remove(final long k) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Long2DoubleFunction unmodifiable(final Long2DoubleFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Long2DoubleFunction {
	 ...
	 @Deprecated
	 @Override
	 public Double put(final Long key, final Double value) { throw new UnsupportedOperationException(); }
	}
