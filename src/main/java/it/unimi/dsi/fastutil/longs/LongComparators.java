...
public final class LongComparators {
	...
	protected static class OppositeComparator implements LongComparator , java.io.Serializable {
	 ...
	 protected OppositeComparator(final LongComparator c) { comparator = c; }

	 @Override
	 public final int compare(final long a, final long b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static LongComparator oppositeComparator(final LongComparator c) { return new OppositeComparator (c); }
