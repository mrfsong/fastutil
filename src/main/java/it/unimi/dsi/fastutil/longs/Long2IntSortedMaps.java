...
public final class Long2IntSortedMaps {
	...
	public static class Singleton extends Long2IntMaps.Singleton implements Long2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2IntMap.Entry > long2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2IntMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2IntMap.Entry >)entries; }
	...
	public static Long2IntSortedMap singleton(final Long key, Integer value) { return new Singleton ((key).longValue(), (value).intValue());}
	...
	public static Long2IntSortedMap singleton(final Long key, Integer value, LongComparator comparator) { return new Singleton ((key).longValue(), (value).intValue(), comparator); }
