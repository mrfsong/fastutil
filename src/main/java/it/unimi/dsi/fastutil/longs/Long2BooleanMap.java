...
public interface Long2BooleanMap extends Long2BooleanFunction , Map<Long,Boolean> {
	...
	default boolean replace(final long key, final boolean value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default boolean computeIfAbsentNullable(final long key, final java.util.function.LongFunction<? extends Boolean> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final boolean v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default boolean computeIfPresent(final long key, final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	default boolean compute(final long key, final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final boolean oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Boolean newValue = remappingFunction.apply(Long.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default boolean merge(final long key, final boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
