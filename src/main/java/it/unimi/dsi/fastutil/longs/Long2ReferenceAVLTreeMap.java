...
public class Long2ReferenceAVLTreeMap <V> extends AbstractLong2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2ReferenceMap.Entry <V> > {
	 ...
	 @Override
	 public Long2ReferenceMap.Entry <V> next() { return nextEntry(); }

	 @Override
	 public Long2ReferenceMap.Entry <V> previous() { return previousEntry(); }

	 @Override
	 public void set(Long2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2ReferenceMap.Entry <V> > long2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Long2ReferenceMap.Entry <V> > comparator = (Comparator<Long2ReferenceMap.Entry <V> >) (x, y) -> Long2ReferenceAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2ReferenceMap.Entry <V> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2ReferenceMap.Entry <V> > iterator(final Long2ReferenceMap.Entry <V> from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public Long2ReferenceMap.Entry <V> first() { return firstEntry; }

	   @Override
	   public Long2ReferenceMap.Entry <V> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2ReferenceMap.Entry <V> > subSet(Long2ReferenceMap.Entry <V> from, Long2ReferenceMap.Entry <V> to) { return subMap(from.getLongKey(), to.getLongKey()).long2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2ReferenceMap.Entry <V> > headSet(Long2ReferenceMap.Entry <V> to) { return headMap(to.getLongKey()).long2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2ReferenceMap.Entry <V> > tailSet(Long2ReferenceMap.Entry <V> from) { return tailMap(from.getLongKey()).long2ReferenceEntrySet(); }
	  };
	...
	@Override
	public Long2ReferenceSortedMap <V> headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2ReferenceSortedMap <V> tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2ReferenceSortedMap <V> subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2ReferenceSortedMap <V> implements java.io.Serializable {
	 ...
	 public ObjectSortedSet<Long2ReferenceMap.Entry <V> > long2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry <V> >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2ReferenceMap.Entry <V> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2ReferenceMap.Entry <V> > iterator(final Long2ReferenceMap.Entry <V> from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2ReferenceMap.Entry <V> > comparator() { return Long2ReferenceAVLTreeMap.this.long2ReferenceEntrySet().comparator(); }
	    @Override
