...
public class Long2BooleanRBTreeMap extends AbstractLong2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry >() {
	   final Comparator<? super Long2BooleanMap.Entry > comparator = (Comparator<Long2BooleanMap.Entry >) (x, y) -> Long2BooleanRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2BooleanRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2BooleanSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2BooleanMap.Entry > comparator() { return Long2BooleanRBTreeMap.this.long2BooleanEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2BooleanRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2BooleanRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2BooleanRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
