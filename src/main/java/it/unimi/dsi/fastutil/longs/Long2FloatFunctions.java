...
public final class Long2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractLong2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final long k) { return (0); }
	...
	public static class Singleton extends AbstractLong2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public double applyAsDouble(long operand) { synchronized(sync) { return function.applyAsDouble(operand); } }
	 ...
	 @Override
	 public Float apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public float put(final long k, final float v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public float get(final long k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public float remove(final long k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Long2FloatFunction synchronize(final Long2FloatFunction f) { return new SynchronizedFunction (f); }
	...
	public static Long2FloatFunction synchronize(final Long2FloatFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractLong2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float get(final long k) { return function.get(k); }
	 ...
	 */
	public static Long2FloatFunction unmodifiable(final Long2FloatFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Long2FloatFunction {
	 ...
	 @Deprecated
	 @Override
	 public Float put(final Long key, final Float value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2FloatFunction primitive(final java.util.function.Function<? super Long, ? extends Float> f) {
	 ...
	 if (f instanceof Long2FloatFunction) return (Long2FloatFunction ) f;

	 if (f instanceof java.util.function.LongToDoubleFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.LongToDoubleFunction ) f).applyAsDouble(key));
