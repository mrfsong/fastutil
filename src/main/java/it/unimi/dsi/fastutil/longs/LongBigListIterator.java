...
public interface LongBigListIterator extends LongBidirectionalIterator , BigListIterator<Long> {
	...
	default void set(@SuppressWarnings("unused") final long k) { throw new UnsupportedOperationException(); }
	...
	default void add(@SuppressWarnings("unused") final long k) { throw new UnsupportedOperationException(); }
