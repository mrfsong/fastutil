...
public class Long2ReferenceOpenHashMap <V> extends AbstractLong2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Long2ReferenceMap.Entry <V>, Map.Entry<Long, V> {
	 ...
	 @Override
	 public int hashCode() {
	  return it.unimi.dsi.fastutil.HashCommon.long2int(key[index]) ^ ( (value[index]) == null ? 0 : System.identityHashCode(value[index]) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (0) )) return Long2ReferenceOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2ReferenceOpenHashMap.this.clear();}
	}
