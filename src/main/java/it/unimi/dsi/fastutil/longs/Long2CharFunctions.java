...
public final class Long2CharFunctions {
	...
	public static class EmptyFunction extends AbstractLong2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final long k) { return ((char)0); }
	...
	public static class Singleton extends AbstractLong2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public Character apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public char put(final long k, final char v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public char get(final long k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public char remove(final long k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Long k, final Character v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Long2CharFunction synchronize(final Long2CharFunction f) { return new SynchronizedFunction (f); }
	...
	public static Long2CharFunction synchronize(final Long2CharFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractLong2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char get(final long k) { return function.get(k); }
	 ...
	 */
	public static Long2CharFunction unmodifiable(final Long2CharFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Long2CharFunction {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Long key, final Character value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2CharFunction primitive(final java.util.function.Function<? super Long, ? extends Character> f) {
	 ...
	 if (f instanceof Long2CharFunction) return (Long2CharFunction ) f;

	 if (f instanceof java.util.function.LongToIntFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.LongToIntFunction ) f).applyAsInt(key));
