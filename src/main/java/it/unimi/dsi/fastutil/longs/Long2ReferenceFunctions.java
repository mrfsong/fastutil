...
public final class Long2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public static <V> Long2ReferenceFunction <V> synchronize(final Long2ReferenceFunction <V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <V> Long2ReferenceFunction <V> synchronize(final Long2ReferenceFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 */
	public static <V> Long2ReferenceFunction <V> unmodifiable(final Long2ReferenceFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static <V> Long2ReferenceFunction <V> primitive(final java.util.function.Function<? super Long, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Long2ReferenceFunction) return (Long2ReferenceFunction <V>) f;
