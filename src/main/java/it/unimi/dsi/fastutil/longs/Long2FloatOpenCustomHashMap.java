...
public class Long2FloatOpenCustomHashMap extends AbstractLong2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Long2FloatMap.Entry , Map.Entry<Long, Float> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).longValue()) ) ) && ( Float.floatToIntBits(value[index]) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Long2FloatOpenCustomHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2FloatOpenCustomHashMap.this.clear();}
	}
