...
public final class Long2ReferenceSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Long2ReferenceMap.Entry <V> > fastIterator(Long2ReferenceSortedMap <V> map) {
	 ...
	 return entries instanceof Long2ReferenceSortedMap.FastSortedEntrySet ? ((Long2ReferenceSortedMap.FastSortedEntrySet <V>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <V> ObjectBidirectionalIterable<Long2ReferenceMap.Entry <V> > fastIterable(Long2ReferenceSortedMap <V> map) {
	 final ObjectSortedSet<Long2ReferenceMap.Entry <V> > entries = map.long2ReferenceEntrySet();
	 return entries instanceof Long2ReferenceSortedMap.FastSortedEntrySet ? ((Long2ReferenceSortedMap.FastSortedEntrySet <V>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <V> extends Long2ReferenceMaps.Singleton <V> implements Long2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ReferenceMap.Entry <V> > long2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2ReferenceMap.Entry <V> >)entries; }
	...
	public static <V> Long2ReferenceSortedMap <V> singleton(final Long key, V value) { return new Singleton <>((key).longValue(), (value));}
	...
	public static <V> Long2ReferenceSortedMap <V> singleton(final Long key, V value, LongComparator comparator) { return new Singleton <>((key).longValue(), (value), comparator); }
	...
	public static class SynchronizedSortedMap <V> extends Long2ReferenceMaps.SynchronizedMap <V> implements Long2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Long2ReferenceSortedMap <V> subMap(final long from, final long to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Long2ReferenceSortedMap <V> headMap(final long to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Long2ReferenceSortedMap <V> tailMap(final long from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <V> Long2ReferenceSortedMap <V> synchronize(final Long2ReferenceSortedMap <V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <V> Long2ReferenceSortedMap <V> synchronize(final Long2ReferenceSortedMap <V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <V> extends Long2ReferenceMaps.UnmodifiableMap <V> implements Long2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Long2ReferenceSortedMap <V> subMap(final long from, final long to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Long2ReferenceSortedMap <V> headMap(final long to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Long2ReferenceSortedMap <V> tailMap(final long from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <V> Long2ReferenceSortedMap <V> unmodifiable(final Long2ReferenceSortedMap <V> m) { return new UnmodifiableSortedMap <>(m); }
}
