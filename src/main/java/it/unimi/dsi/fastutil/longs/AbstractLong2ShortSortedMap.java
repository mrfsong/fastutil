...
public abstract class AbstractLong2ShortSortedMap extends AbstractLong2ShortMap implements Long2ShortSortedMap {
	...
	protected class KeySet extends AbstractLongSortedSet {
	 ...
	 @Override
	 public int size() { return AbstractLong2ShortSortedMap.this.size(); }

	 @Override
	 public void clear() { AbstractLong2ShortSortedMap.this.clear(); }

	 @Override
	 public LongComparator comparator() { return AbstractLong2ShortSortedMap.this.comparator(); }
	 ...
	 @Override
	 public LongBidirectionalIterator iterator(final long from) { return new KeySetIterator (long2ShortEntrySet().iterator(new BasicEntry (from, ((short)0)))); }

	 @Override
	 public LongBidirectionalIterator iterator() { return new KeySetIterator (Long2ShortSortedMaps.fastIterator(AbstractLong2ShortSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractShortCollection {
	 @Override
	 public ShortIterator iterator() { return new ValuesIterator (Long2ShortSortedMaps.fastIterator(AbstractLong2ShortSortedMap.this)); }
