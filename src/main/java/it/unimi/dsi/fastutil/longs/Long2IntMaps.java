...
public final class Long2IntMaps {
	...
	public static class SynchronizedMap extends Long2IntFunctions.SynchronizedFunction implements Long2IntMap , java.io.Serializable {
	 ...
	 @Override
	 public int computeIfAbsentPartial(final long key, final Long2IntFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Long2IntFunctions.UnmodifiableFunction implements Long2IntMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Long2IntMap.Entry > long2IntEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.long2IntEntrySet()); return entries; }
	 ...
	 @Override
	 public int computeIfAbsentPartial(final long key, final Long2IntFunction mappingFunction) { throw new UnsupportedOperationException(); }
