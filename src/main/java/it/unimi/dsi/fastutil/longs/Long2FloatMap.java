...
public interface Long2FloatMap extends Long2FloatFunction , Map<Long,Float> {
	...
	default float replace(final long key, final float value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default float computeIfAbsentNullable(final long key, final java.util.function.LongFunction<? extends Float> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final float v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default float computeIfPresent(final long key, final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> remappingFunction) {
	...
	default float compute(final long key, final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final float oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default float merge(final long key, final float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Float computeIfAbsent(final Long key, final java.util.function.Function<? super Long, ? extends Float> mappingFunction) {
