...
public final class Long2BooleanFunctions {
	...
	public static class Singleton extends AbstractLong2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean test(long operand) { synchronized(sync) { return function.test(operand); } }
	 ...
	 @Override
	 public Boolean apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	...
	public static class PrimitiveFunction implements Long2BooleanFunction {
	 ...
	 @Deprecated
	 @Override
	 public Boolean put(final Long key, final Boolean value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2BooleanFunction primitive(final java.util.function.Function<? super Long, ? extends Boolean> f) {
	 ...
	 if (f instanceof Long2BooleanFunction) return (Long2BooleanFunction ) f;
