...
public final class Long2ShortSortedMaps {
	...
	public static class Singleton extends Long2ShortMaps.Singleton implements Long2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ShortMap.Entry > long2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ShortMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2ShortMap.Entry >)entries; }
	...
	public static Long2ShortSortedMap singleton(final Long key, Short value) { return new Singleton ((key).longValue(), (value).shortValue());}
	...
	public static Long2ShortSortedMap singleton(final Long key, Short value, LongComparator comparator) { return new Singleton ((key).longValue(), (value).shortValue(), comparator); }
