...
public class Long2DoubleOpenHashMap extends AbstractLong2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Long2DoubleMap.Entry , Map.Entry<Long, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).longValue()) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (0) )) return Long2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2DoubleOpenHashMap.this.clear();}
	}
