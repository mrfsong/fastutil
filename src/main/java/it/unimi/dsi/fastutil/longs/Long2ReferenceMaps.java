...
public final class Long2ReferenceMaps {
	...
	public static class SynchronizedMap <V> extends Long2ReferenceFunctions.SynchronizedFunction <V> implements Long2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final long key, final Long2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap <V> extends Long2ReferenceFunctions.UnmodifiableFunction <V> implements Long2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Long2ReferenceMap.Entry <V> > long2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.long2ReferenceEntrySet()); return entries; }
	 ...
	 @Override
	 public V computeIfAbsentPartial(final long key, final Long2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <V> Long2ReferenceMap <V> unmodifiable(final Long2ReferenceMap <V> m) { return new UnmodifiableMap <>(m); }
