...
public class Long2LongOpenCustomHashMap extends AbstractLong2LongMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Long2LongOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2LongOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2LongOpenCustomHashMap(final Map<? extends Long, ? extends Long> m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2LongOpenCustomHashMap(final Map<? extends Long, ? extends Long> m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2LongOpenCustomHashMap(final Long2LongMap m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Long2LongOpenCustomHashMap(final Long2LongMap m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Long2LongOpenCustomHashMap(final long[] k, final long[] v, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2LongOpenCustomHashMap(final long[] k, final long[] v, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsentNullable(final long k, final java.util.function.LongFunction<? extends Long> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfPresent(final long k, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public long compute(final long k, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public long merge(final long k, final long v, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Long2LongMap.Entry , Map.Entry<Long, Long> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).longValue()) ) ) && ( (value[index]) == ((e.getValue()).longValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Long2LongMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Long2LongMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Long2LongOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Long2LongMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractLong2LongMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractLong2LongMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2LongOpenCustomHashMap.this.clear();}
	}
