...
public class Long2LongAVLTreeMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2LongMap.Entry > {
	 ...
	 @Override
	 public Long2LongMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2LongMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry >() {
	   final Comparator<? super Long2LongMap.Entry > comparator = (Comparator<Long2LongMap.Entry >) (x, y) -> Long2LongAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2LongMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2LongMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2LongMap.Entry > iterator(final Long2LongMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2LongAVLTreeMap.this.clear(); }

	   @Override
	   public Long2LongMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2LongMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2LongMap.Entry > subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2LongMap.Entry > headSet(Long2LongMap.Entry to) { return headMap(to.getLongKey()).long2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2LongMap.Entry > tailSet(Long2LongMap.Entry from) { return tailMap(from.getLongKey()).long2LongEntrySet(); }
	  };
	...
	@Override
	public Long2LongSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2LongSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2LongSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2LongSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2LongMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2LongMap.Entry > iterator(final Long2LongMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2LongMap.Entry > comparator() { return Long2LongAVLTreeMap.this.long2LongEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2LongAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2LongAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
