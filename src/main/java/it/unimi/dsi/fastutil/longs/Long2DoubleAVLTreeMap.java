...
public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractLong2DoubleMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key) == ((e.getKey()).longValue()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2DoubleMap.Entry > {
	 ...
	 @Override
	 public Long2DoubleMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2DoubleMap.Entry previous() { return previousEntry(); }
	...
	public ObjectSortedSet<Long2DoubleMap.Entry > long2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry >() {
	   final Comparator<? super Long2DoubleMap.Entry > comparator = (Comparator<Long2DoubleMap.Entry >) (x, y) -> Long2DoubleAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2DoubleMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2DoubleMap.Entry > iterator(final Long2DoubleMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2DoubleAVLTreeMap.this.clear(); }

	   @Override
	   public Long2DoubleMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2DoubleMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2DoubleMap.Entry > subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2DoubleMap.Entry > headSet(Long2DoubleMap.Entry to) { return headMap(to.getLongKey()).long2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2DoubleMap.Entry > tailSet(Long2DoubleMap.Entry from) { return tailMap(from.getLongKey()).long2DoubleEntrySet(); }
	  };
	...
	@Override
	public LongComparator comparator() { return actualComparator; }

	@Override
	public Long2DoubleSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2DoubleSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2DoubleSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2DoubleMap.Entry > long2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2DoubleMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2DoubleMap.Entry > iterator(final Long2DoubleMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2DoubleMap.Entry > comparator() { return Long2DoubleAVLTreeMap.this.long2DoubleEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2DoubleAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2DoubleAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }

	 private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Long2DoubleMap.Entry > {
	  SubmapEntryIterator() {}
	  SubmapEntryIterator(final long k) { super(k); }
