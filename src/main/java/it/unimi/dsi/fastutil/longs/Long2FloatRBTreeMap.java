...
public class Long2FloatRBTreeMap extends AbstractLong2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2FloatMap.Entry > long2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry >() {
	   final Comparator<? super Long2FloatMap.Entry > comparator = (Comparator<Long2FloatMap.Entry >) (x, y) -> Long2FloatRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2FloatRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2FloatMap.Entry > long2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2FloatMap.Entry > comparator() { return Long2FloatRBTreeMap.this.long2FloatEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2FloatRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2FloatRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2FloatRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
