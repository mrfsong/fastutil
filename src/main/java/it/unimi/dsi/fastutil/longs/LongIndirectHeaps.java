...
public final class LongIndirectHeaps {
	...
	public static int downHeap(final long[] refArray, final int[] heap, final int[] inv, final int size, int i, final LongComparator c) {
	 assert i < size;
	...
	public static int upHeap(final long[] refArray, final int[] heap, final int[] inv, final int size, int i, final LongComparator c) {
	 assert i < size;
	...
	public static void makeHeap(final long[] refArray, final int offset, final int length, final int[] heap, final int[] inv, final LongComparator c) {
	...
	public static void makeHeap(final long[] refArray, final int[] heap, final int[] inv, final int size, final LongComparator c) {
	 int i = size >>> 1;
