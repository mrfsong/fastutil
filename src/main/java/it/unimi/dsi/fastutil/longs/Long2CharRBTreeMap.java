...
public class Long2CharRBTreeMap extends AbstractLong2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry >() {
	   final Comparator<? super Long2CharMap.Entry > comparator = (Comparator<Long2CharMap.Entry >) (x, y) -> Long2CharRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2CharRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2CharSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2CharMap.Entry > comparator() { return Long2CharRBTreeMap.this.long2CharEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2CharRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2CharRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2CharRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
