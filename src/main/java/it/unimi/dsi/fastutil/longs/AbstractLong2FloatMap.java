...
public abstract class AbstractLong2FloatMap extends AbstractLong2FloatFunction implements Long2FloatMap , java.io.Serializable {
	...
	public static class BasicEntry implements Long2FloatMap.Entry {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Long2FloatMap.Entry) {
	   ...
	   return ( (key) == (e.getLongKey()) ) && ( Float.floatToIntBits(value) == Float.floatToIntBits(e.getFloatValue()) );
	  }
	  ...
	  return ( (this.key) == (((Long)(key)).longValue()) ) && ( Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)(value)).floatValue()) );
	 }
	...
	public LongSet keySet() {
	 return new AbstractLongSet () {
	   ...
	   @Override
	   public int size() { return AbstractLong2FloatMap.this.size(); }
	   @Override
	   public void clear() { AbstractLong2FloatMap.this.clear(); }
	   @Override
