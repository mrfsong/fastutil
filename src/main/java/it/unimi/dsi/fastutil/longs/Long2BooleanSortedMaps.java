...
public final class Long2BooleanSortedMaps {
	...
	public static class EmptySortedMap extends Long2BooleanMaps.EmptyMap implements Long2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() { return ObjectSortedSets.EMPTY_SET; }
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public ObjectSortedSet<Map.Entry<Long, Boolean>> entrySet() { return ObjectSortedSets.EMPTY_SET; }
	 ...
	 @Override
	 public Long2BooleanSortedMap subMap(final long from, final long to) { return EMPTY_MAP; }


	 @Override
	 public Long2BooleanSortedMap headMap(final long to) { return EMPTY_MAP; }


	 @Override
	 public Long2BooleanSortedMap tailMap(final long from) { return EMPTY_MAP; }
	 ...
	 @Deprecated
	 @Override
	 public Long2BooleanSortedMap headMap(Long oto) { return headMap((oto).longValue()); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Long2BooleanSortedMap tailMap(Long ofrom) { return tailMap((ofrom).longValue()); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Long2BooleanSortedMap subMap(Long ofrom, Long oto) { return subMap((ofrom).longValue(), (oto).longValue()); }
	...
	public static class Singleton extends Long2BooleanMaps.Singleton implements Long2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2BooleanMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2BooleanMap.Entry >)entries; }
	 ...
	 public ObjectSortedSet<Map.Entry<Long, Boolean>> entrySet() { return (ObjectSortedSet)long2BooleanEntrySet(); }
	 ...
	 @Override
	 public Long2BooleanSortedMap subMap(final long from, final long to) { if (compare(from, key) <= 0 && compare(key, to) < 0) return this; return EMPTY_MAP; }


	 @Override
	 public Long2BooleanSortedMap headMap(final long to) { if (compare(key, to) < 0) return this; return EMPTY_MAP; }


	 @Override
	 public Long2BooleanSortedMap tailMap(final long from) { if (compare(from, key) <= 0) return this; return EMPTY_MAP; }
	...
	public static Long2BooleanSortedMap singleton(final Long key, Boolean value) { return new Singleton ((key).longValue(), (value).booleanValue());}
	...
	public static Long2BooleanSortedMap singleton(final Long key, Boolean value, LongComparator comparator) { return new Singleton ((key).longValue(), (value).booleanValue(), comparator); }
	...
	public static class SynchronizedSortedMap extends Long2BooleanMaps.SynchronizedMap implements Long2BooleanSortedMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2BooleanEntrySet(), sync); return (ObjectSortedSet<Long2BooleanMap.Entry >)entries; }
	 ...
	 @Override
	 public Long2BooleanSortedMap subMap(final long from, final long to) { return new SynchronizedSortedMap (sortedMap.subMap(from, to), sync); }

	 @Override
	 public Long2BooleanSortedMap headMap(final long to) { return new SynchronizedSortedMap (sortedMap.headMap(to), sync); }

	 @Override
	 public Long2BooleanSortedMap tailMap(final long from) { return new SynchronizedSortedMap (sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static Long2BooleanSortedMap synchronize(final Long2BooleanSortedMap m) { return new SynchronizedSortedMap (m); }
	...
	public static Long2BooleanSortedMap synchronize(final Long2BooleanSortedMap m, final Object sync) { return new SynchronizedSortedMap (m, sync); }
	...
	public static class UnmodifiableSortedMap extends Long2BooleanMaps.UnmodifiableMap implements Long2BooleanSortedMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable(sortedMap.long2BooleanEntrySet()); return (ObjectSortedSet<Long2BooleanMap.Entry >)entries; }
	 ...
	 @Override
	 public Long2BooleanSortedMap subMap(final long from, final long to) { return new UnmodifiableSortedMap (sortedMap.subMap(from, to)); }

	 @Override
	 public Long2BooleanSortedMap headMap(final long to) { return new UnmodifiableSortedMap (sortedMap.headMap(to)); }

	 @Override
	 public Long2BooleanSortedMap tailMap(final long from) { return new UnmodifiableSortedMap (sortedMap.tailMap(from)); }
	 ...
	 */
	public static Long2BooleanSortedMap unmodifiable(final Long2BooleanSortedMap m) { return new UnmodifiableSortedMap (m); }
}
