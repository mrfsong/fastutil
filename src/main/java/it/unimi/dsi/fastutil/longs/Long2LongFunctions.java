...
public final class Long2LongFunctions {
	...
	public static class EmptyFunction extends AbstractLong2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long get(final long k) { return (0); }
	...
	public static class Singleton extends AbstractLong2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public long applyAsLong(long operand) { synchronized(sync) { return function.applyAsLong(operand); } }
	 ...
	 @Override
	 public Long apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public long put(final long k, final long v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public long get(final long k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public long remove(final long k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Long2LongFunction synchronize(final Long2LongFunction f) { return new SynchronizedFunction (f); }
	...
	public static Long2LongFunction synchronize(final Long2LongFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractLong2LongFunction implements java.io.Serializable {
	 ...
	 @Override
	 public long get(final long k) { return function.get(k); }
	 ...
	 */
	public static Long2LongFunction unmodifiable(final Long2LongFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Long2LongFunction {
	 ...
	 @Deprecated
	 @Override
	 public Long put(final Long key, final Long value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2LongFunction primitive(final java.util.function.Function<? super Long, ? extends Long> f) {
	 ...
	 if (f instanceof Long2LongFunction) return (Long2LongFunction ) f;
