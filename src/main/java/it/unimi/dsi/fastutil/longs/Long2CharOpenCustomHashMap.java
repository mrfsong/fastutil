...
public class Long2CharOpenCustomHashMap extends AbstractLong2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Long2CharOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2CharOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2CharOpenCustomHashMap(final Map<? extends Long, ? extends Character> m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2CharOpenCustomHashMap(final Map<? extends Long, ? extends Character> m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2CharOpenCustomHashMap(final Long2CharMap m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Long2CharOpenCustomHashMap(final Long2CharMap m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Long2CharOpenCustomHashMap(final long[] k, final char[] v, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2CharOpenCustomHashMap(final long[] k, final char[] v, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final long k, final java.util.function.LongFunction<? extends Character> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final long k, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final long k, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 final Character newValue = remappingFunction.apply(Long.valueOf(k), pos >= 0 ? Character.valueOf(value[pos]) : null);
	 if (newValue == null) {
	  if (pos >= 0) {
	   if (( strategy.equals( (k), (0) ) )) removeNullEntry();
	   else removeEntry(pos);
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final long k, final char v, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Long2CharMap.Entry , Map.Entry<Long, Character> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).longValue()) ) ) && ( (value[index]) == ((e.getValue()).charValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Long2CharMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Long2CharMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Long2CharOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Long2CharMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractLong2CharMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractLong2CharMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2CharOpenCustomHashMap.this.clear();}
	}
