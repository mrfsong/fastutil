...
public class Long2IntAVLTreeMap extends AbstractLong2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2IntMap.Entry > {
	 ...
	 @Override
	 public Long2IntMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2IntMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2IntMap.Entry > long2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2IntMap.Entry >() {
	   final Comparator<? super Long2IntMap.Entry > comparator = (Comparator<Long2IntMap.Entry >) (x, y) -> Long2IntAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2IntMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2IntMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2IntMap.Entry > iterator(final Long2IntMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2IntAVLTreeMap.this.clear(); }

	   @Override
	   public Long2IntMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2IntMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2IntMap.Entry > subSet(Long2IntMap.Entry from, Long2IntMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2IntMap.Entry > headSet(Long2IntMap.Entry to) { return headMap(to.getLongKey()).long2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2IntMap.Entry > tailSet(Long2IntMap.Entry from) { return tailMap(from.getLongKey()).long2IntEntrySet(); }
	  };
	...
	@Override
	public Long2IntSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2IntSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2IntSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2IntSortedMap implements java.io.Serializable {
	 ...
	 public ObjectSortedSet<Long2IntMap.Entry > long2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2IntMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2IntMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2IntMap.Entry > iterator(final Long2IntMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2IntMap.Entry > comparator() { return Long2IntAVLTreeMap.this.long2IntEntrySet().comparator(); }
	    @Override
