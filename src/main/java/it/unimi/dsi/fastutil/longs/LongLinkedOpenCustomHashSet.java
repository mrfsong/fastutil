...
public class LongLinkedOpenCustomHashSet extends AbstractLongSortedSet implements java.io.Serializable, Cloneable, Hash {
	...
	public LongLinkedOpenCustomHashSet(final int expected, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final int expected, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final Collection<? extends Long> c, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final Collection<? extends Long> c, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final LongCollection c, final float f, it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	this(c.size(), f, strategy);
	 addAll(c);
	}
	/** Creates a new hash set  with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor
	...
	public LongLinkedOpenCustomHashSet(final LongCollection c, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public LongLinkedOpenCustomHashSet(final LongIterator i, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final LongIterator i, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final Iterator<?> i, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final Iterator<?> i, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final long[] a, final int offset, final int length, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final long[] a, final int offset, final int length, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public LongLinkedOpenCustomHashSet(final long[] a, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
