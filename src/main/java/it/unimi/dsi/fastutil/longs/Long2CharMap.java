...
public interface Long2CharMap extends Long2CharFunction , Map<Long,Character> {
	...
	default char replace(final long key, final char value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default char computeIfAbsentNullable(final long key, final java.util.function.LongFunction<? extends Character> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final char v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default char computeIfPresent(final long key, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	default char compute(final long key, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final char oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Character newValue = remappingFunction.apply(Long.valueOf(key), contained ? Character.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default char merge(final long key, final char value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Long key, final java.util.function.Function<? super Long, ? extends Character> mappingFunction) {
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Long key, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Long key, final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Long key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
