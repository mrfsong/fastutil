...
public class Long2DoubleRBTreeMap extends AbstractLong2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2DoubleMap.Entry > long2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry >() {
	   final Comparator<? super Long2DoubleMap.Entry > comparator = (Comparator<Long2DoubleMap.Entry >) (x, y) -> Long2DoubleRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2DoubleRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2DoubleMap.Entry > long2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2DoubleMap.Entry > comparator() { return Long2DoubleRBTreeMap.this.long2DoubleEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2DoubleRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2DoubleRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2DoubleRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
