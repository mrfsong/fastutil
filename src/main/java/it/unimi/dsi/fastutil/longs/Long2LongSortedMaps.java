...
public final class Long2LongSortedMaps {
	...
	public static class Singleton extends Long2LongMaps.Singleton implements Long2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2LongMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2LongMap.Entry >)entries; }
	...
	public static Long2LongSortedMap singleton(final Long key, Long value) { return new Singleton ((key).longValue(), (value).longValue());}
	...
	public static Long2LongSortedMap singleton(final Long key, Long value, LongComparator comparator) { return new Singleton ((key).longValue(), (value).longValue(), comparator); }
