...
public abstract class AbstractLong2ReferenceSortedMap <V> extends AbstractLong2ReferenceMap <V> implements Long2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractLongSortedSet {
	 ...
	 @Override
	 public int size() { return AbstractLong2ReferenceSortedMap.this.size(); }

	 @Override
	 public void clear() { AbstractLong2ReferenceSortedMap.this.clear(); }

	 @Override
	 public LongComparator comparator() { return AbstractLong2ReferenceSortedMap.this.comparator(); }
	 ...
	 @Override
	 public LongBidirectionalIterator iterator(final long from) { return new KeySetIterator <>(long2ReferenceEntrySet().iterator(new BasicEntry <>(from, (null)))); }

	 @Override
	 public LongBidirectionalIterator iterator() { return new KeySetIterator <>(Long2ReferenceSortedMaps.fastIterator(AbstractLong2ReferenceSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <>(Long2ReferenceSortedMaps.fastIterator(AbstractLong2ReferenceSortedMap.this)); }
