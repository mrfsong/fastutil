...
public class Long2BooleanAVLTreeMap extends AbstractLong2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2BooleanMap.Entry > {
	 ...
	 @Override
	 public Long2BooleanMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2BooleanMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry >() {
	   final Comparator<? super Long2BooleanMap.Entry > comparator = (Comparator<Long2BooleanMap.Entry >) (x, y) -> Long2BooleanAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2BooleanMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2BooleanMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2BooleanMap.Entry > iterator(final Long2BooleanMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2BooleanAVLTreeMap.this.clear(); }

	   @Override
	   public Long2BooleanMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2BooleanMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2BooleanMap.Entry > subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2BooleanMap.Entry > headSet(Long2BooleanMap.Entry to) { return headMap(to.getLongKey()).long2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2BooleanMap.Entry > tailSet(Long2BooleanMap.Entry from) { return tailMap(from.getLongKey()).long2BooleanEntrySet(); }
	  };
	...
	@Override
	public Long2BooleanSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2BooleanSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2BooleanSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2BooleanSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2BooleanMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2BooleanMap.Entry > iterator(final Long2BooleanMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2BooleanMap.Entry > comparator() { return Long2BooleanAVLTreeMap.this.long2BooleanEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2BooleanAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2BooleanAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
