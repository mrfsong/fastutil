...
public class Long2ReferenceOpenCustomHashMap <V> extends AbstractLong2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Long2ReferenceOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ReferenceOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ReferenceOpenCustomHashMap(final Map<? extends Long, ? extends V> m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ReferenceOpenCustomHashMap(final Map<? extends Long, ? extends V> m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ReferenceOpenCustomHashMap(final Long2ReferenceMap <V> m, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Long2ReferenceOpenCustomHashMap(final Long2ReferenceMap <V> m, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Long2ReferenceOpenCustomHashMap(final long[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	public Long2ReferenceOpenCustomHashMap(final long[] k, final V[] v, final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 @Override
	 public ObjectIterator<Long2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Long2ReferenceMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Long2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Long2ReferenceMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractLong2ReferenceMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractLong2ReferenceMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 @Override
	 public void clear() { Long2ReferenceOpenCustomHashMap.this.clear();}
	}
