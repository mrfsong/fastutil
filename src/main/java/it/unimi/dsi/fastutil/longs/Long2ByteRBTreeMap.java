...
public class Long2ByteRBTreeMap extends AbstractLong2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry >() {
	   final Comparator<? super Long2ByteMap.Entry > comparator = (Comparator<Long2ByteMap.Entry >) (x, y) -> Long2ByteRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2ByteRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2ByteSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2ByteRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2ByteMap.Entry > comparator() { return Long2ByteRBTreeMap.this.long2ByteEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2ByteRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2ByteRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2ByteRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
