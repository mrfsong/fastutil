...
public class Long2FloatAVLTreeMap extends AbstractLong2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractLong2FloatMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key) == ((e.getKey()).longValue()) ) && ( Float.floatToIntBits(value) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2FloatMap.Entry > {
	 ...
	 @Override
	 public Long2FloatMap.Entry next() { return nextEntry(); }

	 @Override
	 public Long2FloatMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Long2FloatMap.Entry > long2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry >() {
	   final Comparator<? super Long2FloatMap.Entry > comparator = (Comparator<Long2FloatMap.Entry >) (x, y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());

	   @Override
	   public Comparator<? super Long2FloatMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Long2FloatMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Long2FloatMap.Entry > iterator(final Long2FloatMap.Entry from) { return new EntryIterator(from.getLongKey()); }
	   ...
	   @Override
	   public void clear() { Long2FloatAVLTreeMap.this.clear(); }

	   @Override
	   public Long2FloatMap.Entry first() { return firstEntry; }

	   @Override
	   public Long2FloatMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Long2FloatMap.Entry > subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) { return subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2FloatMap.Entry > headSet(Long2FloatMap.Entry to) { return headMap(to.getLongKey()).long2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Long2FloatMap.Entry > tailSet(Long2FloatMap.Entry from) { return tailMap(from.getLongKey()).long2FloatEntrySet(); }
	  };
	...
	@Override
	public Long2FloatSortedMap headMap(long to) { return new Submap((0), true, to, false); }

	@Override
	public Long2FloatSortedMap tailMap(long from) { return new Submap(from, false, (0), true); }

	@Override
	public Long2FloatSortedMap subMap(long from, long to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractLong2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2FloatMap.Entry > long2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Long2FloatMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Long2FloatMap.Entry > iterator(final Long2FloatMap.Entry from) { return new SubmapEntryIterator(from.getLongKey()); }
	    @Override
	    public Comparator<? super Long2FloatMap.Entry > comparator() { return Long2FloatAVLTreeMap.this.long2FloatEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2FloatAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2FloatAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
