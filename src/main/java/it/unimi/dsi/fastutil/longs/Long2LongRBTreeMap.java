...
public class Long2LongRBTreeMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry >() {
	   final Comparator<? super Long2LongMap.Entry > comparator = (Comparator<Long2LongMap.Entry >) (x, y) -> Long2LongRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	   ...
	   @Override
	   public void clear() { Long2LongRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractLong2LongSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final long from, final boolean bottom, final long to, final boolean top) {
	  if (! bottom && ! top && Long2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Long2LongMap.Entry > comparator() { return Long2LongRBTreeMap.this.long2LongEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final long k) { return in( k) && Long2LongRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Long2LongRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Long2LongRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
