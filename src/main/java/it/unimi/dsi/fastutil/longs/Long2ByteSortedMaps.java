...
public final class Long2ByteSortedMaps {
	...
	public static class Singleton extends Long2ByteMaps.Singleton implements Long2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ByteMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Long2ByteMap.Entry >)entries; }
	...
	public static Long2ByteSortedMap singleton(final Long key, Byte value) { return new Singleton ((key).longValue(), (value).byteValue());}
	...
	public static Long2ByteSortedMap singleton(final Long key, Byte value, LongComparator comparator) { return new Singleton ((key).longValue(), (value).byteValue(), comparator); }
