...
public final class Long2IntFunctions {
	...
	public static class EmptyFunction extends AbstractLong2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final long k) { return (0); }
	...
	public static class Singleton extends AbstractLong2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Long2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public Integer apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public int put(final long k, final int v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public int get(final long k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public int remove(final long k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Long k, final Integer v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Long2IntFunction synchronize(final Long2IntFunction f) { return new SynchronizedFunction (f); }
	...
	public static Long2IntFunction synchronize(final Long2IntFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractLong2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int put(final long k, final int v) { throw new UnsupportedOperationException(); }

	 @Override
	 public int get(final long k) { return function.get(k); }

	 @Override
	 public int remove(final long k) { throw new UnsupportedOperationException(); }
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Long k, final Integer v) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Long2IntFunction unmodifiable(final Long2IntFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Long2IntFunction {
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Long key, final Integer value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Long2IntFunction primitive(final java.util.function.Function<? super Long, ? extends Integer> f) {
	 ...
	 if (f instanceof Long2IntFunction) return (Long2IntFunction ) f;
