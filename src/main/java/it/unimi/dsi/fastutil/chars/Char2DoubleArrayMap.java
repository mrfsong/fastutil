...
public class Char2DoubleArrayMap extends AbstractChar2DoubleMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Char2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(Object o) {
	  ...
	  return Char2DoubleArrayMap.this.containsKey(k) && ( Double.doubleToLongBits(Char2DoubleArrayMap.this.get(k)) == Double.doubleToLongBits(((Double)(e.getValue())).doubleValue()) );
	 }
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( Double.doubleToLongBits(v) == Double.doubleToLongBits(Char2DoubleArrayMap.this.value[oldPos]) )) return false;
	...
	@Override
	public FastEntrySet char2DoubleEntrySet() { return new EntrySet(); }
