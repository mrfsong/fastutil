...
public final class Char2FloatMaps {
	...
	public static class SynchronizedMap extends Char2FloatFunctions.SynchronizedFunction implements Char2FloatMap , java.io.Serializable {
	 ...
	 @Override
	 public float computeIfAbsentPartial(final char key, final Char2FloatFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Char2FloatFunctions.UnmodifiableFunction implements Char2FloatMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Char2FloatMap.Entry > char2FloatEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.char2FloatEntrySet()); return entries; }
	 ...
	 @Override
	 public float computeIfAbsentPartial(final char key, final Char2FloatFunction mappingFunction) { throw new UnsupportedOperationException(); }
