...
public interface Int2DoubleMap extends Int2DoubleFunction , Map<Integer,Double> {
	...
	default double replace(final int key, final double value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default double computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Double> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final double v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default double computeIfPresent(final int key, final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	...
	default double compute(final int key, final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final double oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Double newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Double.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default double merge(final int key, final double value, final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Double computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	...
	@Deprecated
	@Override
	default Double compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	...
	@Deprecated
	@Override
	default Double merge(final Integer key, final Double value, final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
