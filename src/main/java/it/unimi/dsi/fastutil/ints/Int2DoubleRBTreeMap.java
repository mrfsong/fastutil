...
public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry >() {
	   final Comparator<? super Int2DoubleMap.Entry > comparator = (Comparator<Int2DoubleMap.Entry >) (x, y) -> Int2DoubleRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2DoubleRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Int2DoubleMap.Entry > comparator() { return Int2DoubleRBTreeMap.this.int2DoubleEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2DoubleRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2DoubleRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2DoubleRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
