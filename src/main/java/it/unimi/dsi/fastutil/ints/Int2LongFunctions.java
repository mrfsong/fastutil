...
public final class Int2LongFunctions {
	...
	public static class EmptyFunction extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long get(final int k) { return (0); }
	...
	public static class Singleton extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public long applyAsLong(int operand) { synchronized(sync) { return function.applyAsLong(operand); } }
	 ...
	 @Override
	 public Long apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public long put(final int k, final long v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public long get(final int k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public long remove(final int k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Long put(final Integer k, final Long v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Int2LongFunction synchronize(final Int2LongFunction f) { return new SynchronizedFunction (f); }
	...
	public static Int2LongFunction synchronize(final Int2LongFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractInt2LongFunction implements java.io.Serializable {
	 ...
	 @Override
	 public long put(final int k, final long v) { throw new UnsupportedOperationException(); }

	 @Override
	 public long get(final int k) { return function.get(k); }

	 @Override
	 public long remove(final int k) { throw new UnsupportedOperationException(); }
	 ...
	 @Deprecated
	 @Override
	 public Long put(final Integer k, final Long v) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Int2LongFunction unmodifiable(final Int2LongFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Int2LongFunction {
	 ...
	 @Deprecated
	 @Override
	 public Long put(final Integer key, final Long value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2LongFunction primitive(final java.util.function.Function<? super Integer, ? extends Long> f) {
	 ...
	 if (f instanceof Int2LongFunction) return (Int2LongFunction ) f;
