...
public final class Int2ByteFunctions {
	...
	public static class EmptyFunction extends AbstractInt2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final int k) { return ((byte)0); }
	...
	public static class Singleton extends AbstractInt2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2ByteFunction , java.io.Serializable {
	 ...
	 @Override
	 public Byte apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public byte put(final int k, final byte v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public byte get(final int k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public byte remove(final int k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Byte put(final Integer k, final Byte v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Int2ByteFunction synchronize(final Int2ByteFunction f) { return new SynchronizedFunction (f); }
	...
	public static Int2ByteFunction synchronize(final Int2ByteFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractInt2ByteFunction implements java.io.Serializable {
	 ...
	 @Override
	 public byte put(final int k, final byte v) { throw new UnsupportedOperationException(); }

	 @Override
	 public byte get(final int k) { return function.get(k); }

	 @Override
	 public byte remove(final int k) { throw new UnsupportedOperationException(); }
	 ...
	 @Deprecated
	 @Override
	 public Byte put(final Integer k, final Byte v) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Int2ByteFunction unmodifiable(final Int2ByteFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Int2ByteFunction {
	 ...
	 @Deprecated
	 @Override
	 public Byte put(final Integer key, final Byte value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2ByteFunction primitive(final java.util.function.Function<? super Integer, ? extends Byte> f) {
	 ...
	 if (f instanceof Int2ByteFunction) return (Int2ByteFunction ) f;

	 if (f instanceof java.util.function.IntUnaryOperator)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.IntUnaryOperator ) f).applyAsInt(key));
