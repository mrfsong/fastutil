...
public interface Int2ByteMap extends Int2ByteFunction , Map<Integer,Byte> {
	...
	default byte replace(final int key, final byte value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default byte computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final byte v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default byte computeIfPresent(final int key, final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
	...
	default byte compute(final int key, final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final byte oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default byte merge(final int key, final byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Byte computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
	...
	@Deprecated
	@Override
	default Byte compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
	...
	@Deprecated
	@Override
	default Byte merge(final Integer key, final Byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
