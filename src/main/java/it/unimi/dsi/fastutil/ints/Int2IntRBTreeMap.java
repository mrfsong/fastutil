...
public class Int2IntRBTreeMap extends AbstractInt2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2IntMap.Entry > int2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2IntMap.Entry >() {
	   final Comparator<? super Int2IntMap.Entry > comparator = (Comparator<Int2IntMap.Entry >) (x, y) -> Int2IntRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2IntRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2IntSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2IntMap.Entry > int2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2IntMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Int2IntMap.Entry > comparator() { return Int2IntRBTreeMap.this.int2IntEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2IntRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2IntRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2IntRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
