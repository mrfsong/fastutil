...
public final class IntComparators {
	...
	protected static class OppositeComparator implements IntComparator , java.io.Serializable {
	 ...
	 protected OppositeComparator(final IntComparator c) { comparator = c; }

	 @Override
	 public final int compare(final int a, final int b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static IntComparator oppositeComparator(final IntComparator c) { return new OppositeComparator (c); }
