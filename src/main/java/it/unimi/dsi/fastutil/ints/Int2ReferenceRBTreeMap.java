...
public class Int2ReferenceRBTreeMap <V> extends AbstractInt2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Int2ReferenceMap.Entry <V> > comparator = (Comparator<Int2ReferenceMap.Entry <V> >) (x, y) -> Int2ReferenceRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2ReferenceRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2ReferenceSortedMap <V> implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2ReferenceRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> >() {
	    ...
	    @Override
	    public Comparator<? super Int2ReferenceMap.Entry <V> > comparator() { return Int2ReferenceRBTreeMap.this.int2ReferenceEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2ReferenceRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2ReferenceRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2ReferenceRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
