...
public interface IntPriorityQueue extends PriorityQueue<Integer> {
	...
	default int lastInt() { throw new UnsupportedOperationException(); }
	...
	@Deprecated
	@Override
	default void enqueue(final Integer x) { enqueue(x.intValue()); }
	...
	@Deprecated
	@Override
	default Integer dequeue() { return Integer.valueOf(dequeueInt()); }
	...
	@Deprecated
	@Override
	default Integer first() { return Integer.valueOf(firstInt()); }
