...
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2CharOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2CharOpenCustomHashMap(final Map<? extends Integer, ? extends Character> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2CharOpenCustomHashMap(final Map<? extends Integer, ? extends Character> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2CharOpenCustomHashMap(final Int2CharMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2CharOpenCustomHashMap(final int[] k, final char[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2CharOpenCustomHashMap(final int[] k, final char[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final int k, final java.util.function.IntFunction<? extends Character> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final int k, final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final int k, final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 final Character newValue = remappingFunction.apply(Integer.valueOf(k), pos >= 0 ? Character.valueOf(value[pos]) : null);
	 if (newValue == null) {
	  if (pos >= 0) {
	   if (( strategy.equals( (k), (0) ) )) removeNullEntry();
	   else removeEntry(pos);
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final int k, final char v, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Int2CharMap.Entry , Map.Entry<Integer, Character> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( (value[index]) == ((e.getValue()).charValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2CharMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2CharMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2CharOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2CharMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2CharMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2CharMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2CharOpenCustomHashMap.this.clear();}
	}
