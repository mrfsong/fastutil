...
public class Int2DoubleOpenHashMap extends AbstractInt2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Int2DoubleMap.Entry , Map.Entry<Integer, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).intValue()) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (0) )) return Int2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2DoubleOpenHashMap.this.clear();}
	}
