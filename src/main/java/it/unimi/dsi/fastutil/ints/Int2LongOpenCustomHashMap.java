...
public class Int2LongOpenCustomHashMap extends AbstractInt2LongMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2LongOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2LongOpenCustomHashMap(final Map<? extends Integer, ? extends Long> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2LongOpenCustomHashMap(final Map<? extends Integer, ? extends Long> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2LongOpenCustomHashMap(final Int2LongMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2LongOpenCustomHashMap(final int[] k, final long[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2LongOpenCustomHashMap(final int[] k, final long[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsentNullable(final int k, final java.util.function.IntFunction<? extends Long> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfPresent(final int k, final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public long compute(final int k, final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public long merge(final int k, final long v, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Int2LongMap.Entry , Map.Entry<Integer, Long> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( (value[index]) == ((e.getValue()).longValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2LongMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2LongMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2LongOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2LongMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2LongMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2LongMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2LongOpenCustomHashMap.this.clear();}
	}
