...
public final class Int2ReferenceSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Int2ReferenceMap.Entry <V> > fastIterator(Int2ReferenceSortedMap <V> map) {
	 ...
	 return entries instanceof Int2ReferenceSortedMap.FastSortedEntrySet ? ((Int2ReferenceSortedMap.FastSortedEntrySet <V>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <V> ObjectBidirectionalIterable<Int2ReferenceMap.Entry <V> > fastIterable(Int2ReferenceSortedMap <V> map) {
	 final ObjectSortedSet<Int2ReferenceMap.Entry <V> > entries = map.int2ReferenceEntrySet();
	 return entries instanceof Int2ReferenceSortedMap.FastSortedEntrySet ? ((Int2ReferenceSortedMap.FastSortedEntrySet <V>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <V> extends Int2ReferenceMaps.Singleton <V> implements Int2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Int2ReferenceMap.Entry <V> >)entries; }
	...
	public static <V> Int2ReferenceSortedMap <V> singleton(final Integer key, V value) { return new Singleton <>((key).intValue(), (value));}
	...
	public static <V> Int2ReferenceSortedMap <V> singleton(final Integer key, V value, IntComparator comparator) { return new Singleton <>((key).intValue(), (value), comparator); }
	...
	public static class SynchronizedSortedMap <V> extends Int2ReferenceMaps.SynchronizedMap <V> implements Int2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Int2ReferenceSortedMap <V> subMap(final int from, final int to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Int2ReferenceSortedMap <V> headMap(final int to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Int2ReferenceSortedMap <V> tailMap(final int from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> subMap(final Integer from, final Integer to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> headMap(final Integer to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> tailMap(final Integer from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <V> Int2ReferenceSortedMap <V> synchronize(final Int2ReferenceSortedMap <V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <V> Int2ReferenceSortedMap <V> synchronize(final Int2ReferenceSortedMap <V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <V> extends Int2ReferenceMaps.UnmodifiableMap <V> implements Int2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Int2ReferenceSortedMap <V> subMap(final int from, final int to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Int2ReferenceSortedMap <V> headMap(final int to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Int2ReferenceSortedMap <V> tailMap(final int from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> subMap(final Integer from, final Integer to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> headMap(final Integer to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Int2ReferenceSortedMap <V> tailMap(final Integer from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <V> Int2ReferenceSortedMap <V> unmodifiable(final Int2ReferenceSortedMap <V> m) { return new UnmodifiableSortedMap <>(m); }
}
