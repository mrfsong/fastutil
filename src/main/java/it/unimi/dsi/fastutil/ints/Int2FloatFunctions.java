...
public final class Int2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractInt2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final int k) { return (0); }
	...
	public static class Singleton extends AbstractInt2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public Float apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public float put(final int k, final float v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public float get(final int k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public float remove(final int k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Float put(final Integer k, final Float v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Int2FloatFunction synchronize(final Int2FloatFunction f) { return new SynchronizedFunction (f); }
	...
	public static Int2FloatFunction synchronize(final Int2FloatFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractInt2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float put(final int k, final float v) { throw new UnsupportedOperationException(); }

	 @Override
	 public float get(final int k) { return function.get(k); }

	 @Override
	 public float remove(final int k) { throw new UnsupportedOperationException(); }
	 ...
	 @Deprecated
	 @Override
	 public Float put(final Integer k, final Float v) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Int2FloatFunction unmodifiable(final Int2FloatFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Int2FloatFunction {
	 ...
	 @Deprecated
	 @Override
	 public Float put(final Integer key, final Float value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2FloatFunction primitive(final java.util.function.Function<? super Integer, ? extends Float> f) {
	 ...
	 if (f instanceof Int2FloatFunction) return (Int2FloatFunction ) f;
