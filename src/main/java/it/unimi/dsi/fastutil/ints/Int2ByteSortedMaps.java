...
public final class Int2ByteSortedMaps {
	...
	public static class Singleton extends Int2ByteMaps.Singleton implements Int2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2ByteMap.Entry > int2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ByteMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Int2ByteMap.Entry >)entries; }
	...
	public static Int2ByteSortedMap singleton(final Integer key, Byte value) { return new Singleton ((key).intValue(), (value).byteValue());}
	...
	public static Int2ByteSortedMap singleton(final Integer key, Byte value, IntComparator comparator) { return new Singleton ((key).intValue(), (value).byteValue(), comparator); }
