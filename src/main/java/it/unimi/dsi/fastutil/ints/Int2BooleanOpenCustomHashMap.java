...
public class Int2BooleanOpenCustomHashMap extends AbstractInt2BooleanMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2BooleanOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2BooleanOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2BooleanOpenCustomHashMap(final Map<? extends Integer, ? extends Boolean> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2BooleanOpenCustomHashMap(final Map<? extends Integer, ? extends Boolean> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2BooleanOpenCustomHashMap(final Int2BooleanMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2BooleanOpenCustomHashMap(final Int2BooleanMap m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Int2BooleanOpenCustomHashMap(final int[] k, final boolean[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2BooleanOpenCustomHashMap(final int[] k, final boolean[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsentNullable(final int k, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfPresent(final int k, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean compute(final int k, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 final Boolean newValue = remappingFunction.apply(Integer.valueOf(k), pos >= 0 ? Boolean.valueOf(value[pos]) : null);
	 if (newValue == null) {
	  if (pos >= 0) {
	   if (( strategy.equals( (k), (0) ) )) removeNullEntry();
	   else removeEntry(pos);
	...
	/** {@inheritDoc} */
	@Override
	public boolean merge(final int k, final boolean v, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Int2BooleanMap.Entry , Map.Entry<Integer, Boolean> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( (value[index]) == ((e.getValue()).booleanValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2BooleanMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2BooleanMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2BooleanOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2BooleanMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2BooleanMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2BooleanMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2BooleanOpenCustomHashMap.this.clear();}
	}
