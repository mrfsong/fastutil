...
public final class Int2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractInt2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final int k) { return ((short)0); }
	...
	public static class Singleton extends AbstractInt2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public Short apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public short put(final int k, final short v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public short get(final int k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public short remove(final int k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Integer k, final Short v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Int2ShortFunction synchronize(final Int2ShortFunction f) { return new SynchronizedFunction (f); }
	...
	public static Int2ShortFunction synchronize(final Int2ShortFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractInt2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short get(final int k) { return function.get(k); }
	 ...
	 */
	public static Int2ShortFunction unmodifiable(final Int2ShortFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Int2ShortFunction {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Integer key, final Short value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2ShortFunction primitive(final java.util.function.Function<? super Integer, ? extends Short> f) {
	 ...
	 if (f instanceof Int2ShortFunction) return (Int2ShortFunction ) f;
