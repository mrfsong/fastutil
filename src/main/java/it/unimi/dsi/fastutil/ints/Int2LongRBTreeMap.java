...
public class Int2LongRBTreeMap extends AbstractInt2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2LongMap.Entry > int2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2LongMap.Entry >() {
	   final Comparator<? super Int2LongMap.Entry > comparator = (Comparator<Int2LongMap.Entry >) (x, y) -> Int2LongRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2LongRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2LongSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2LongRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2LongMap.Entry > int2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2LongMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Int2LongMap.Entry > comparator() { return Int2LongRBTreeMap.this.int2LongEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2LongRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2LongRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2LongRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
