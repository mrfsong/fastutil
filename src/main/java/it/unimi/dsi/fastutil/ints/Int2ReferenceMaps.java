...
public final class Int2ReferenceMaps {
	...
	public static class SynchronizedMap <V> extends Int2ReferenceFunctions.SynchronizedFunction <V> implements Int2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final int key, final Int2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap <V> extends Int2ReferenceFunctions.UnmodifiableFunction <V> implements Int2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.int2ReferenceEntrySet()); return entries; }
	 ...
	 @Override
	 public V computeIfAbsentPartial(final int key, final Int2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <V> Int2ReferenceMap <V> unmodifiable(final Int2ReferenceMap <V> m) { return new UnmodifiableMap <>(m); }
