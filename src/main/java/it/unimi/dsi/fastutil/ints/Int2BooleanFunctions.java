...
public final class Int2BooleanFunctions {
	...
	public static class Singleton extends AbstractInt2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public Boolean apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	...
	public static class PrimitiveFunction implements Int2BooleanFunction {
	 ...
	 @Deprecated
	 @Override
	 public Boolean put(final Integer key, final Boolean value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2BooleanFunction primitive(final java.util.function.Function<? super Integer, ? extends Boolean> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Int2BooleanFunction) return (Int2BooleanFunction ) f;
