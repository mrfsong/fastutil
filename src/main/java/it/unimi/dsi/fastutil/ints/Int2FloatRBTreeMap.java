...
public class Int2FloatRBTreeMap extends AbstractInt2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2FloatMap.Entry > int2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry >() {
	   final Comparator<? super Int2FloatMap.Entry > comparator = (Comparator<Int2FloatMap.Entry >) (x, y) -> Int2FloatRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2FloatRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2FloatSortedMap implements java.io.Serializable {
	 ...
	 public ObjectSortedSet<Int2FloatMap.Entry > int2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Int2FloatMap.Entry > comparator() { return Int2FloatRBTreeMap.this.int2FloatEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2FloatRBTreeMap.this.containsKey(k); }
