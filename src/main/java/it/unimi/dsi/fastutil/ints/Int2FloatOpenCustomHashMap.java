...
public class Int2FloatOpenCustomHashMap extends AbstractInt2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2FloatOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2FloatOpenCustomHashMap(final Map<? extends Integer, ? extends Float> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2FloatOpenCustomHashMap(final Map<? extends Integer, ? extends Float> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2FloatOpenCustomHashMap(final Int2FloatMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2FloatOpenCustomHashMap(final Int2FloatMap m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Int2FloatOpenCustomHashMap(final int[] k, final float[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2FloatOpenCustomHashMap(final int[] k, final float[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public boolean containsValue(final float v) {
	 ...
	 for(int i = n; i-- != 0;) if (! ( (key[i]) == (0) ) && ( Float.floatToIntBits(value[i]) == Float.floatToIntBits(v) )) return true;
	 return false;
	}
	...
	/** {@inheritDoc} */
	@Override
	public float computeIfAbsentNullable(final int k, final java.util.function.IntFunction<? extends Float> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public float computeIfPresent(final int k, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public float compute(final int k, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public float merge(final int k, final float v, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Int2FloatMap.Entry , Map.Entry<Integer, Float> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( Float.floatToIntBits(value[index]) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2FloatMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2FloatMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2FloatOpenCustomHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	 ...
	 public void forEach(final Consumer<? super Int2FloatMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2FloatMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2FloatMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2FloatOpenCustomHashMap.this.clear();}
	}
