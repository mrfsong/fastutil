...
public abstract class AbstractInt2ReferenceSortedMap <V> extends AbstractInt2ReferenceMap <V> implements Int2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractIntSortedSet {
	 ...
	 @Override
	 public IntBidirectionalIterator iterator(final int from) { return new KeySetIterator <>(int2ReferenceEntrySet().iterator(new BasicEntry <>(from, (null)))); }

	 @Override
	 public IntBidirectionalIterator iterator() { return new KeySetIterator <>(Int2ReferenceSortedMaps.fastIterator(AbstractInt2ReferenceSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <>(Int2ReferenceSortedMaps.fastIterator(AbstractInt2ReferenceSortedMap.this)); }
