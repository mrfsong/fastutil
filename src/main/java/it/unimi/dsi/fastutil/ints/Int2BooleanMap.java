...
public interface Int2BooleanMap extends Int2BooleanFunction , Map<Integer,Boolean> {
	...
	default boolean replace(final int key, final boolean value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default boolean computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final boolean v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default boolean computeIfPresent(final int key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	default boolean compute(final int key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final boolean oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Boolean newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default boolean merge(final int key, final boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Boolean computeIfAbsent(final Integer key, final java.util.function.Function<? super Integer, ? extends Boolean> mappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean merge(final Integer key, final Boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
