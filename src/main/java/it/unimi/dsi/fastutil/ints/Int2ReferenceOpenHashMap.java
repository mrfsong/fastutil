...
public class Int2ReferenceOpenHashMap <V> extends AbstractInt2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (0) )) return Int2ReferenceOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2ReferenceOpenHashMap.this.clear();}
	}
