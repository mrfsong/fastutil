...
public final class Int2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractInt2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <V> extends AbstractInt2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public static <V> Int2ReferenceFunction <V> synchronize(final Int2ReferenceFunction <V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <V> Int2ReferenceFunction <V> synchronize(final Int2ReferenceFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <V> extends AbstractInt2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 */
	public static <V> Int2ReferenceFunction <V> unmodifiable(final Int2ReferenceFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static <V> Int2ReferenceFunction <V> primitive(final java.util.function.Function<? super Integer, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Int2ReferenceFunction) return (Int2ReferenceFunction <V>) f;
