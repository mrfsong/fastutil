...
public class Int2ReferenceAVLTreeMap <V> extends AbstractInt2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2ReferenceMap.Entry <V> > {
	 ...
	 @Override
	 public Int2ReferenceMap.Entry <V> next() { return nextEntry(); }

	 @Override
	 public Int2ReferenceMap.Entry <V> previous() { return previousEntry(); }

	 @Override
	 public void set(Int2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Int2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Int2ReferenceMap.Entry <V> > comparator = (Comparator<Int2ReferenceMap.Entry <V> >) (x, y) -> Int2ReferenceAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());

	   @Override
	   public Comparator<? super Int2ReferenceMap.Entry <V> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Int2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Int2ReferenceMap.Entry <V> > iterator(final Int2ReferenceMap.Entry <V> from) { return new EntryIterator(from.getIntKey()); }
	   ...
	   @Override
	   public void clear() { Int2ReferenceAVLTreeMap.this.clear(); }

	   @Override
	   public Int2ReferenceMap.Entry <V> first() { return firstEntry; }

	   @Override
	   public Int2ReferenceMap.Entry <V> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Int2ReferenceMap.Entry <V> > subSet(Int2ReferenceMap.Entry <V> from, Int2ReferenceMap.Entry <V> to) { return subMap(from.getIntKey(), to.getIntKey()).int2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Int2ReferenceMap.Entry <V> > headSet(Int2ReferenceMap.Entry <V> to) { return headMap(to.getIntKey()).int2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Int2ReferenceMap.Entry <V> > tailSet(Int2ReferenceMap.Entry <V> from) { return tailMap(from.getIntKey()).int2ReferenceEntrySet(); }
	  };
	...
	@Override
	public Int2ReferenceSortedMap <V> headMap(int to) { return new Submap((0), true, to, false); }

	@Override
	public Int2ReferenceSortedMap <V> tailMap(int from) { return new Submap(from, false, (0), true); }

	@Override
	public Int2ReferenceSortedMap <V> subMap(int from, int to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractInt2ReferenceSortedMap <V> implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> >() {
	    @Override
	    public ObjectBidirectionalIterator<Int2ReferenceMap.Entry <V> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Int2ReferenceMap.Entry <V> > iterator(final Int2ReferenceMap.Entry <V> from) { return new SubmapEntryIterator(from.getIntKey()); }
	    @Override
	    public Comparator<? super Int2ReferenceMap.Entry <V> > comparator() { return Int2ReferenceAVLTreeMap.this.int2ReferenceEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
