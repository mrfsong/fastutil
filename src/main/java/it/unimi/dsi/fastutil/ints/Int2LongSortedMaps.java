...
public final class Int2LongSortedMaps {
	...
	public static class Singleton extends Int2LongMaps.Singleton implements Int2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2LongMap.Entry > int2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2LongMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Int2LongMap.Entry >)entries; }
	...
	public static Int2LongSortedMap singleton(final Integer key, Long value) { return new Singleton ((key).intValue(), (value).longValue());}
	...
	public static Int2LongSortedMap singleton(final Integer key, Long value, IntComparator comparator) { return new Singleton ((key).intValue(), (value).longValue(), comparator); }
