...
public class IntHeapSemiIndirectPriorityQueue implements IntIndirectPriorityQueue {
	...
	@Override
	public void allChanged() { IntSemiIndirectHeaps.makeHeap(refArray, heap, size, c); }
	 ...
	 */
	@Override
	public int front(final int[] a) { return c == null ? IntSemiIndirectHeaps.front(refArray, heap, size, a) : IntSemiIndirectHeaps.front(refArray, heap, size, a, c); }
