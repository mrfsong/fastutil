...
public final class Int2BooleanMaps {
	...
	public static class SynchronizedMap extends Int2BooleanFunctions.SynchronizedFunction implements Int2BooleanMap , java.io.Serializable {
	 ...
	 @Override
	 public boolean computeIfAbsentPartial(final int key, final Int2BooleanFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Int2BooleanFunctions.UnmodifiableFunction implements Int2BooleanMap , java.io.Serializable {
	 ...
	 @Override
	 public boolean computeIfAbsentPartial(final int key, final Int2BooleanFunction mappingFunction) { throw new UnsupportedOperationException(); }
