...
public class Int2IntOpenCustomHashMap extends AbstractInt2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2IntOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2IntOpenCustomHashMap(final Map<? extends Integer, ? extends Integer> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2IntOpenCustomHashMap(final Map<? extends Integer, ? extends Integer> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2IntOpenCustomHashMap(final Int2IntMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2IntOpenCustomHashMap(final int[] k, final int[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2IntOpenCustomHashMap(final int[] k, final int[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	final class MapEntry implements Int2IntMap.Entry , Map.Entry<Integer, Integer> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( (value[index]) == ((e.getValue()).intValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2IntMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2IntMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2IntOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2IntMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2IntMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2IntMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2IntOpenCustomHashMap.this.clear();}
	}
