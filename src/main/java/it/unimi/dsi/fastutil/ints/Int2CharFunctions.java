...
public final class Int2CharFunctions {
	...
	public static class EmptyFunction extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final int k) { return ((char)0); }
	...
	public static class Singleton extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final int k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Int2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public Character apply(final Integer key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public char put(final int k, final char v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public char get(final int k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public char remove(final int k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Integer k, final Character v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Int2CharFunction synchronize(final Int2CharFunction f) { return new SynchronizedFunction (f); }
	...
	public static Int2CharFunction synchronize(final Int2CharFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractInt2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char put(final int k, final char v) { throw new UnsupportedOperationException(); }

	 @Override
	 public char get(final int k) { return function.get(k); }

	 @Override
	 public char remove(final int k) { throw new UnsupportedOperationException(); }
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Integer k, final Character v) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static Int2CharFunction unmodifiable(final Int2CharFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Int2CharFunction {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Integer key, final Character value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Int2CharFunction primitive(final java.util.function.Function<? super Integer, ? extends Character> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Int2CharFunction) return (Int2CharFunction ) f;

	 if (f instanceof java.util.function.IntUnaryOperator)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.IntUnaryOperator ) f).applyAsInt(key));
