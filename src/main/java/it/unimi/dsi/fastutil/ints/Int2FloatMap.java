...
public interface Int2FloatMap extends Int2FloatFunction , Map<Integer,Float> {
	...
	default float replace(final int key, final float value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default float computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Float> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final float v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default float computeIfPresent(final int key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	default float compute(final int key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final float oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Float newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Float.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default float merge(final int key, final float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Float computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	@Deprecated
	@Override
	default Float compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	@Deprecated
	@Override
	default Float merge(final Integer key, final Float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
