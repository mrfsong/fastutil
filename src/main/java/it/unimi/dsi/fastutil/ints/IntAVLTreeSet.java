...
public class IntAVLTreeSet extends AbstractIntSortedSet implements java.io.Serializable, Cloneable, IntSortedSet {
	...
	*/
	...
	@Override
	public IntBidirectionalIterator iterator() { return new SetIterator(); }

	@Override
	public IntBidirectionalIterator iterator(final int from) { return new SetIterator(from); }

	@Override
	public IntComparator comparator() { return actualComparator; }

	@Override
	public IntSortedSet headSet(final int to) { return new Subset((0), true, to, false); }

	@Override
	public IntSortedSet tailSet(final int from) { return new Subset(from, false, (0), true); }

	@Override
	public IntSortedSet subSet(final int from, final int to) { return new Subset(from, false, to, false); }
	...
	private final class Subset extends AbstractIntSortedSet implements java.io.Serializable, IntSortedSet {
	 ...
	 @Override
	 public IntBidirectionalIterator iterator() { return new SubsetIterator(); }

	 @Override
	 public IntBidirectionalIterator iterator(final int from) { return new SubsetIterator(from); }
