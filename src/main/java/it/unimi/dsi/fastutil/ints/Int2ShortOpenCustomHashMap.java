...
public class Int2ShortOpenCustomHashMap extends AbstractInt2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2ShortOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ShortOpenCustomHashMap(final Map<? extends Integer, ? extends Short> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ShortOpenCustomHashMap(final Map<? extends Integer, ? extends Short> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ShortOpenCustomHashMap(final Int2ShortMap m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2ShortOpenCustomHashMap(final Int2ShortMap m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Int2ShortOpenCustomHashMap(final int[] k, final short[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ShortOpenCustomHashMap(final int[] k, final short[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfAbsentNullable(final int k, final java.util.function.IntFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfPresent(final int k, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public short compute(final int k, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public short merge(final int k, final short v, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Int2ShortMap.Entry , Map.Entry<Integer, Short> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).intValue()) ) ) && ( (value[index]) == ((e.getValue()).shortValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Int2ShortMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2ShortMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2ShortOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2ShortMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2ShortMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2ShortMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2ShortOpenCustomHashMap.this.clear();}
	}
