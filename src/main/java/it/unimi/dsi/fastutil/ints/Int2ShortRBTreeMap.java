...
public class Int2ShortRBTreeMap extends AbstractInt2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2ShortMap.Entry > int2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ShortMap.Entry >() {
	   final Comparator<? super Int2ShortMap.Entry > comparator = (Comparator<Int2ShortMap.Entry >) (x, y) -> Int2ShortRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	   ...
	   @Override
	   public void clear() { Int2ShortRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractInt2ShortSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2ShortRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2ShortMap.Entry > int2ShortEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2ShortMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Int2ShortMap.Entry > comparator() { return Int2ShortRBTreeMap.this.int2ShortEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final int k) { return in( k) && Int2ShortRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2ShortRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2ShortRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
