...
public interface Int2ShortMap extends Int2ShortFunction , Map<Integer,Short> {
	...
	default short replace(final int key, final short value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default short computeIfAbsentNullable(final int key, final java.util.function.IntFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final short v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default short computeIfPresent(final int key, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	default short compute(final int key, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Short newValue = remappingFunction.apply(Integer.valueOf(key), contained ? Short.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default short merge(final int key, final short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Short computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	@Deprecated
	@Override
	default Short compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	@Deprecated
	@Override
	default Short merge(final Integer key, final Short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
