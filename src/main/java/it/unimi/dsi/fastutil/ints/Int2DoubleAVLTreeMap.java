...
public class Int2DoubleAVLTreeMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractInt2DoubleMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key) == ((e.getKey()).intValue()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2DoubleMap.Entry > {
	 ...
	 @Override
	 public Int2DoubleMap.Entry next() { return nextEntry(); }

	 @Override
	 public Int2DoubleMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry >() {
	   final Comparator<? super Int2DoubleMap.Entry > comparator = (Comparator<Int2DoubleMap.Entry >) (x, y) -> Int2DoubleAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());

	   @Override
	   public Comparator<? super Int2DoubleMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Int2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Int2DoubleMap.Entry > iterator(final Int2DoubleMap.Entry from) { return new EntryIterator(from.getIntKey()); }
	   ...
	   @Override
	   public void clear() { Int2DoubleAVLTreeMap.this.clear(); }

	   @Override
	   public Int2DoubleMap.Entry first() { return firstEntry; }

	   @Override
	   public Int2DoubleMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Int2DoubleMap.Entry > subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) { return subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Int2DoubleMap.Entry > headSet(Int2DoubleMap.Entry to) { return headMap(to.getIntKey()).int2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Int2DoubleMap.Entry > tailSet(Int2DoubleMap.Entry from) { return tailMap(from.getIntKey()).int2DoubleEntrySet(); }
	  };
	...
	@Override
	public IntComparator comparator() { return actualComparator; }

	@Override
	public Int2DoubleSortedMap headMap(int to) { return new Submap((0), true, to, false); }

	@Override
	public Int2DoubleSortedMap tailMap(int from) { return new Submap(from, false, (0), true); }

	@Override
	public Int2DoubleSortedMap subMap(int from, int to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractInt2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final int from, final boolean bottom, final int to, final boolean top) {
	  if (! bottom && ! top && Int2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Int2DoubleMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Int2DoubleMap.Entry > iterator(final Int2DoubleMap.Entry from) { return new SubmapEntryIterator(from.getIntKey()); }
	    @Override
	    public Comparator<? super Int2DoubleMap.Entry > comparator() { return Int2DoubleAVLTreeMap.this.int2DoubleEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Int2DoubleAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Int2DoubleAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }

	 private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Int2DoubleMap.Entry > {
	  SubmapEntryIterator() {}
	  SubmapEntryIterator(final int k) { super(k); }
