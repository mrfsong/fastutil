...
public class Int2ReferenceOpenCustomHashMap <V> extends AbstractInt2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2ReferenceOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ReferenceOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ReferenceOpenCustomHashMap(final Map<? extends Integer, ? extends V> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ReferenceOpenCustomHashMap(final Map<? extends Integer, ? extends V> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ReferenceOpenCustomHashMap(final Int2ReferenceMap <V> m, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Int2ReferenceOpenCustomHashMap(final Int2ReferenceMap <V> m, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Int2ReferenceOpenCustomHashMap(final int[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	public Int2ReferenceOpenCustomHashMap(final int[] k, final V[] v, final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 @Override
	 public ObjectIterator<Int2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Int2ReferenceMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Int2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Int2ReferenceMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractInt2ReferenceMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (0) )) consumer.accept(new AbstractInt2ReferenceMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractIntSet {
	 ...
	 @Override
	 public void clear() { Int2ReferenceOpenCustomHashMap.this.clear();}
	}
