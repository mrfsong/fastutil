...
public final class Int2BooleanSortedMaps {
	...
	public static class Singleton extends Int2BooleanMaps.Singleton implements Int2BooleanSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Int2BooleanMap.Entry > int2BooleanEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2BooleanMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Int2BooleanMap.Entry >)entries; }
	...
	public static Int2BooleanSortedMap singleton(final Integer key, Boolean value) { return new Singleton ((key).intValue(), (value).booleanValue());}
	...
	public static Int2BooleanSortedMap singleton(final Integer key, Boolean value, IntComparator comparator) { return new Singleton ((key).intValue(), (value).booleanValue(), comparator); }
