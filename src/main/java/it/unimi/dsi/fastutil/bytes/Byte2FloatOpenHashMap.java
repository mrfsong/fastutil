...
public class Byte2FloatOpenHashMap extends AbstractByte2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Byte2FloatMap.Entry , Map.Entry<Byte, Float> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).byteValue()) ) && ( Float.floatToIntBits(value[index]) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == ((byte)0) )) return Byte2FloatOpenHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	...
	private final class KeySet extends AbstractByteSet {
	 ...
	 @Override
	 public void clear() { Byte2FloatOpenHashMap.this.clear();}
	}
