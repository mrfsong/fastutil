...
public final class Byte2ShortMaps {
	...
	public static class SynchronizedMap extends Byte2ShortFunctions.SynchronizedFunction implements Byte2ShortMap , java.io.Serializable {
	 ...
	 @Override
	 public short computeIfAbsentPartial(final byte key, final Byte2ShortFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Byte2ShortFunctions.UnmodifiableFunction implements Byte2ShortMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Byte2ShortMap.Entry > byte2ShortEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.byte2ShortEntrySet()); return entries; }
	 ...
	 @Override
	 public short computeIfAbsentPartial(final byte key, final Byte2ShortFunction mappingFunction) { throw new UnsupportedOperationException(); }
