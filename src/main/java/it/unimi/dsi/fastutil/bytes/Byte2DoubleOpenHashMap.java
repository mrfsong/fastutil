...
public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Byte2DoubleMap.Entry , Map.Entry<Byte, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).byteValue()) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == ((byte)0) )) return Byte2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractByteSet {
	 ...
	 @Override
	 public void clear() { Byte2DoubleOpenHashMap.this.clear();}
	}
