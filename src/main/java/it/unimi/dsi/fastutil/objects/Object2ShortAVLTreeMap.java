...
public class Object2ShortAVLTreeMap <K> extends AbstractObject2ShortSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ShortMap.Entry <K> >() {
	   final Comparator<? super Object2ShortMap.Entry <K> > comparator = (Comparator<Object2ShortMap.Entry <K> >) (x, y) -> Object2ShortAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2ShortMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2ShortMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2ShortMap.Entry <K> > iterator(final Object2ShortMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2ShortAVLTreeMap.this.clear(); }
	...
	@Override
	public Object2ShortSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2ShortSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2ShortSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2ShortSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2ShortMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2ShortMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2ShortMap.Entry <K> > iterator(final Object2ShortMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2ShortMap.Entry <K> > comparator() { return Object2ShortAVLTreeMap.this.object2ShortEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2ShortAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2ShortAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
