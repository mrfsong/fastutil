...
public final class Reference2DoubleMaps {
	...
	public static <K> ObjectIterable<Reference2DoubleMap.Entry <K> > fastIterable(Reference2DoubleMap <K> map) {
	 ...
	 return entries instanceof Reference2DoubleMap.FastEntrySet ? new ObjectIterable<Reference2DoubleMap.Entry <K> >() {
	  public ObjectIterator<Reference2DoubleMap.Entry <K> > iterator() { return ((Reference2DoubleMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2DoubleMap.Entry <K> > consumer) { ((Reference2DoubleMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class EmptyMap <K> extends Reference2DoubleFunctions.EmptyFunction <K> implements Reference2DoubleMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSet<Reference2DoubleMap.Entry <K> > reference2DoubleEntrySet() { return ObjectSets.EMPTY_SET; }
	...
	public static class Singleton <K> extends Reference2DoubleFunctions.Singleton <K> implements Reference2DoubleMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2DoubleMap.Entry <K> > reference2DoubleEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2DoubleMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 public ObjectSet<Map.Entry<K, Double>> entrySet() { return (ObjectSet)reference2DoubleEntrySet(); }
	 ...
	 @Override
	 public int hashCode() { return ( System.identityHashCode(key) ) ^ it.unimi.dsi.fastutil.HashCommon.double2int(value); }
	...
	public static <K> Reference2DoubleMap <K> singleton(final K key, double value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2DoubleMap <K> singleton(final K key, final Double value) { return new Singleton <>((key), (value).doubleValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2DoubleFunctions.SynchronizedFunction <K> implements Reference2DoubleMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2DoubleMap.Entry <K> > reference2DoubleEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2DoubleEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public double computeDoubleIfAbsentPartial(final K key, final Reference2DoubleFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeDoubleIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2DoubleMap <K> synchronize(final Reference2DoubleMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2DoubleMap <K> synchronize(final Reference2DoubleMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <K> extends Reference2DoubleFunctions.UnmodifiableFunction <K> implements Reference2DoubleMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2DoubleMap.Entry <K> > reference2DoubleEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2DoubleEntrySet()); return entries; }
	 ...
	 @Override
	 public double computeDoubleIfAbsentPartial(final K key, final Reference2DoubleFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2DoubleMap <K> unmodifiable(final Reference2DoubleMap <K> m) { return new UnmodifiableMap <>(m); }
