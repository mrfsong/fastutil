...
public final class Reference2ObjectFunctions {
	...
	public static class EmptyFunction <K,V> extends AbstractReference2ObjectFunction <K,V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K,V> extends AbstractReference2ObjectFunction <K,V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V get(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K,V> Reference2ObjectFunction <K,V> synchronize(final Reference2ObjectFunction <K,V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K,V> Reference2ObjectFunction <K,V> synchronize(final Reference2ObjectFunction <K,V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K,V> extends AbstractReference2ObjectFunction <K,V> implements java.io.Serializable {
	 ...
	 */
	public static <K,V> Reference2ObjectFunction <K,V> unmodifiable(final Reference2ObjectFunction <K,V> f) { return new UnmodifiableFunction <>(f); }
}
