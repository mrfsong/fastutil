...
public final class Reference2LongSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Reference2LongMap.Entry <K> > fastIterator(Reference2LongSortedMap <K> map) {
	 ...
	 return entries instanceof Reference2LongSortedMap.FastSortedEntrySet ? ((Reference2LongSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Reference2LongMap.Entry <K> > fastIterable(Reference2LongSortedMap <K> map) {
	 final ObjectSortedSet<Reference2LongMap.Entry <K> > entries = map.reference2LongEntrySet();
	 return entries instanceof Reference2LongSortedMap.FastSortedEntrySet ? ((Reference2LongSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K> extends Reference2LongMaps.Singleton <K> implements Reference2LongSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2LongMap.Entry <K> > reference2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2LongMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Reference2LongMap.Entry <K> >)entries; }
	...
	public static <K> Reference2LongSortedMap <K> singleton(final K key, Long value) { return new Singleton <>((key), (value).longValue());}
	...
	public static <K> Reference2LongSortedMap <K> singleton(final K key, Long value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).longValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Reference2LongMaps.SynchronizedMap <K> implements Reference2LongSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2LongSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Reference2LongSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Reference2LongSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Reference2LongSortedMap <K> synchronize(final Reference2LongSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Reference2LongSortedMap <K> synchronize(final Reference2LongSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Reference2LongMaps.UnmodifiableMap <K> implements Reference2LongSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2LongSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Reference2LongSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Reference2LongSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Reference2LongSortedMap <K> unmodifiable(final Reference2LongSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
