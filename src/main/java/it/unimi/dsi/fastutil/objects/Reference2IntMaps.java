...
public final class Reference2IntMaps {
	...
	public static <K> ObjectIterator<Reference2IntMap.Entry <K> > fastIterator(Reference2IntMap <K> map) {
	 ...
	 return entries instanceof Reference2IntMap.FastEntrySet ? ((Reference2IntMap.FastEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> void fastForEach(Reference2IntMap <K> map, final Consumer<? super Reference2IntMap.Entry <K> > consumer) {
	 final ObjectSet<Reference2IntMap.Entry <K> > entries = map.reference2IntEntrySet();
	 if (entries instanceof Reference2IntMap.FastEntrySet) ((Reference2IntMap.FastEntrySet <K>) entries).fastForEach(consumer);
	...
	public static <K> ObjectIterable<Reference2IntMap.Entry <K> > fastIterable(Reference2IntMap <K> map) {
	 ...
	 return entries instanceof Reference2IntMap.FastEntrySet ? new ObjectIterable<Reference2IntMap.Entry <K> >() {
	  public ObjectIterator<Reference2IntMap.Entry <K> > iterator() { return ((Reference2IntMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2IntMap.Entry <K> > consumer) { ((Reference2IntMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class EmptyMap <K> extends Reference2IntFunctions.EmptyFunction <K> implements Reference2IntMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { return ObjectSets.EMPTY_SET; }
	...
	public static class Singleton <K> extends Reference2IntFunctions.Singleton <K> implements Reference2IntMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2IntMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 public ObjectSet<Map.Entry<K, Integer>> entrySet() { return (ObjectSet)reference2IntEntrySet(); }
	...
	public static <K> Reference2IntMap <K> singleton(final K key, int value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2IntMap <K> singleton(final K key, final Integer value) { return new Singleton <>((key), (value).intValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2IntFunctions.SynchronizedFunction <K> implements Reference2IntMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2IntEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public int computeIntIfAbsentPartial(final K key, final Reference2IntFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIntIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2IntMap <K> synchronize(final Reference2IntMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2IntMap <K> synchronize(final Reference2IntMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }



	/** An unmodifiable wrapper class for maps. */

	public static class UnmodifiableMap <K> extends Reference2IntFunctions.UnmodifiableFunction <K> implements Reference2IntMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2IntEntrySet()); return entries; }
	 ...
	 @Override
	 public int computeIntIfAbsentPartial(final K key, final Reference2IntFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2IntMap <K> unmodifiable(final Reference2IntMap <K> m) { return new UnmodifiableMap <>(m); }
