...
public class Reference2ByteOpenCustomHashMap <K> extends AbstractReference2ByteMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final Strategy <? super K> strategy) {
	...
	public Reference2ByteOpenCustomHashMap(final Reference2ByteMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2ByteOpenCustomHashMap(final K[] k, final byte[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2ByteMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2ByteMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2ByteOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2ByteMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2ByteMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2ByteMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2ByteOpenCustomHashMap.this.clear();}
	}
