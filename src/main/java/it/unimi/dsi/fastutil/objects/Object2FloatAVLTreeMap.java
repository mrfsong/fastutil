...
public class Object2FloatAVLTreeMap <K> extends AbstractObject2FloatSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry <K> extends AbstractObject2FloatMap.BasicEntry <K> implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return java.util.Objects.equals(key, (e.getKey())) && ( Float.floatToIntBits(value) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2FloatMap.Entry <K> > {
	 ...
	 @Override
	 public Object2FloatMap.Entry <K> next() { return nextEntry(); }

	 @Override
	 public Object2FloatMap.Entry <K> previous() { return previousEntry(); }

	 @Override
	 public void set(Object2FloatMap.Entry <K> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2FloatMap.Entry <K> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry <K> >() {
	   final Comparator<? super Object2FloatMap.Entry <K> > comparator = (Comparator<Object2FloatMap.Entry <K> >) (x, y) -> Object2FloatAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2FloatMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2FloatMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2FloatMap.Entry <K> > iterator(final Object2FloatMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2FloatAVLTreeMap.this.clear(); }

	   @Override
	   public Object2FloatMap.Entry <K> first() { return firstEntry; }

	   @Override
	   public Object2FloatMap.Entry <K> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2FloatMap.Entry <K> > subSet(Object2FloatMap.Entry <K> from, Object2FloatMap.Entry <K> to) { return subMap(from.getKey(), to.getKey()).object2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2FloatMap.Entry <K> > headSet(Object2FloatMap.Entry <K> to) { return headMap(to.getKey()).object2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2FloatMap.Entry <K> > tailSet(Object2FloatMap.Entry <K> from) { return tailMap(from.getKey()).object2FloatEntrySet(); }
	  };
	...
	@Override
	public Object2FloatSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2FloatSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2FloatSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2FloatSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2FloatMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2FloatMap.Entry <K> > iterator(final Object2FloatMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2FloatMap.Entry <K> > comparator() { return Object2FloatAVLTreeMap.this.object2FloatEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	    ...
	    public boolean remove(final Object o) {
	     ...
	     final Object2FloatAVLTreeMap.Entry <K> f = findKey(((K) e.getKey()));
	     if (f != null && in(f.key)) Submap.this.removeFloat(f.key);
	     return f != null;
	    }
	    @Override
	    public int size() {
	 ...
	 public FloatCollection values() {
	  if (values == null) values = new AbstractFloatCollection () {
	    @Override
	    public FloatIterator iterator() { return new SubmapValueIterator(); }
	    @Override
	    public boolean contains(final float k) { return containsValue(k); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2FloatAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2FloatAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
