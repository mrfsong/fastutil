...
public final class Reference2BooleanFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getBoolean(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2BooleanFunction <K> synchronize(final Reference2BooleanFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2BooleanFunction <K> synchronize(final Reference2BooleanFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2BooleanFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2BooleanFunction <K> unmodifiable(final Reference2BooleanFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2BooleanFunction <K> primitive(final java.util.function.Function<? super K, ? extends Boolean> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2BooleanFunction) return (Reference2BooleanFunction <K>) f;
