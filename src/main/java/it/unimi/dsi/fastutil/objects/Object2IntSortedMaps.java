...
public final class Object2IntSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2IntMap.Entry <K> > fastIterator(Object2IntSortedMap <K> map) {
	 ...
	 return entries instanceof Object2IntSortedMap.FastSortedEntrySet ? ((Object2IntSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Object2IntMap.Entry <K> > fastIterable(Object2IntSortedMap <K> map) {
	 final ObjectSortedSet<Object2IntMap.Entry <K> > entries = map.object2IntEntrySet();
	 return entries instanceof Object2IntSortedMap.FastSortedEntrySet ? ((Object2IntSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K> extends Object2IntMaps.Singleton <K> implements Object2IntSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2IntMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2IntMap.Entry <K> >)entries; }
	...
	public static <K> Object2IntSortedMap <K> singleton(final K key, Integer value) { return new Singleton <>((key), (value).intValue());}
	...
	public static <K> Object2IntSortedMap <K> singleton(final K key, Integer value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).intValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Object2IntMaps.SynchronizedMap <K> implements Object2IntSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2IntSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2IntSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2IntSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Object2IntSortedMap <K> synchronize(final Object2IntSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Object2IntSortedMap <K> synchronize(final Object2IntSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Object2IntMaps.UnmodifiableMap <K> implements Object2IntSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2IntSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2IntSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2IntSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Object2IntSortedMap <K> unmodifiable(final Object2IntSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
