...
public final class ReferenceBigLists {
	...
	public static class EmptyBigList <K> extends ReferenceCollections.EmptyCollection <K> implements ReferenceBigList <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ReferenceBigList <K> subList(long from, long to) { if (from == 0 && to == 0) return this; throw new IndexOutOfBoundsException(); }
	...
	public static class Singleton <K> extends AbstractReferenceBigList <K> implements java.io.Serializable, Cloneable {
	 ...
	 protected Singleton(final K element) { this.element = element; }
	...
	public static <K> ReferenceBigList <K> singleton(final K element) { return new Singleton <>(element); }
	/** A synchronized wrapper class for big lists. */

	public static class SynchronizedBigList <K> extends ReferenceCollections.SynchronizedCollection <K> implements ReferenceBigList <K>, java.io.Serializable {

	 private static final long serialVersionUID = -7046029254386353129L;

	 protected final ReferenceBigList <K> list; // Due to the large number of methods that are not in COLLECTION, this is worth caching.
	 ...
	 @Override
	 public ReferenceBigList <K> subList(final long from, final long to) { synchronized(sync) { return synchronize(list.subList(from, to), sync); } }
	 ...
	 */
	public static <K> ReferenceBigList <K> synchronize(final ReferenceBigList <K> l) { return new SynchronizedBigList <>(l); }
	...
	public static <K> ReferenceBigList <K> synchronize(final ReferenceBigList <K> l, final Object sync) { return new SynchronizedBigList <>(l, sync); }



	/** An unmodifiable wrapper class for big lists. */

	public static class UnmodifiableBigList <K> extends ReferenceCollections.UnmodifiableCollection <K> implements ReferenceBigList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceBigList <K> subList(final long from, final long to) { return unmodifiable(list.subList(from, to)); }
	 ...
	 */
	public static <K> ReferenceBigList <K> unmodifiable(final ReferenceBigList <K> l) { return new UnmodifiableBigList <>(l); }
	...
	public static class ListBigList <K> extends AbstractReferenceBigList <K> implements java.io.Serializable {
	 ...
	 @Override
	 public ReferenceBigList <K> subList(long from, long to) { return new ListBigList <>(list.subList(intIndex(from), intIndex(to))); }
	...
	*/
	public static <K> ReferenceBigList <K> asBigList(final ReferenceList <K> list) { return new ListBigList <>(list); }
}
