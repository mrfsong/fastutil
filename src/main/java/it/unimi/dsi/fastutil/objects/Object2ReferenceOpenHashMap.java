...
public class Object2ReferenceOpenHashMap <K,V> extends AbstractObject2ReferenceMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Object2ReferenceMap.Entry <K,V>, Map.Entry<K, V> {
	 ...
	 @Override
	 public int hashCode() {
	  return ( (key[index]) == null ? 0 : (key[index]).hashCode() ) ^ ( (value[index]) == null ? 0 : System.identityHashCode(value[index]) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == null )) return Object2ReferenceOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ReferenceOpenHashMap.this.clear();}
	}
