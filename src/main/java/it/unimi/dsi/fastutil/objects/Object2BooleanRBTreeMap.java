...
public class Object2BooleanRBTreeMap <K> extends AbstractObject2BooleanSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry <K> >() {
	   final Comparator<? super Object2BooleanMap.Entry <K> > comparator = (Comparator<Object2BooleanMap.Entry <K> >) (x, y) -> Object2BooleanRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2BooleanRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2BooleanSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2BooleanMap.Entry <K> > comparator() { return Object2BooleanRBTreeMap.this.object2BooleanEntrySet().comparator(); }
	 ...
	 public BooleanCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2BooleanRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2BooleanRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2BooleanRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
