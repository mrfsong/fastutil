...
public final class Reference2ReferenceSortedMaps {
	...
	public static class Singleton <K,V> extends Reference2ReferenceMaps.Singleton <K,V> implements Reference2ReferenceSortedMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2ReferenceMap.Entry <K,V> > reference2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Reference2ReferenceMap.Entry <K,V> >)entries; }
	...
	public static <K,V> Reference2ReferenceSortedMap <K,V> singleton(final K key, V value) { return new Singleton <>((key), (value));}
	...
	public static <K,V> Reference2ReferenceSortedMap <K,V> singleton(final K key, V value, Comparator <? super K> comparator) { return new Singleton <>((key), (value), comparator); }
	...
	public static class SynchronizedSortedMap <K,V> extends Reference2ReferenceMaps.SynchronizedMap <K,V> implements Reference2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2ReferenceSortedMap <K,V> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Reference2ReferenceSortedMap <K,V> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Reference2ReferenceSortedMap <K,V> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K,V> Reference2ReferenceSortedMap <K,V> synchronize(final Reference2ReferenceSortedMap <K,V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K,V> Reference2ReferenceSortedMap <K,V> synchronize(final Reference2ReferenceSortedMap <K,V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K,V> extends Reference2ReferenceMaps.UnmodifiableMap <K,V> implements Reference2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2ReferenceSortedMap <K,V> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Reference2ReferenceSortedMap <K,V> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Reference2ReferenceSortedMap <K,V> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K,V> Reference2ReferenceSortedMap <K,V> unmodifiable(final Reference2ReferenceSortedMap <K,V> m) { return new UnmodifiableSortedMap <>(m); }
}
