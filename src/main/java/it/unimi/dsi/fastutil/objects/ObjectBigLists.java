...
public final class ObjectBigLists {
	...
	public static <K> ObjectBigList <K> singleton(final K element) { return new Singleton <>(element); }
	 ...
	 */
	public static <K> ObjectBigList <K> synchronize(final ObjectBigList <K> l) { return new SynchronizedBigList <>(l); }
	...
	public static <K> ObjectBigList <K> synchronize(final ObjectBigList <K> l, final Object sync) { return new SynchronizedBigList <>(l, sync); }
	 ...
	 */
	public static <K> ObjectBigList <K> unmodifiable(final ObjectBigList <K> l) { return new UnmodifiableBigList <>(l); }
	...
	public static class ListBigList <K> extends AbstractObjectBigList <K> implements java.io.Serializable {
	 ...
	 @Override
	 public ObjectBigList <K> subList(long from, long to) { return new ListBigList <>(list.subList(intIndex(from), intIndex(to))); }
	...
	*/
	public static <K> ObjectBigList <K> asBigList(final ObjectList <K> list) { return new ListBigList <>(list); }
}
