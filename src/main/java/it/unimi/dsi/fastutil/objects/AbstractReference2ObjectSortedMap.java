...
public abstract class AbstractReference2ObjectSortedMap <K,V> extends AbstractReference2ObjectMap <K,V> implements Reference2ObjectSortedMap <K,V> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public int size() { return AbstractReference2ObjectSortedMap.this.size(); }

	 @Override
	 public void clear() { AbstractReference2ObjectSortedMap.this.clear(); }

	 @Override
	 public Comparator <? super K> comparator() { return AbstractReference2ObjectSortedMap.this.comparator(); }
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(reference2ObjectEntrySet().iterator(new BasicEntry <>(from, (null)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Reference2ObjectSortedMaps.fastIterator(AbstractReference2ObjectSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractObjectCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <>(Reference2ObjectSortedMaps.fastIterator(AbstractReference2ObjectSortedMap.this)); }
