...
public abstract class AbstractObject2FloatSortedMap <K> extends AbstractObject2FloatMap <K> implements Object2FloatSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(object2FloatEntrySet().iterator(new BasicEntry <>(from, (0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Object2FloatSortedMaps.fastIterator(AbstractObject2FloatSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractFloatCollection {
	 @Override
	 public FloatIterator iterator() { return new ValuesIterator <>(Object2FloatSortedMaps.fastIterator(AbstractObject2FloatSortedMap.this)); }
