...
public class Object2IntAVLTreeMap <K> extends AbstractObject2IntSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2IntMap.Entry <K> > {
	 ...
	 @Override
	 public Object2IntMap.Entry <K> next() { return nextEntry(); }

	 @Override
	 public Object2IntMap.Entry <K> previous() { return previousEntry(); }

	 @Override
	 public void set(Object2IntMap.Entry <K> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2IntMap.Entry <K> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry <K> >() {
	   final Comparator<? super Object2IntMap.Entry <K> > comparator = (Comparator<Object2IntMap.Entry <K> >) (x, y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2IntMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2IntMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2IntMap.Entry <K> > iterator(final Object2IntMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2IntAVLTreeMap.this.clear(); }

	   @Override
	   public Object2IntMap.Entry <K> first() { return firstEntry; }

	   @Override
	   public Object2IntMap.Entry <K> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2IntMap.Entry <K> > subSet(Object2IntMap.Entry <K> from, Object2IntMap.Entry <K> to) { return subMap(from.getKey(), to.getKey()).object2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2IntMap.Entry <K> > headSet(Object2IntMap.Entry <K> to) { return headMap(to.getKey()).object2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2IntMap.Entry <K> > tailSet(Object2IntMap.Entry <K> from) { return tailMap(from.getKey()).object2IntEntrySet(); }
	  };
	...
	@Override
	public Object2IntSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2IntSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2IntSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2IntSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2IntAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2IntMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2IntMap.Entry <K> > iterator(final Object2IntMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2IntMap.Entry <K> > comparator() { return Object2IntAVLTreeMap.this.object2IntEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	    ...
	    public boolean remove(final Object o) {
	     ...
	     final Object2IntAVLTreeMap.Entry <K> f = findKey(((K) e.getKey()));
	     if (f != null && in(f.key)) Submap.this.removeInt(f.key);
	     return f != null;
	    }
	    @Override
	    public int size() {
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2IntAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2IntAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
