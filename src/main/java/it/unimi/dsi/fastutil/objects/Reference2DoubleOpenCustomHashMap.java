...
public class Reference2DoubleOpenCustomHashMap <K> extends AbstractReference2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final Strategy <? super K> strategy) {
	...
	public Reference2DoubleOpenCustomHashMap(final Reference2DoubleMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2DoubleOpenCustomHashMap(final K[] k, final double[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2DoubleOpenCustomHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2DoubleOpenCustomHashMap.this.clear();}
	}
