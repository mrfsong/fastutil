...
public interface ObjectBigListIterator <K> extends ObjectBidirectionalIterator <K>, BigListIterator<K> {
	...
	default void set(@SuppressWarnings("unused") final K k) { throw new UnsupportedOperationException(); }
	...
	default void add(@SuppressWarnings("unused") final K k) { throw new UnsupportedOperationException(); }
