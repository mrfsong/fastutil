...
public final class ReferenceSortedSets {
	...
	public static class EmptySet <K> extends ReferenceSets.EmptySet <K> implements ReferenceSortedSet <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> subSet(K from, K to) { return EMPTY_SET; }

	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> headSet(K from) { return EMPTY_SET; }

	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> tailSet(K to) { return EMPTY_SET; }
	...
	public static class Singleton <K> extends ReferenceSets.Singleton <K> implements ReferenceSortedSet <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> subSet(final K from, final K to) { if (compare(from, element) <= 0 && compare(element, to) < 0) return this; return EMPTY_SET; }

	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> headSet(final K to) { if (compare(element, to) < 0) return this; return EMPTY_SET; }

	 @Override
	 @SuppressWarnings("unchecked")
	 public ReferenceSortedSet <K> tailSet(final K from) { if (compare(from, element) <= 0) return this; return EMPTY_SET; }
	...
	public static class SynchronizedSortedSet <K> extends ReferenceSets.SynchronizedSet <K> implements ReferenceSortedSet <K>, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceSortedSet <K> subSet(final K from, final K to) { return new SynchronizedSortedSet <>(sortedSet.subSet(from, to), sync); }

	 @Override
	 public ReferenceSortedSet <K> headSet(final K to) { return new SynchronizedSortedSet <>(sortedSet.headSet(to), sync); }

	 @Override
	 public ReferenceSortedSet <K> tailSet(final K from) { return new SynchronizedSortedSet <>(sortedSet.tailSet(from), sync); }
	 ...
	 */
	public static <K> ReferenceSortedSet <K> synchronize(final ReferenceSortedSet <K> s) { return new SynchronizedSortedSet <>(s); }
	...
	public static <K> ReferenceSortedSet <K> synchronize(final ReferenceSortedSet <K> s, final Object sync) { return new SynchronizedSortedSet <>(s, sync); }
	...
	public static class UnmodifiableSortedSet <K> extends ReferenceSets.UnmodifiableSet <K> implements ReferenceSortedSet <K>, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceSortedSet <K> subSet(final K from, final K to) { return new UnmodifiableSortedSet <>(sortedSet.subSet(from, to)); }

	 @Override
	 public ReferenceSortedSet <K> headSet(final K to) { return new UnmodifiableSortedSet <>(sortedSet.headSet(to)); }

	 @Override
	 public ReferenceSortedSet <K> tailSet(final K from) { return new UnmodifiableSortedSet <>(sortedSet.tailSet(from)); }
	 ...
	 */
	public static <K> ReferenceSortedSet <K> unmodifiable(final ReferenceSortedSet <K> s) { return new UnmodifiableSortedSet <>(s); }
}
