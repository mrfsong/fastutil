...
public final class Reference2ObjectMaps {
	...
	public static <K,V> ObjectIterator<Reference2ObjectMap.Entry <K,V> > fastIterator(Reference2ObjectMap <K,V> map) {
	 ...
	 return entries instanceof Reference2ObjectMap.FastEntrySet ? ((Reference2ObjectMap.FastEntrySet <K,V>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K,V> void fastForEach(Reference2ObjectMap <K,V> map, final Consumer<? super Reference2ObjectMap.Entry <K,V> > consumer) {
	 final ObjectSet<Reference2ObjectMap.Entry <K,V> > entries = map.reference2ObjectEntrySet();
	 if (entries instanceof Reference2ObjectMap.FastEntrySet) ((Reference2ObjectMap.FastEntrySet <K,V>) entries).fastForEach(consumer);
	...
	public static <K,V> ObjectIterable<Reference2ObjectMap.Entry <K,V> > fastIterable(Reference2ObjectMap <K,V> map) {
	 ...
	 return entries instanceof Reference2ObjectMap.FastEntrySet ? new ObjectIterable<Reference2ObjectMap.Entry <K,V> >() {
	  public ObjectIterator<Reference2ObjectMap.Entry <K,V> > iterator() { return ((Reference2ObjectMap.FastEntrySet <K,V>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2ObjectMap.Entry <K,V> > consumer) { ((Reference2ObjectMap.FastEntrySet <K,V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <K,V> extends Reference2ObjectFunctions.Singleton <K,V> implements Reference2ObjectMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2ObjectMap.Entry <K,V> > reference2ObjectEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2ObjectMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <K,V> Reference2ObjectMap <K,V> singleton(final K key, V value) { return new Singleton <>(key, value); }
	...
	public static class SynchronizedMap <K,V> extends Reference2ObjectFunctions.SynchronizedFunction <K,V> implements Reference2ObjectMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2ObjectMap.Entry <K,V> > reference2ObjectEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2ObjectEntrySet(), sync); return entries; } }
	 ...
	 */
	public static <K,V> Reference2ObjectMap <K,V> synchronize(final Reference2ObjectMap <K,V> m) { return new SynchronizedMap <>(m); }
	...
	public static <K,V> Reference2ObjectMap <K,V> synchronize(final Reference2ObjectMap <K,V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	 ...
	 */
	public static <K,V> Reference2ObjectMap <K,V> unmodifiable(final Reference2ObjectMap <K,V> m) { return new UnmodifiableMap <>(m); }
