...
public final class ObjectLists {
	...
	public static <K> ObjectList <K> singleton(final K element) { return new Singleton <>(element); }
	...
	public static class SynchronizedList <K> extends ObjectCollections.SynchronizedCollection <K> implements ObjectList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedList <>(list.subList(from, to), sync); } }
	...
	public static class SynchronizedRandomAccessList <K> extends SynchronizedList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedRandomAccessList <>(list.subList(from, to), sync); } }
	}
	...
	public static class UnmodifiableList <K> extends ObjectCollections.UnmodifiableCollection <K> implements ObjectList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { return new UnmodifiableList <>(list.subList(from, to)); }
	...
	public static class UnmodifiableRandomAccessList <K> extends UnmodifiableList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ObjectList <K> subList(final int from, final int to) { return new UnmodifiableRandomAccessList <>(list.subList(from, to)); }
	}
