...
public final class Object2LongSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2LongMap.Entry <K> > fastIterator(Object2LongSortedMap <K> map) {
	 ...
	 return entries instanceof Object2LongSortedMap.FastSortedEntrySet ? ((Object2LongSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Object2LongMap.Entry <K> > fastIterable(Object2LongSortedMap <K> map) {
	 final ObjectSortedSet<Object2LongMap.Entry <K> > entries = map.object2LongEntrySet();
	 return entries instanceof Object2LongSortedMap.FastSortedEntrySet ? ((Object2LongSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K> extends Object2LongMaps.Singleton <K> implements Object2LongSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2LongMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2LongMap.Entry <K> >)entries; }
	...
	public static <K> Object2LongSortedMap <K> singleton(final K key, Long value) { return new Singleton <>((key), (value).longValue());}
	...
	public static <K> Object2LongSortedMap <K> singleton(final K key, Long value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).longValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Object2LongMaps.SynchronizedMap <K> implements Object2LongSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2LongSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2LongSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2LongSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Object2LongSortedMap <K> synchronize(final Object2LongSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Object2LongSortedMap <K> synchronize(final Object2LongSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Object2LongMaps.UnmodifiableMap <K> implements Object2LongSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2LongSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2LongSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2LongSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Object2LongSortedMap <K> unmodifiable(final Object2LongSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
