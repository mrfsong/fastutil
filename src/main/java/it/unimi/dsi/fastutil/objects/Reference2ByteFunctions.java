...
public final class Reference2ByteFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2ByteFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2ByteFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getByte(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2ByteFunction <K> synchronize(final Reference2ByteFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2ByteFunction <K> synchronize(final Reference2ByteFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2ByteFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2ByteFunction <K> unmodifiable(final Reference2ByteFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2ByteFunction <K> primitive(final java.util.function.Function<? super K, ? extends Byte> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2ByteFunction) return (Reference2ByteFunction <K>) f;
