...
public class Reference2IntOpenCustomHashMap <K> extends AbstractReference2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final Strategy <? super K> strategy) {
	...
	public Reference2IntOpenCustomHashMap(final Reference2IntMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2IntOpenCustomHashMap(final K[] k, final int[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2IntMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2IntMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2IntOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2IntMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2IntMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2IntMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2IntOpenCustomHashMap.this.clear();}
	}
