...
public class Reference2ObjectOpenHashMap <K,V> extends AbstractReference2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (null) )) return Reference2ObjectOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2ObjectOpenHashMap.this.clear();}
	}
