...
public class Object2ReferenceAVLTreeMap <K,V> extends AbstractObject2ReferenceSortedMap <K,V> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2ReferenceMap.Entry <K,V> > {
	 ...
	 @Override
	 public Object2ReferenceMap.Entry <K,V> next() { return nextEntry(); }

	 @Override
	 public Object2ReferenceMap.Entry <K,V> previous() { return previousEntry(); }

	 @Override
	 public void set(Object2ReferenceMap.Entry <K,V> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2ReferenceMap.Entry <K,V> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry <K,V> >() {
	   final Comparator<? super Object2ReferenceMap.Entry <K,V> > comparator = (Comparator<Object2ReferenceMap.Entry <K,V> >) (x, y) -> Object2ReferenceAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2ReferenceMap.Entry <K,V> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2ReferenceMap.Entry <K,V> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2ReferenceMap.Entry <K,V> > iterator(final Object2ReferenceMap.Entry <K,V> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2ReferenceAVLTreeMap.this.clear(); }

	   @Override
	   public Object2ReferenceMap.Entry <K,V> first() { return firstEntry; }

	   @Override
	   public Object2ReferenceMap.Entry <K,V> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > subSet(Object2ReferenceMap.Entry <K,V> from, Object2ReferenceMap.Entry <K,V> to) { return subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > headSet(Object2ReferenceMap.Entry <K,V> to) { return headMap(to.getKey()).object2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > tailSet(Object2ReferenceMap.Entry <K,V> from) { return tailMap(from.getKey()).object2ReferenceEntrySet(); }
	  };
	...
	@Override
	public Object2ReferenceSortedMap <K,V> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2ReferenceSortedMap <K,V> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2ReferenceSortedMap <K,V> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2ReferenceSortedMap <K,V> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry <K,V> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry <K,V> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry <K,V> > iterator(final Object2ReferenceMap.Entry <K,V> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2ReferenceMap.Entry <K,V> > comparator() { return Object2ReferenceAVLTreeMap.this.object2ReferenceEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
