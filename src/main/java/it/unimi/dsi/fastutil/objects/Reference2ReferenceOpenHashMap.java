...
public class Reference2ReferenceOpenHashMap <K,V> extends AbstractReference2ReferenceMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Reference2ReferenceMap.Entry <K,V>, Map.Entry<K, V> {
	 ...
	 @Override
	 public int hashCode() {
	  return ( System.identityHashCode(key[index]) ) ^ ( (value[index]) == null ? 0 : System.identityHashCode(value[index]) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (null) )) return Reference2ReferenceOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2ReferenceOpenHashMap.this.clear();}
	}
