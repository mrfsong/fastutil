...
public final class Object2ReferenceMaps {
	...
	public static <K,V> ObjectIterator<Object2ReferenceMap.Entry <K,V> > fastIterator(Object2ReferenceMap <K,V> map) {
	 ...
	 return entries instanceof Object2ReferenceMap.FastEntrySet ? ((Object2ReferenceMap.FastEntrySet <K,V>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K,V> void fastForEach(Object2ReferenceMap <K,V> map, final Consumer<? super Object2ReferenceMap.Entry <K,V> > consumer) {
	 final ObjectSet<Object2ReferenceMap.Entry <K,V> > entries = map.object2ReferenceEntrySet();
	 if (entries instanceof Object2ReferenceMap.FastEntrySet) ((Object2ReferenceMap.FastEntrySet <K,V>) entries).fastForEach(consumer);
	...
	public static <K,V> ObjectIterable<Object2ReferenceMap.Entry <K,V> > fastIterable(Object2ReferenceMap <K,V> map) {
	 ...
	 return entries instanceof Object2ReferenceMap.FastEntrySet ? new ObjectIterable<Object2ReferenceMap.Entry <K,V> >() {
	  public ObjectIterator<Object2ReferenceMap.Entry <K,V> > iterator() { return ((Object2ReferenceMap.FastEntrySet <K,V>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Object2ReferenceMap.Entry <K,V> > consumer) { ((Object2ReferenceMap.FastEntrySet <K,V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <K,V> extends Object2ReferenceFunctions.Singleton <K,V> implements Object2ReferenceMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractObject2ReferenceMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <K,V> Object2ReferenceMap <K,V> singleton(final K key, V value) { return new Singleton <>(key, value); }
	...
	public static class SynchronizedMap <K,V> extends Object2ReferenceFunctions.SynchronizedFunction <K,V> implements Object2ReferenceMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.object2ReferenceEntrySet(), sync); return entries; } }
	 ...
	 */
	public static <K,V> Object2ReferenceMap <K,V> synchronize(final Object2ReferenceMap <K,V> m) { return new SynchronizedMap <>(m); }
	...
	public static <K,V> Object2ReferenceMap <K,V> synchronize(final Object2ReferenceMap <K,V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	 ...
	 */
	public static <K,V> Object2ReferenceMap <K,V> unmodifiable(final Object2ReferenceMap <K,V> m) { return new UnmodifiableMap <>(m); }
