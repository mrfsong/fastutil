...
public final class Reference2ReferenceMaps {
	...
	public static class UnmodifiableMap <K,V> extends Reference2ReferenceFunctions.UnmodifiableFunction <K,V> implements Reference2ReferenceMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2ReferenceMap.Entry <K,V> > reference2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2ReferenceEntrySet()); return entries; }
	 ...
	 */
	public static <K,V> Reference2ReferenceMap <K,V> unmodifiable(final Reference2ReferenceMap <K,V> m) { return new UnmodifiableMap <>(m); }
