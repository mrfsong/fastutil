...
public final class ReferenceCollections {
	 ...
	 */
	public static <K> ReferenceCollection <K> synchronize(final ReferenceCollection <K> c) { return new SynchronizedCollection <>(c); }
	...
	public static <K> ReferenceCollection <K> synchronize(final ReferenceCollection <K> c, final Object sync) { return new SynchronizedCollection <>(c, sync); }
	 ...
	 */
	public static <K> ReferenceCollection <K> unmodifiable(final ReferenceCollection <K> c) { return new UnmodifiableCollection <>(c); }
