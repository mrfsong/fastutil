...
public final class Reference2DoubleFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getDouble(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2DoubleFunction <K> synchronize(final Reference2DoubleFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2DoubleFunction <K> synchronize(final Reference2DoubleFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2DoubleFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2DoubleFunction <K> unmodifiable(final Reference2DoubleFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2DoubleFunction <K> primitive(final java.util.function.Function<? super K, ? extends Double> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2DoubleFunction) return (Reference2DoubleFunction <K>) f;
