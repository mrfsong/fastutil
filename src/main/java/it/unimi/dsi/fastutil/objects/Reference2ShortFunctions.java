...
public final class Reference2ShortFunctions {
	...
	public static class Singleton <K> extends AbstractReference2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getShort(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2ShortFunction <K> synchronize(final Reference2ShortFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2ShortFunction <K> synchronize(final Reference2ShortFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <K> Reference2ShortFunction <K> unmodifiable(final Reference2ShortFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2ShortFunction <K> primitive(final java.util.function.Function<? super K, ? extends Short> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2ShortFunction) return (Reference2ShortFunction <K>) f;
