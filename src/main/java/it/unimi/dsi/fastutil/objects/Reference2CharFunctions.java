...
public final class Reference2CharFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2CharFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2CharFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getChar(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2CharFunction <K> synchronize(final Reference2CharFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2CharFunction <K> synchronize(final Reference2CharFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2CharFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2CharFunction <K> unmodifiable(final Reference2CharFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2CharFunction <K> primitive(final java.util.function.Function<? super K, ? extends Character> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2CharFunction) return (Reference2CharFunction <K>) f;
