...
public final class Reference2CharSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Reference2CharMap.Entry <K> > fastIterator(Reference2CharSortedMap <K> map) {
	 ...
	 return entries instanceof Reference2CharSortedMap.FastSortedEntrySet ? ((Reference2CharSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Reference2CharMap.Entry <K> > fastIterable(Reference2CharSortedMap <K> map) {
	 final ObjectSortedSet<Reference2CharMap.Entry <K> > entries = map.reference2CharEntrySet();
	 return entries instanceof Reference2CharSortedMap.FastSortedEntrySet ? ((Reference2CharSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class EmptySortedMap <K> extends Reference2CharMaps.EmptyMap <K> implements Reference2CharSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { return ObjectSortedSets.EMPTY_SET; }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> subMap(final K from, final K to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> headMap(final K to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> tailMap(final K from) { return EMPTY_MAP; }
	...
	public static class Singleton <K> extends Reference2CharMaps.Singleton <K> implements Reference2CharSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2CharMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Reference2CharMap.Entry <K> >)entries; }
	 ...
	 public ObjectSortedSet<Map.Entry<K, Character>> entrySet() { return (ObjectSortedSet)reference2CharEntrySet(); }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> subMap(final K from, final K to) { if (compare(from, key) <= 0 && compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> headMap(final K to) { if (compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Reference2CharSortedMap <K> tailMap(final K from) { if (compare(from, key) <= 0) return this; return EMPTY_MAP; }
	...
	public static <K> Reference2CharSortedMap <K> singleton(final K key, Character value) { return new Singleton <>((key), (value).charValue());}
	...
	public static <K> Reference2CharSortedMap <K> singleton(final K key, Character value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).charValue(), comparator); }
	...
	public static <K> Reference2CharSortedMap <K> singleton(final K key, final char value, Comparator <? super K> comparator) {
	...
	public static class SynchronizedSortedMap <K> extends Reference2CharMaps.SynchronizedMap <K> implements Reference2CharSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2CharSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Reference2CharSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Reference2CharSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Reference2CharSortedMap <K> synchronize(final Reference2CharSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Reference2CharSortedMap <K> synchronize(final Reference2CharSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Reference2CharMaps.UnmodifiableMap <K> implements Reference2CharSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2CharSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Reference2CharSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Reference2CharSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Reference2CharSortedMap <K> unmodifiable(final Reference2CharSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
