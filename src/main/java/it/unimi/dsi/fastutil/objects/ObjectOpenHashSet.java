...
public class ObjectOpenHashSet <K> extends AbstractObjectSet <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public K get(final Object k) {
	 if (( ((K) k) == null )) return key[n]; // This is correct independently of the value of containsNull and of the set being custom
	 ...
	 // The starting point.
	 if (( (curr = key[pos = ( it.unimi.dsi.fastutil.HashCommon.mix( (k).hashCode() ) ) & mask]) == null )) return null;
