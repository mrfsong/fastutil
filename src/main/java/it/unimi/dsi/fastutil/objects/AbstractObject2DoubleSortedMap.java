...
public abstract class AbstractObject2DoubleSortedMap <K> extends AbstractObject2DoubleMap <K> implements Object2DoubleSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(object2DoubleEntrySet().iterator(new BasicEntry <>(from, (0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Object2DoubleSortedMaps.fastIterator(AbstractObject2DoubleSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractDoubleCollection {
	 @Override
	 public DoubleIterator iterator() { return new ValuesIterator <>(Object2DoubleSortedMaps.fastIterator(AbstractObject2DoubleSortedMap.this)); }
