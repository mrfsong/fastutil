...
public final class Reference2LongFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2LongFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2LongFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getLong(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2LongFunction <K> synchronize(final Reference2LongFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2LongFunction <K> synchronize(final Reference2LongFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2LongFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2LongFunction <K> unmodifiable(final Reference2LongFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2LongFunction <K> primitive(final java.util.function.Function<? super K, ? extends Long> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2LongFunction) return (Reference2LongFunction <K>) f;
