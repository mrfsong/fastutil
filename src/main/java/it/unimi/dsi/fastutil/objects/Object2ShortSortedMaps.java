...
public final class Object2ShortSortedMaps {
	...
	public static class EmptySortedMap <K> extends Object2ShortMaps.EmptyMap <K> implements Object2ShortSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { return ObjectSortedSets.EMPTY_SET; }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> subMap(final K from, final K to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> headMap(final K to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> tailMap(final K from) { return EMPTY_MAP; }
	...
	public static class Singleton <K> extends Object2ShortMaps.Singleton <K> implements Object2ShortSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2ShortMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2ShortMap.Entry <K> >)entries; }
	 ...
	 public ObjectSortedSet<Map.Entry<K, Short>> entrySet() { return (ObjectSortedSet)object2ShortEntrySet(); }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> subMap(final K from, final K to) { if (compare(from, key) <= 0 && compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> headMap(final K to) { if (compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Object2ShortSortedMap <K> tailMap(final K from) { if (compare(from, key) <= 0) return this; return EMPTY_MAP; }
	...
	public static <K> Object2ShortSortedMap <K> singleton(final K key, Short value) { return new Singleton <>((key), (value).shortValue());}
	...
	public static <K> Object2ShortSortedMap <K> singleton(final K key, Short value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).shortValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Object2ShortMaps.SynchronizedMap <K> implements Object2ShortSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2ShortEntrySet(), sync); return (ObjectSortedSet<Object2ShortMap.Entry <K> >)entries; }
	 ...
	 @Override
	 public Object2ShortSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2ShortSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2ShortSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Object2ShortSortedMap <K> synchronize(final Object2ShortSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Object2ShortSortedMap <K> synchronize(final Object2ShortSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Object2ShortMaps.UnmodifiableMap <K> implements Object2ShortSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable(sortedMap.object2ShortEntrySet()); return (ObjectSortedSet<Object2ShortMap.Entry <K> >)entries; }
	 ...
	 @Override
	 public Object2ShortSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2ShortSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2ShortSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Object2ShortSortedMap <K> unmodifiable(final Object2ShortSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
