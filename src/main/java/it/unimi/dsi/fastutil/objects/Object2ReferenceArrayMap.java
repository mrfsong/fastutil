...
public class Object2ReferenceArrayMap <K,V> extends AbstractObject2ReferenceMap <K,V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == (Object2ReferenceArrayMap.this.value[oldPos]) )) return false;
	...
	@Override
	public FastEntrySet <K,V> object2ReferenceEntrySet() { return new EntrySet(); }
