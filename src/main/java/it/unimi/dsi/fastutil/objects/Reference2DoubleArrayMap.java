...
public class Reference2DoubleArrayMap <K> extends AbstractReference2DoubleMap <K> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(Object o) {
	  ...
	  return Reference2DoubleArrayMap.this.containsKey(k) && ( Double.doubleToLongBits(Reference2DoubleArrayMap.this.getDouble(k)) == Double.doubleToLongBits(((Double)(e.getValue())).doubleValue()) );
	 }
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( Double.doubleToLongBits(v) == Double.doubleToLongBits(Reference2DoubleArrayMap.this.value[oldPos]) )) return false;
	...
	@Override
	public FastEntrySet <K> reference2DoubleEntrySet() { return new EntrySet(); }
