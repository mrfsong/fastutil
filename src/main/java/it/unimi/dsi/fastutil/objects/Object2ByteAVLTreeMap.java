...
public class Object2ByteAVLTreeMap <K> extends AbstractObject2ByteSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2ByteMap.Entry <K> > {
	 ...
	 @Override
	 public void set(Object2ByteMap.Entry <K> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2ByteMap.Entry <K> ok) { throw new UnsupportedOperationException(); }
	}
	...
	public ObjectSortedSet<Object2ByteMap.Entry <K> > object2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ByteMap.Entry <K> >() {
	   final Comparator<? super Object2ByteMap.Entry <K> > comparator = (Comparator<Object2ByteMap.Entry <K> >) (x, y) -> Object2ByteAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2ByteAVLTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2ByteSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2ByteMap.Entry <K> > object2ByteEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2ByteMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2ByteMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2ByteMap.Entry <K> > iterator(final Object2ByteMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2ByteMap.Entry <K> > comparator() { return Object2ByteAVLTreeMap.this.object2ByteEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2ByteAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2ByteAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
