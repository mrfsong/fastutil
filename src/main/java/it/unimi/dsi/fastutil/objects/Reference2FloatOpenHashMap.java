...
public class Reference2FloatOpenHashMap <K> extends AbstractReference2FloatMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Reference2FloatMap.Entry <K>, Map.Entry<K, Float> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey())) ) && ( Float.floatToIntBits(value[index]) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (null) )) return Reference2FloatOpenHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2FloatOpenHashMap.this.clear();}
	}
