...
public abstract class AbstractReference2ByteSortedMap <K> extends AbstractReference2ByteMap <K> implements Reference2ByteSortedMap <K> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(reference2ByteEntrySet().iterator(new BasicEntry <>(from, ((byte)0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Reference2ByteSortedMaps.fastIterator(AbstractReference2ByteSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractByteCollection {
	 @Override
	 public ByteIterator iterator() { return new ValuesIterator <>(Reference2ByteSortedMaps.fastIterator(AbstractReference2ByteSortedMap.this)); }
