...
public class Reference2ReferenceOpenCustomHashMap <K,V> extends AbstractReference2ReferenceMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final Strategy <? super K> strategy) {
	...
	public Reference2ReferenceOpenCustomHashMap(final Reference2ReferenceMap <K,V> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2ReferenceOpenCustomHashMap(final Reference2ReferenceMap <K,V> m, final Strategy <? super K> strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Reference2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {

	 @Override
	 public ObjectIterator<Reference2ReferenceMap.Entry <K,V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2ReferenceMap.Entry <K,V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2ReferenceMap.Entry <K,V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2ReferenceMap.BasicEntry <K,V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2ReferenceMap.BasicEntry <K,V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2ReferenceOpenCustomHashMap.this.clear();}
	}
