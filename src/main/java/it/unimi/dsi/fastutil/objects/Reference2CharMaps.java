...
public final class Reference2CharMaps {
	...
	public static <K> ObjectIterator<Reference2CharMap.Entry <K> > fastIterator(Reference2CharMap <K> map) {
	 ...
	 return entries instanceof Reference2CharMap.FastEntrySet ? ((Reference2CharMap.FastEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> void fastForEach(Reference2CharMap <K> map, final Consumer<? super Reference2CharMap.Entry <K> > consumer) {
	 final ObjectSet<Reference2CharMap.Entry <K> > entries = map.reference2CharEntrySet();
	 if (entries instanceof Reference2CharMap.FastEntrySet) ((Reference2CharMap.FastEntrySet <K>) entries).fastForEach(consumer);
	...
	public static <K> ObjectIterable<Reference2CharMap.Entry <K> > fastIterable(Reference2CharMap <K> map) {
	 ...
	 return entries instanceof Reference2CharMap.FastEntrySet ? new ObjectIterable<Reference2CharMap.Entry <K> >() {
	  public ObjectIterator<Reference2CharMap.Entry <K> > iterator() { return ((Reference2CharMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2CharMap.Entry <K> > consumer) { ((Reference2CharMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class EmptyMap <K> extends Reference2CharFunctions.EmptyFunction <K> implements Reference2CharMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { return ObjectSets.EMPTY_SET; }
	...
	public static class Singleton <K> extends Reference2CharFunctions.Singleton <K> implements Reference2CharMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2CharMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 public ObjectSet<Map.Entry<K, Character>> entrySet() { return (ObjectSet)reference2CharEntrySet(); }
	...
	public static class SynchronizedMap <K> extends Reference2CharFunctions.SynchronizedFunction <K> implements Reference2CharMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2CharEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public char computeCharIfAbsentPartial(final K key, final Reference2CharFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeCharIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap <K> extends Reference2CharFunctions.UnmodifiableFunction <K> implements Reference2CharMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2CharMap.Entry <K> > reference2CharEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2CharEntrySet()); return entries; }
	 ...
	 @Override
	 public char computeCharIfAbsentPartial(final K key, final Reference2CharFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
