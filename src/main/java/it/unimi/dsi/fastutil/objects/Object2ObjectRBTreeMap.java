...
public class Object2ObjectRBTreeMap <K,V> extends AbstractObject2ObjectSortedMap <K,V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2ObjectMap.Entry <K,V> > object2ObjectEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry <K,V> >() {
	   final Comparator<? super Object2ObjectMap.Entry <K,V> > comparator = (Comparator<Object2ObjectMap.Entry <K,V> >) (x, y) -> Object2ObjectRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2ObjectRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2ObjectSortedMap <K,V> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2ObjectRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2ObjectMap.Entry <K,V> > object2ObjectEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry <K,V> >() {
	    ...
	    @Override
	    public Comparator<? super Object2ObjectMap.Entry <K,V> > comparator() { return Object2ObjectRBTreeMap.this.object2ObjectEntrySet().comparator(); }
	 ...
	 public ObjectCollection <V> values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2ObjectRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2ObjectRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2ObjectRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
