...
public final class Reference2ByteMaps {
	...
	public static <K> ObjectIterable<Reference2ByteMap.Entry <K> > fastIterable(Reference2ByteMap <K> map) {
	 ...
	 return entries instanceof Reference2ByteMap.FastEntrySet ? new ObjectIterable<Reference2ByteMap.Entry <K> >() {
	  public ObjectIterator<Reference2ByteMap.Entry <K> > iterator() { return ((Reference2ByteMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2ByteMap.Entry <K> > consumer) { ((Reference2ByteMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class EmptyMap <K> extends Reference2ByteFunctions.EmptyFunction <K> implements Reference2ByteMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { return ObjectSets.EMPTY_SET; }
	...
	public static class Singleton <K> extends Reference2ByteFunctions.Singleton <K> implements Reference2ByteMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2ByteMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 public ObjectSet<Map.Entry<K, Byte>> entrySet() { return (ObjectSet)reference2ByteEntrySet(); }
	...
	public static <K> Reference2ByteMap <K> singleton(final K key, byte value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2ByteMap <K> singleton(final K key, final Byte value) { return new Singleton <>((key), (value).byteValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2ByteFunctions.SynchronizedFunction <K> implements Reference2ByteMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2ByteEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public byte computeByteIfAbsentPartial(final K key, final Reference2ByteFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeByteIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2ByteMap <K> synchronize(final Reference2ByteMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2ByteMap <K> synchronize(final Reference2ByteMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <K> extends Reference2ByteFunctions.UnmodifiableFunction <K> implements Reference2ByteMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2ByteEntrySet()); return entries; }
	 ...
	 @Override
	 public byte computeByteIfAbsentPartial(final K key, final Reference2ByteFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2ByteMap <K> unmodifiable(final Reference2ByteMap <K> m) { return new UnmodifiableMap <>(m); }
