	...
	public static class BasicEntry <K> implements Reference2DoubleMap.Entry <K> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Reference2DoubleMap.Entry) {
	   ...
	   return ( (key) == (e.getKey()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits(e.getDoubleValue()) );
	  }
	  ...
	  return ( (this.key) == ((key)) ) && ( Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)(value)).doubleValue()) );
	 }
