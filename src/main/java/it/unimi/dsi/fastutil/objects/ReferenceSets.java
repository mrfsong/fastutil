...
public final class ReferenceSets {
	 ...
	 */
	public static <K> ReferenceSet <K> synchronize(final ReferenceSet <K> s) { return new SynchronizedSet <>(s); }
	...
	public static <K> ReferenceSet <K> synchronize(final ReferenceSet <K> s, final Object sync) { return new SynchronizedSet <>(s, sync); }
	 ...
	 */
	public static <K> ReferenceSet <K> unmodifiable(final ReferenceSet <K> s) { return new UnmodifiableSet <>(s); }
}
