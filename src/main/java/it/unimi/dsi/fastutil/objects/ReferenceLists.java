...
public final class ReferenceLists {
	...
	public static <K> ReferenceList <K> singleton(final K element) { return new Singleton <>(element); }
	...
	public static class SynchronizedList <K> extends ReferenceCollections.SynchronizedCollection <K> implements ReferenceList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedList <>(list.subList(from, to), sync); } }
	...
	public static class SynchronizedRandomAccessList <K> extends SynchronizedList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceList <K> subList(final int from, final int to) { synchronized(sync) { return new SynchronizedRandomAccessList <>(list.subList(from, to), sync); } }
	}
	...
	public static class UnmodifiableList <K> extends ReferenceCollections.UnmodifiableCollection <K> implements ReferenceList <K>, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceList <K> subList(final int from, final int to) { return new UnmodifiableList <>(list.subList(from, to)); }
	...
	public static class UnmodifiableRandomAccessList <K> extends UnmodifiableList <K> implements RandomAccess, java.io.Serializable {
	 ...
	 @Override
	 public ReferenceList <K> subList(final int from, final int to) { return new UnmodifiableRandomAccessList <>(list.subList(from, to)); }
	}
