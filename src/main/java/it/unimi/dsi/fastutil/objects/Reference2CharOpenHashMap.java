...
public class Reference2CharOpenHashMap <K> extends AbstractReference2CharMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == (null) )) return Reference2CharOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2CharOpenHashMap.this.clear();}
	}
