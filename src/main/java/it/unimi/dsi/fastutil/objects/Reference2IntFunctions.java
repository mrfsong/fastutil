...
public final class Reference2IntFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2IntFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2IntFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getInt(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2IntFunction <K> synchronize(final Reference2IntFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2IntFunction <K> synchronize(final Reference2IntFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2IntFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2IntFunction <K> unmodifiable(final Reference2IntFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2IntFunction <K> primitive(final java.util.function.Function<? super K, ? extends Integer> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2IntFunction) return (Reference2IntFunction <K>) f;
