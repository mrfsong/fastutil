...
public final class Object2FloatSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2FloatMap.Entry <K> > fastIterator(Object2FloatSortedMap <K> map) {
	 ...
	 return entries instanceof Object2FloatSortedMap.FastSortedEntrySet ? ((Object2FloatSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Object2FloatMap.Entry <K> > fastIterable(Object2FloatSortedMap <K> map) {
	 final ObjectSortedSet<Object2FloatMap.Entry <K> > entries = map.object2FloatEntrySet();
	 return entries instanceof Object2FloatSortedMap.FastSortedEntrySet ? ((Object2FloatSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K> extends Object2FloatMaps.Singleton <K> implements Object2FloatSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2FloatMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2FloatMap.Entry <K> >)entries; }
	...
	public static <K> Object2FloatSortedMap <K> singleton(final K key, Float value) { return new Singleton <>((key), (value).floatValue());}
	...
	public static <K> Object2FloatSortedMap <K> singleton(final K key, Float value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).floatValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Object2FloatMaps.SynchronizedMap <K> implements Object2FloatSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2FloatSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2FloatSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2FloatSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Object2FloatSortedMap <K> synchronize(final Object2FloatSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Object2FloatSortedMap <K> synchronize(final Object2FloatSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Object2FloatMaps.UnmodifiableMap <K> implements Object2FloatSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2FloatSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2FloatSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2FloatSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Object2FloatSortedMap <K> unmodifiable(final Object2FloatSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
