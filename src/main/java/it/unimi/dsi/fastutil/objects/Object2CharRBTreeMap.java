...
public class Object2CharRBTreeMap <K> extends AbstractObject2CharSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2CharMap.Entry <K> > object2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2CharMap.Entry <K> >() {
	   final Comparator<? super Object2CharMap.Entry <K> > comparator = (Comparator<Object2CharMap.Entry <K> >) (x, y) -> Object2CharRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2CharMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2CharMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2CharMap.Entry <K> > iterator(final Object2CharMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2CharRBTreeMap.this.clear(); }
	...
	@Override
	public Object2CharSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2CharSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2CharSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2CharSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2CharMap.Entry <K> > object2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2CharMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2CharMap.Entry <K> > comparator() { return Object2CharRBTreeMap.this.object2CharEntrySet().comparator(); }
	 ...
	 public CharCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2CharRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2CharRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2CharRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
