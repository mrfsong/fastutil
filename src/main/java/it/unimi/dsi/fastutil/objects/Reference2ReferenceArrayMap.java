...
public class Reference2ReferenceArrayMap <K,V> extends AbstractReference2ReferenceMap <K,V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == (Reference2ReferenceArrayMap.this.value[oldPos]) )) return false;
	...
	@Override
	public FastEntrySet <K,V> reference2ReferenceEntrySet() { return new EntrySet(); }
