...
public class Object2LongRBTreeMap <K> extends AbstractObject2LongSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry <K> >() {
	   final Comparator<? super Object2LongMap.Entry <K> > comparator = (Comparator<Object2LongMap.Entry <K> >) (x, y) -> Object2LongRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2LongSortedMap <K> implements java.io.Serializable {
	 ...
	 public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2LongMap.Entry <K> > comparator() { return Object2LongRBTreeMap.this.object2LongEntrySet().comparator(); }
	 ...
	 public LongCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2LongRBTreeMap.this.containsKey(k); }
