...
public final class Object2ReferenceFunctions {
	...
	public static class EmptyFunction <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public static <K,V> Object2ReferenceFunction <K,V> synchronize(final Object2ReferenceFunction <K,V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K,V> Object2ReferenceFunction <K,V> synchronize(final Object2ReferenceFunction <K,V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable {
	 ...
	 */
	public static <K,V> Object2ReferenceFunction <K,V> unmodifiable(final Object2ReferenceFunction <K,V> f) { return new UnmodifiableFunction <>(f); }
}
