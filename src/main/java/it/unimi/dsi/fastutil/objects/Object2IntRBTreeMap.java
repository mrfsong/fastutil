...
public class Object2IntRBTreeMap <K> extends AbstractObject2IntSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry <K> >() {
	   final Comparator<? super Object2IntMap.Entry <K> > comparator = (Comparator<Object2IntMap.Entry <K> >) (x, y) -> Object2IntRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2IntRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2IntSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2IntMap.Entry <K> > object2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2IntMap.Entry <K> > comparator() { return Object2IntRBTreeMap.this.object2IntEntrySet().comparator(); }
	 ...
	 public IntCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2IntRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2IntRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2IntRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
