...
public class Reference2FloatOpenCustomHashMap <K> extends AbstractReference2FloatMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final Strategy <? super K> strategy) {
	...
	public Reference2FloatOpenCustomHashMap(final Reference2FloatMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2FloatOpenCustomHashMap(final K[] k, final float[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2FloatMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2FloatMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2FloatOpenCustomHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	 ...
	 public void forEach(final Consumer<? super Reference2FloatMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2FloatMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2FloatMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2FloatOpenCustomHashMap.this.clear();}
	}
