...
public final class ObjectComparators {
	...
	protected static class OppositeComparator <K> implements Comparator <K>, java.io.Serializable {
	 ...
	 protected OppositeComparator(final Comparator <K> c) { comparator = c; }

	 @Override
	 public final int compare(final K a, final K b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static <K> Comparator <K> oppositeComparator(final Comparator <K> c) { return new OppositeComparator <>(c); }
}
