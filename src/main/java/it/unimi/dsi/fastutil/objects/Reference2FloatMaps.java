...
public final class Reference2FloatMaps {
	...
	public static <K> ObjectIterator<Reference2FloatMap.Entry <K> > fastIterator(Reference2FloatMap <K> map) {
	 ...
	 return entries instanceof Reference2FloatMap.FastEntrySet ? ((Reference2FloatMap.FastEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> void fastForEach(Reference2FloatMap <K> map, final Consumer<? super Reference2FloatMap.Entry <K> > consumer) {
	 final ObjectSet<Reference2FloatMap.Entry <K> > entries = map.reference2FloatEntrySet();
	 if (entries instanceof Reference2FloatMap.FastEntrySet) ((Reference2FloatMap.FastEntrySet <K>) entries).fastForEach(consumer);
	...
	public static <K> ObjectIterable<Reference2FloatMap.Entry <K> > fastIterable(Reference2FloatMap <K> map) {
	 ...
	 return entries instanceof Reference2FloatMap.FastEntrySet ? new ObjectIterable<Reference2FloatMap.Entry <K> >() {
	  public ObjectIterator<Reference2FloatMap.Entry <K> > iterator() { return ((Reference2FloatMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2FloatMap.Entry <K> > consumer) { ((Reference2FloatMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <K> extends Reference2FloatFunctions.Singleton <K> implements Reference2FloatMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2FloatMap.Entry <K> > reference2FloatEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2FloatMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <K> Reference2FloatMap <K> singleton(final K key, float value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2FloatMap <K> singleton(final K key, final Float value) { return new Singleton <>((key), (value).floatValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2FloatFunctions.SynchronizedFunction <K> implements Reference2FloatMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2FloatMap.Entry <K> > reference2FloatEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2FloatEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public float computeFloatIfAbsentPartial(final K key, final Reference2FloatFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeFloatIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2FloatMap <K> synchronize(final Reference2FloatMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2FloatMap <K> synchronize(final Reference2FloatMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <K> extends Reference2FloatFunctions.UnmodifiableFunction <K> implements Reference2FloatMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public float computeFloatIfAbsentPartial(final K key, final Reference2FloatFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2FloatMap <K> unmodifiable(final Reference2FloatMap <K> m) { return new UnmodifiableMap <>(m); }
