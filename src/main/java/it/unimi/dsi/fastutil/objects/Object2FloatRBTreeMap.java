...
public class Object2FloatRBTreeMap <K> extends AbstractObject2FloatSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry <K> >() {
	   final Comparator<? super Object2FloatMap.Entry <K> > comparator = (Comparator<Object2FloatMap.Entry <K> >) (x, y) -> Object2FloatRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2FloatRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2FloatSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2FloatMap.Entry <K> > comparator() { return Object2FloatRBTreeMap.this.object2FloatEntrySet().comparator(); }
	 ...
	 public FloatCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2FloatRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2FloatRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2FloatRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
