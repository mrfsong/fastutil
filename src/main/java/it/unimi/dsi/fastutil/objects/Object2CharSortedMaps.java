...
public final class Object2CharSortedMaps {
	...
	public static class Singleton <K> extends Object2CharMaps.Singleton <K> implements Object2CharSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2CharMap.Entry <K> > object2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2CharMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2CharMap.Entry <K> >)entries; }
	...
	public static <K> Object2CharSortedMap <K> singleton(final K key, Character value) { return new Singleton <>((key), (value).charValue());}
	...
	public static <K> Object2CharSortedMap <K> singleton(final K key, Character value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).charValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Object2CharMaps.SynchronizedMap <K> implements Object2CharSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2CharSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2CharSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2CharSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Object2CharSortedMap <K> synchronize(final Object2CharSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Object2CharSortedMap <K> synchronize(final Object2CharSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Object2CharMaps.UnmodifiableMap <K> implements Object2CharSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Object2CharSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2CharSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2CharSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Object2CharSortedMap <K> unmodifiable(final Object2CharSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
