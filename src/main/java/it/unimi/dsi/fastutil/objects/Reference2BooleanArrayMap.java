...
public class Reference2BooleanArrayMap <K> extends AbstractReference2BooleanMap <K> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! ( (v) == (Reference2BooleanArrayMap.this.value[oldPos]) )) return false;
	...
	@Override
	public FastEntrySet <K> reference2BooleanEntrySet() { return new EntrySet(); }
