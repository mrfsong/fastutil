...
public final class Reference2FloatFunctions {
	...
	public static class EmptyFunction <K> extends AbstractReference2FloatFunction <K> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <K> extends AbstractReference2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getFloat(final Object k) { return ( (key) == (k) ) ? value : defRetValue; }
	 ...
	 */
	public static <K> Reference2FloatFunction <K> synchronize(final Reference2FloatFunction <K> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K> Reference2FloatFunction <K> synchronize(final Reference2FloatFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <K> extends AbstractReference2FloatFunction <K> implements java.io.Serializable {
	 ...
	 */
	public static <K> Reference2FloatFunction <K> unmodifiable(final Reference2FloatFunction <K> f) { return new UnmodifiableFunction <>(f); }
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2FloatFunction <K> primitive(final java.util.function.Function<? super K, ? extends Float> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Reference2FloatFunction) return (Reference2FloatFunction <K>) f;
