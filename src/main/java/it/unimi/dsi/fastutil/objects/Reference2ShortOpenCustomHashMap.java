...
public class Reference2ShortOpenCustomHashMap <K> extends AbstractReference2ShortMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final Strategy <? super K> strategy) {
	...
	public Reference2ShortOpenCustomHashMap(final Reference2ShortMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2ShortOpenCustomHashMap(final K[] k, final short[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2ShortMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2ShortMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2ShortOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2ShortMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2ShortMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2ShortMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2ShortOpenCustomHashMap.this.clear();}
	}
