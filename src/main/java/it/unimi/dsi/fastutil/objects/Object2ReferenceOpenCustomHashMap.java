...
public class Object2ReferenceOpenCustomHashMap <K,V> extends AbstractObject2ReferenceMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Object2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f, final Strategy <? super K> strategy) {
	...
	public Object2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final Strategy <? super K> strategy) {
	...
	public Object2ReferenceOpenCustomHashMap(final Object2ReferenceMap <K,V> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Object2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry <K,V> > implements FastEntrySet <K,V> {

	 @Override
	 public ObjectIterator<Object2ReferenceMap.Entry <K,V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Object2ReferenceMap.Entry <K,V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Object2ReferenceMap.Entry <K,V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractObject2ReferenceMap.BasicEntry <K,V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == null )) consumer.accept(new AbstractObject2ReferenceMap.BasicEntry <K,V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ReferenceOpenCustomHashMap.this.clear();}
	}
