...
public abstract class AbstractObject2LongSortedMap <K> extends AbstractObject2LongMap <K> implements Object2LongSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(object2LongEntrySet().iterator(new BasicEntry <>(from, (0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Object2LongSortedMaps.fastIterator(AbstractObject2LongSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractLongCollection {
	 @Override
	 public LongIterator iterator() { return new ValuesIterator <>(Object2LongSortedMaps.fastIterator(AbstractObject2LongSortedMap.this)); }
