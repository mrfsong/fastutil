...
public final class Reference2IntSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Reference2IntMap.Entry <K> > fastIterator(Reference2IntSortedMap <K> map) {
	 ...
	 return entries instanceof Reference2IntSortedMap.FastSortedEntrySet ? ((Reference2IntSortedMap.FastSortedEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K> ObjectBidirectionalIterable<Reference2IntMap.Entry <K> > fastIterable(Reference2IntSortedMap <K> map) {
	 final ObjectSortedSet<Reference2IntMap.Entry <K> > entries = map.reference2IntEntrySet();
	 return entries instanceof Reference2IntSortedMap.FastSortedEntrySet ? ((Reference2IntSortedMap.FastSortedEntrySet <K>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K> extends Reference2IntMaps.Singleton <K> implements Reference2IntSortedMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Reference2IntMap.Entry <K> > reference2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractReference2IntMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Reference2IntMap.Entry <K> >)entries; }
	...
	public static <K> Reference2IntSortedMap <K> singleton(final K key, Integer value) { return new Singleton <>((key), (value).intValue());}
	...
	public static <K> Reference2IntSortedMap <K> singleton(final K key, Integer value, Comparator <? super K> comparator) { return new Singleton <>((key), (value).intValue(), comparator); }
	...
	public static class SynchronizedSortedMap <K> extends Reference2IntMaps.SynchronizedMap <K> implements Reference2IntSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2IntSortedMap <K> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Reference2IntSortedMap <K> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Reference2IntSortedMap <K> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K> Reference2IntSortedMap <K> synchronize(final Reference2IntSortedMap <K> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K> Reference2IntSortedMap <K> synchronize(final Reference2IntSortedMap <K> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K> extends Reference2IntMaps.UnmodifiableMap <K> implements Reference2IntSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public Reference2IntSortedMap <K> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Reference2IntSortedMap <K> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Reference2IntSortedMap <K> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K> Reference2IntSortedMap <K> unmodifiable(final Reference2IntSortedMap <K> m) { return new UnmodifiableSortedMap <>(m); }
}
