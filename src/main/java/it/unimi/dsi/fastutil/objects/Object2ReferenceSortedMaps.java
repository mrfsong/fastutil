...
public final class Object2ReferenceSortedMaps {
	...
	public static <K,V> ObjectBidirectionalIterator<Object2ReferenceMap.Entry <K,V> > fastIterator(Object2ReferenceSortedMap <K,V> map) {
	 ...
	 return entries instanceof Object2ReferenceSortedMap.FastSortedEntrySet ? ((Object2ReferenceSortedMap.FastSortedEntrySet <K,V>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <K,V> ObjectBidirectionalIterable<Object2ReferenceMap.Entry <K,V> > fastIterable(Object2ReferenceSortedMap <K,V> map) {
	 final ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > entries = map.object2ReferenceEntrySet();
	 return entries instanceof Object2ReferenceSortedMap.FastSortedEntrySet ? ((Object2ReferenceSortedMap.FastSortedEntrySet <K,V>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <K,V> extends Object2ReferenceMaps.Singleton <K,V> implements Object2ReferenceSortedMap <K,V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Object2ReferenceMap.Entry <K,V> >)entries; }
	...
	public static <K,V> Object2ReferenceSortedMap <K,V> singleton(final K key, V value) { return new Singleton <>((key), (value));}
	...
	public static <K,V> Object2ReferenceSortedMap <K,V> singleton(final K key, V value, Comparator <? super K> comparator) { return new Singleton <>((key), (value), comparator); }
	...
	public static class SynchronizedSortedMap <K,V> extends Object2ReferenceMaps.SynchronizedMap <K,V> implements Object2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public Object2ReferenceSortedMap <K,V> subMap(final K from, final K to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Object2ReferenceSortedMap <K,V> headMap(final K to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Object2ReferenceSortedMap <K,V> tailMap(final K from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <K,V> Object2ReferenceSortedMap <K,V> synchronize(final Object2ReferenceSortedMap <K,V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <K,V> Object2ReferenceSortedMap <K,V> synchronize(final Object2ReferenceSortedMap <K,V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <K,V> extends Object2ReferenceMaps.UnmodifiableMap <K,V> implements Object2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @Override
	 public Object2ReferenceSortedMap <K,V> subMap(final K from, final K to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Object2ReferenceSortedMap <K,V> headMap(final K to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Object2ReferenceSortedMap <K,V> tailMap(final K from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <K,V> Object2ReferenceSortedMap <K,V> unmodifiable(final Object2ReferenceSortedMap <K,V> m) { return new UnmodifiableSortedMap <>(m); }
}
