...
public class Reference2BooleanOpenCustomHashMap <K> extends AbstractReference2BooleanMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final Strategy <? super K> strategy) {
	...
	public Reference2BooleanOpenCustomHashMap(final Reference2BooleanMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2BooleanOpenCustomHashMap(final K[] k, final boolean[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2BooleanMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2BooleanMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2BooleanOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2BooleanMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2BooleanMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2BooleanMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2BooleanOpenCustomHashMap.this.clear();}
	}
