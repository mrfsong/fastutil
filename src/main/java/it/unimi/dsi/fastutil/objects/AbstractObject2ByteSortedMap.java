...
public abstract class AbstractObject2ByteSortedMap <K> extends AbstractObject2ByteMap <K> implements Object2ByteSortedMap <K> {
	...
	protected class KeySet extends AbstractObjectSortedSet <K> {
	 ...
	 @Override
	 public int size() { return AbstractObject2ByteSortedMap.this.size(); }

	 @Override
	 public void clear() { AbstractObject2ByteSortedMap.this.clear(); }

	 @Override
	 public Comparator <? super K> comparator() { return AbstractObject2ByteSortedMap.this.comparator(); }
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(object2ByteEntrySet().iterator(new BasicEntry <>(from, ((byte)0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Object2ByteSortedMaps.fastIterator(AbstractObject2ByteSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractByteCollection {
	 @Override
	 public ByteIterator iterator() { return new ValuesIterator <>(Object2ByteSortedMaps.fastIterator(AbstractObject2ByteSortedMap.this)); }
