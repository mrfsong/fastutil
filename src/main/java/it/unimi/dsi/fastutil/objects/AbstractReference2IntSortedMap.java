...
public abstract class AbstractReference2IntSortedMap <K> extends AbstractReference2IntMap <K> implements Reference2IntSortedMap <K> {
	...
	protected class KeySet extends AbstractReferenceSortedSet <K> {
	 ...
	 @Override
	 public ObjectBidirectionalIterator <K> iterator(final K from) { return new KeySetIterator <>(reference2IntEntrySet().iterator(new BasicEntry <>(from, (0)))); }

	 @Override
	 public ObjectBidirectionalIterator <K> iterator() { return new KeySetIterator <>(Reference2IntSortedMaps.fastIterator(AbstractReference2IntSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractIntCollection {
	 @Override
	 public IntIterator iterator() { return new ValuesIterator <>(Reference2IntSortedMaps.fastIterator(AbstractReference2IntSortedMap.this)); }
