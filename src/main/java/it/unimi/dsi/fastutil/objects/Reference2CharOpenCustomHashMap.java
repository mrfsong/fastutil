...
public class Reference2CharOpenCustomHashMap <K> extends AbstractReference2CharMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2CharOpenCustomHashMap(final Map<? extends K, ? extends Character> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2CharOpenCustomHashMap(final Map<? extends K, ? extends Character> m, final Strategy <? super K> strategy) {
	...
	public Reference2CharOpenCustomHashMap(final Reference2CharMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2CharOpenCustomHashMap(final K[] k, final char[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2CharMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2CharMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2CharOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2CharMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2CharMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2CharMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2CharOpenCustomHashMap.this.clear();}
	}
