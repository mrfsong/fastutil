...
public class Object2BooleanAVLTreeMap <K> extends AbstractObject2BooleanSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2BooleanMap.Entry <K> > {
	 ...
	 @Override
	 public Object2BooleanMap.Entry <K> next() { return nextEntry(); }

	 @Override
	 public Object2BooleanMap.Entry <K> previous() { return previousEntry(); }

	 @Override
	 public void set(Object2BooleanMap.Entry <K> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2BooleanMap.Entry <K> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry <K> >() {
	   final Comparator<? super Object2BooleanMap.Entry <K> > comparator = (Comparator<Object2BooleanMap.Entry <K> >) (x, y) -> Object2BooleanAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2BooleanMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2BooleanMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2BooleanMap.Entry <K> > iterator(final Object2BooleanMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2BooleanAVLTreeMap.this.clear(); }

	   @Override
	   public Object2BooleanMap.Entry <K> first() { return firstEntry; }

	   @Override
	   public Object2BooleanMap.Entry <K> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2BooleanMap.Entry <K> > subSet(Object2BooleanMap.Entry <K> from, Object2BooleanMap.Entry <K> to) { return subMap(from.getKey(), to.getKey()).object2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2BooleanMap.Entry <K> > headSet(Object2BooleanMap.Entry <K> to) { return headMap(to.getKey()).object2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2BooleanMap.Entry <K> > tailSet(Object2BooleanMap.Entry <K> from) { return tailMap(from.getKey()).object2BooleanEntrySet(); }
	  };
	...
	@Override
	public Object2BooleanSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2BooleanSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2BooleanSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2BooleanSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2BooleanMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2BooleanMap.Entry <K> > iterator(final Object2BooleanMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2BooleanMap.Entry <K> > comparator() { return Object2BooleanAVLTreeMap.this.object2BooleanEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	    ...
	    public boolean remove(final Object o) {
	     ...
	     final Object2BooleanAVLTreeMap.Entry <K> f = findKey(((K) e.getKey()));
	     if (f != null && in(f.key)) Submap.this.removeBoolean(f.key);
	     return f != null;
	    }
	    @Override
	    public int size() {
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2BooleanAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2BooleanAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
