...
public final class Reference2BooleanMaps {
	...
	public static <K> ObjectIterable<Reference2BooleanMap.Entry <K> > fastIterable(Reference2BooleanMap <K> map) {
	 ...
	 return entries instanceof Reference2BooleanMap.FastEntrySet ? new ObjectIterable<Reference2BooleanMap.Entry <K> >() {
	  public ObjectIterator<Reference2BooleanMap.Entry <K> > iterator() { return ((Reference2BooleanMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2BooleanMap.Entry <K> > consumer) { ((Reference2BooleanMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class EmptyMap <K> extends Reference2BooleanFunctions.EmptyFunction <K> implements Reference2BooleanMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { return ObjectSets.EMPTY_SET; }
	...
	public static class Singleton <K> extends Reference2BooleanFunctions.Singleton <K> implements Reference2BooleanMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2BooleanMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 public ObjectSet<Map.Entry<K, Boolean>> entrySet() { return (ObjectSet)reference2BooleanEntrySet(); }
	...
	public static <K> Reference2BooleanMap <K> singleton(final K key, boolean value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2BooleanMap <K> singleton(final K key, final Boolean value) { return new Singleton <>((key), (value).booleanValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2BooleanFunctions.SynchronizedFunction <K> implements Reference2BooleanMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2BooleanEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public boolean computeBooleanIfAbsentPartial(final K key, final Reference2BooleanFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeBooleanIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2BooleanMap <K> synchronize(final Reference2BooleanMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2BooleanMap <K> synchronize(final Reference2BooleanMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <K> extends Reference2BooleanFunctions.UnmodifiableFunction <K> implements Reference2BooleanMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.reference2BooleanEntrySet()); return entries; }
	 ...
	 @Override
	 public boolean computeBooleanIfAbsentPartial(final K key, final Reference2BooleanFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2BooleanMap <K> unmodifiable(final Reference2BooleanMap <K> m) { return new UnmodifiableMap <>(m); }
