...
public final class Reference2LongMaps {
	...
	public static <K> ObjectIterator<Reference2LongMap.Entry <K> > fastIterator(Reference2LongMap <K> map) {
	 ...
	 return entries instanceof Reference2LongMap.FastEntrySet ? ((Reference2LongMap.FastEntrySet <K>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> void fastForEach(Reference2LongMap <K> map, final Consumer<? super Reference2LongMap.Entry <K> > consumer) {
	 final ObjectSet<Reference2LongMap.Entry <K> > entries = map.reference2LongEntrySet();
	 if (entries instanceof Reference2LongMap.FastEntrySet) ((Reference2LongMap.FastEntrySet <K>) entries).fastForEach(consumer);
	...
	public static <K> ObjectIterable<Reference2LongMap.Entry <K> > fastIterable(Reference2LongMap <K> map) {
	 ...
	 return entries instanceof Reference2LongMap.FastEntrySet ? new ObjectIterable<Reference2LongMap.Entry <K> >() {
	  public ObjectIterator<Reference2LongMap.Entry <K> > iterator() { return ((Reference2LongMap.FastEntrySet <K>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Reference2LongMap.Entry <K> > consumer) { ((Reference2LongMap.FastEntrySet <K>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <K> extends Reference2LongFunctions.Singleton <K> implements Reference2LongMap <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Reference2LongMap.Entry <K> > reference2LongEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry <>(key, value)); return entries; }
	 ...
	 @Override
	 public int hashCode() { return ( System.identityHashCode(key) ) ^ it.unimi.dsi.fastutil.HashCommon.long2int(value); }
	...
	public static <K> Reference2LongMap <K> singleton(final K key, long value) { return new Singleton <>(key, value); }
	...
	public static <K> Reference2LongMap <K> singleton(final K key, final Long value) { return new Singleton <>((key), (value).longValue()); }
	...
	public static class SynchronizedMap <K> extends Reference2LongFunctions.SynchronizedFunction <K> implements Reference2LongMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Reference2LongMap.Entry <K> > reference2LongEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.reference2LongEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public long computeLongIfAbsentPartial(final K key, final Reference2LongFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeLongIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <K> Reference2LongMap <K> synchronize(final Reference2LongMap <K> m) { return new SynchronizedMap <>(m); }
	...
	public static <K> Reference2LongMap <K> synchronize(final Reference2LongMap <K> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <K> extends Reference2LongFunctions.UnmodifiableFunction <K> implements Reference2LongMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public long computeLongIfAbsentPartial(final K key, final Reference2LongFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <K> Reference2LongMap <K> unmodifiable(final Reference2LongMap <K> m) { return new UnmodifiableMap <>(m); }
