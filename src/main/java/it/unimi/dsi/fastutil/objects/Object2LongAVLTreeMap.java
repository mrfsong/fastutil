...
public class Object2LongAVLTreeMap <K> extends AbstractObject2LongSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2LongMap.Entry <K> > {
	 ...
	 @Override
	 public Object2LongMap.Entry <K> next() { return nextEntry(); }

	 @Override
	 public Object2LongMap.Entry <K> previous() { return previousEntry(); }

	 @Override
	 public void set(Object2LongMap.Entry <K> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Object2LongMap.Entry <K> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry <K> >() {
	   final Comparator<? super Object2LongMap.Entry <K> > comparator = (Comparator<Object2LongMap.Entry <K> >) (x, y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2LongMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2LongMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2LongMap.Entry <K> > iterator(final Object2LongMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2LongAVLTreeMap.this.clear(); }

	   @Override
	   public Object2LongMap.Entry <K> first() { return firstEntry; }

	   @Override
	   public Object2LongMap.Entry <K> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2LongMap.Entry <K> > subSet(Object2LongMap.Entry <K> from, Object2LongMap.Entry <K> to) { return subMap(from.getKey(), to.getKey()).object2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2LongMap.Entry <K> > headSet(Object2LongMap.Entry <K> to) { return headMap(to.getKey()).object2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2LongMap.Entry <K> > tailSet(Object2LongMap.Entry <K> from) { return tailMap(from.getKey()).object2LongEntrySet(); }
	  };
	...
	@Override
	public Object2LongSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2LongSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2LongSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2LongSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2LongMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2LongMap.Entry <K> > iterator(final Object2LongMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2LongMap.Entry <K> > comparator() { return Object2LongAVLTreeMap.this.object2LongEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2LongAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2LongAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
