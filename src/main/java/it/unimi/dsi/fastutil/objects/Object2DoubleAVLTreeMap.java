...
public class Object2DoubleAVLTreeMap <K> extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry <K> extends AbstractObject2DoubleMap.BasicEntry <K> implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return java.util.Objects.equals(key, (e.getKey())) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2DoubleMap.Entry <K> > {
	 ...
	 @Override
	 public Object2DoubleMap.Entry <K> next() { return nextEntry(); }

	 @Override
	 public Object2DoubleMap.Entry <K> previous() { return previousEntry(); }
	...
	public ObjectSortedSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry <K> >() {
	   final Comparator<? super Object2DoubleMap.Entry <K> > comparator = (Comparator<Object2DoubleMap.Entry <K> >) (x, y) -> Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());

	   @Override
	   public Comparator<? super Object2DoubleMap.Entry <K> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Object2DoubleMap.Entry <K> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Object2DoubleMap.Entry <K> > iterator(final Object2DoubleMap.Entry <K> from) { return new EntryIterator(from.getKey()); }
	   ...
	   @Override
	   public void clear() { Object2DoubleAVLTreeMap.this.clear(); }

	   @Override
	   public Object2DoubleMap.Entry <K> first() { return firstEntry; }

	   @Override
	   public Object2DoubleMap.Entry <K> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Object2DoubleMap.Entry <K> > subSet(Object2DoubleMap.Entry <K> from, Object2DoubleMap.Entry <K> to) { return subMap(from.getKey(), to.getKey()).object2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2DoubleMap.Entry <K> > headSet(Object2DoubleMap.Entry <K> to) { return headMap(to.getKey()).object2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Object2DoubleMap.Entry <K> > tailSet(Object2DoubleMap.Entry <K> from) { return tailMap(from.getKey()).object2DoubleEntrySet(); }
	  };
	...
	@Override
	public Object2DoubleSortedMap <K> headMap(K to) { return new Submap((null), true, to, false); }

	@Override
	public Object2DoubleSortedMap <K> tailMap(K from) { return new Submap(from, false, (null), true); }

	@Override
	public Object2DoubleSortedMap <K> subMap(K from, K to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry <K> >() {
	    @Override
	    public ObjectBidirectionalIterator<Object2DoubleMap.Entry <K> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Object2DoubleMap.Entry <K> > iterator(final Object2DoubleMap.Entry <K> from) { return new SubmapEntryIterator(from.getKey()); }
	    @Override
	    public Comparator<? super Object2DoubleMap.Entry <K> > comparator() { return Object2DoubleAVLTreeMap.this.object2DoubleEntrySet().comparator(); }
	    @Override
	    @SuppressWarnings("unchecked")
	    public boolean contains(final Object o) {
	     if (!(o instanceof Map.Entry)) return false;
	    ...
	    public boolean remove(final Object o) {
	     ...
	     final Object2DoubleAVLTreeMap.Entry <K> f = findKey(((K) e.getKey()));
	     if (f != null && in(f.key)) Submap.this.removeDouble(f.key);
	     return f != null;
	    }
	    @Override
	    public int size() {
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2DoubleAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2DoubleAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }

	 private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Object2DoubleMap.Entry <K> > {
	  SubmapEntryIterator() {}
	  SubmapEntryIterator(final K k) { super(k); }
