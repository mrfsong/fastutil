...
public final class Reference2ByteSortedMaps {
	...
	public static class UnmodifiableSortedMap <K> extends Reference2ByteMaps.UnmodifiableMap <K> implements Reference2ByteSortedMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Reference2ByteMap.Entry <K> > reference2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable(sortedMap.reference2ByteEntrySet()); return (ObjectSortedSet<Reference2ByteMap.Entry <K> >)entries; }
