...
public class Object2DoubleRBTreeMap <K> extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry <K> >() {
	   final Comparator<? super Object2DoubleMap.Entry <K> > comparator = (Comparator<Object2DoubleMap.Entry <K> >) (x, y) -> Object2DoubleRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	   ...
	   @Override
	   public void clear() { Object2DoubleRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractObject2DoubleSortedMap <K> implements java.io.Serializable {
	 ...
	 public Submap(final K from, final boolean bottom, final K to, final boolean top) {
	  if (! bottom && ! top && Object2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry <K> >() {
	    ...
	    @Override
	    public Comparator<? super Object2DoubleMap.Entry <K> > comparator() { return Object2DoubleRBTreeMap.this.object2DoubleEntrySet().comparator(); }
	 ...
	 public DoubleCollection values() {
	  ...
	  return values;
	    ...
	    @Override
	 @SuppressWarnings("unchecked")
	 public boolean containsKey(final Object k) { return in((K) k) && Object2DoubleRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Object2DoubleRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Object2DoubleRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
