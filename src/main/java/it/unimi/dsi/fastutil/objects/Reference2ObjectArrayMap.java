...
public class Reference2ObjectArrayMap <K,V> extends AbstractReference2ObjectMap <K,V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean contains(Object o) {
	  ...
	  return Reference2ObjectArrayMap.this.containsKey(k) && java.util.Objects.equals(Reference2ObjectArrayMap.this.get(k), (e.getValue()));
	 }
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (oldPos == -1 || ! java.util.Objects.equals(v, Reference2ObjectArrayMap.this.value[oldPos])) return false;
	...
	@Override
	public FastEntrySet <K,V> reference2ObjectEntrySet() { return new EntrySet(); }
