...
public final class Reference2ReferenceFunctions {
	 ...
	 */
	public static <K,V> Reference2ReferenceFunction <K,V> synchronize(final Reference2ReferenceFunction <K,V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <K,V> Reference2ReferenceFunction <K,V> synchronize(final Reference2ReferenceFunction <K,V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <K,V> Reference2ReferenceFunction <K,V> unmodifiable(final Reference2ReferenceFunction <K,V> f) { return new UnmodifiableFunction <>(f); }
}
