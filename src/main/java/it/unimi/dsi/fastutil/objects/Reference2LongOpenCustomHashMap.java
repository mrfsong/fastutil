...
public class Reference2LongOpenCustomHashMap <K> extends AbstractReference2LongMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f, final Strategy <? super K> strategy) {
	...
	public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final Strategy <? super K> strategy) {
	...
	public Reference2LongOpenCustomHashMap(final Reference2LongMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Reference2LongOpenCustomHashMap(final K[] k, final long[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 @Override
	 public ObjectIterator<Reference2LongMap.Entry <K> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Reference2LongMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Reference2LongOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Reference2LongMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractReference2LongMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == (null) )) consumer.accept(new AbstractReference2LongMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractReferenceSet <K> {
	 ...
	 @Override
	 public void clear() { Reference2LongOpenCustomHashMap.this.clear();}
	}
