...
public class Float2LongOpenCustomHashMap extends AbstractFloat2LongMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2LongOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2LongOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2LongOpenCustomHashMap(final Map<? extends Float, ? extends Long> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2LongOpenCustomHashMap(final Map<? extends Float, ? extends Long> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2LongOpenCustomHashMap(final Float2LongMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2LongOpenCustomHashMap(final Float2LongMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2LongOpenCustomHashMap(final float[] k, final long[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2LongOpenCustomHashMap(final float[] k, final long[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Long> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public long compute(final float k, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public long merge(final float k, final long v, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2LongMap.Entry , Map.Entry<Float, Long> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).longValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2LongMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2LongMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2LongOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2LongMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2LongMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2LongMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2LongOpenCustomHashMap.this.clear();}
	}
