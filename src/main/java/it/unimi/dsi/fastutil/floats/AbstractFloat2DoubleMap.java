	...
	public static class BasicEntry implements Float2DoubleMap.Entry {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Float2DoubleMap.Entry) {
	   ...
	   return ( Float.floatToIntBits(key) == Float.floatToIntBits(e.getFloatKey()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits(e.getDoubleValue()) );
	  }
	  ...
	  return ( Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)(key)).floatValue()) ) && ( Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)(value)).doubleValue()) );
	 }
