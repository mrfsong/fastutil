...
public final class Float2ReferenceMaps {
	...
	public static <V> ObjectIterator<Float2ReferenceMap.Entry <V> > fastIterator(Float2ReferenceMap <V> map) {
	 ...
	 return entries instanceof Float2ReferenceMap.FastEntrySet ? ((Float2ReferenceMap.FastEntrySet <V>) entries).fastIterator() : entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <V> void fastForEach(Float2ReferenceMap <V> map, final Consumer<? super Float2ReferenceMap.Entry <V> > consumer) {
	 final ObjectSet<Float2ReferenceMap.Entry <V> > entries = map.float2ReferenceEntrySet();
	 if (entries instanceof Float2ReferenceMap.FastEntrySet) ((Float2ReferenceMap.FastEntrySet <V>) entries).fastForEach(consumer);
	...
	public static <V> ObjectIterable<Float2ReferenceMap.Entry <V> > fastIterable(Float2ReferenceMap <V> map) {
	 ...
	 return entries instanceof Float2ReferenceMap.FastEntrySet ? new ObjectIterable<Float2ReferenceMap.Entry <V> >() {
	  public ObjectIterator<Float2ReferenceMap.Entry <V> > iterator() { return ((Float2ReferenceMap.FastEntrySet <V>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Float2ReferenceMap.Entry <V> > consumer) { ((Float2ReferenceMap.FastEntrySet <V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <V> extends Float2ReferenceFunctions.Singleton <V> implements Float2ReferenceMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <V> Float2ReferenceMap <V> singleton(final float key, V value) { return new Singleton <>(key, value); }
	...
	public static <V> Float2ReferenceMap <V> singleton(final Float key, final V value) { return new Singleton <>((key).floatValue(), (value)); }
	...
	public static class SynchronizedMap <V> extends Float2ReferenceFunctions.SynchronizedFunction <V> implements Float2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.float2ReferenceEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public V computeIfAbsentPartial(final float key, final Float2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <V> Float2ReferenceMap <V> synchronize(final Float2ReferenceMap <V> m) { return new SynchronizedMap <>(m); }
	...
	public static <V> Float2ReferenceMap <V> synchronize(final Float2ReferenceMap <V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <V> extends Float2ReferenceFunctions.UnmodifiableFunction <V> implements Float2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final float key, final Float2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <V> Float2ReferenceMap <V> unmodifiable(final Float2ReferenceMap <V> m) { return new UnmodifiableMap <>(m); }
