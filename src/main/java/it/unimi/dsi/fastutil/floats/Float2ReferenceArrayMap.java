...
public class Float2ReferenceArrayMap <V> extends AbstractFloat2ReferenceMap <V> implements java.io.Serializable, Cloneable {
	...
	@Override
	public FastEntrySet <V> float2ReferenceEntrySet() { return new EntrySet(); }
