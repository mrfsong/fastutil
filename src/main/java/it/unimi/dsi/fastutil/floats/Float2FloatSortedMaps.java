...
public final class Float2FloatSortedMaps {
	...
	public static class Singleton extends Float2FloatMaps.Singleton implements Float2FloatSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2FloatMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2FloatMap.Entry >)entries; }
	...
	public static Float2FloatSortedMap singleton(final Float key, Float value) { return new Singleton ((key).floatValue(), (value).floatValue());}
	...
	public static Float2FloatSortedMap singleton(final Float key, Float value, FloatComparator comparator) { return new Singleton ((key).floatValue(), (value).floatValue(), comparator); }
