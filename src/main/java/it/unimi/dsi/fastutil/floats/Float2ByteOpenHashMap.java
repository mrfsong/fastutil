...
public class Float2ByteOpenHashMap extends AbstractFloat2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Float2ByteMap.Entry , Map.Entry<Float, Byte> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key[index]) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value[index]) == ((e.getValue()).byteValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Float.floatToIntBits(k) == 0 )) return Float2ByteOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2ByteOpenHashMap.this.clear();}
	}
