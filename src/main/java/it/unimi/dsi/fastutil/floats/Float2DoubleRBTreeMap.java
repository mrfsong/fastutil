...
public class Float2DoubleRBTreeMap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2DoubleMap.Entry > float2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry >() {
	   final Comparator<? super Float2DoubleMap.Entry > comparator = (Comparator<Float2DoubleMap.Entry >) (x, y) -> Float2DoubleRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
	   ...
	   @Override
	   public void clear() { Float2DoubleRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2DoubleMap.Entry > float2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Float2DoubleMap.Entry > comparator() { return Float2DoubleRBTreeMap.this.float2DoubleEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final float k) { return in( k) && Float2DoubleRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2DoubleRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2DoubleRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
