...
public interface Float2CharMap extends Float2CharFunction , Map<Float,Character> {
	...
	default char replace(final float key, final char value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default char computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Character> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final char v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default char computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	default char compute(final float key, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final char oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Character newValue = remappingFunction.apply(Float.valueOf(key), contained ? Character.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default char merge(final float key, final char value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Float key, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Float key, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Float key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
