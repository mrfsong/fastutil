...
public final class Float2LongMaps {
	...
	public static void fastForEach(Float2LongMap map, final Consumer<? super Float2LongMap.Entry > consumer) {
	 final ObjectSet<Float2LongMap.Entry > entries = map.float2LongEntrySet();
	 if (entries instanceof Float2LongMap.FastEntrySet) ((Float2LongMap.FastEntrySet ) entries).fastForEach(consumer);
	...
	public static ObjectIterable<Float2LongMap.Entry > fastIterable(Float2LongMap map) {
	 ...
	 return entries instanceof Float2LongMap.FastEntrySet ? new ObjectIterable<Float2LongMap.Entry >() {
	  ...
	  public void forEach(final Consumer<? super Float2LongMap.Entry > consumer) { ((Float2LongMap.FastEntrySet )entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton extends Float2LongFunctions.Singleton implements Float2LongMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Float2LongMap.Entry > float2LongEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractFloat2LongMap.BasicEntry (key, value)); return entries; }
	...
	public static class SynchronizedMap extends Float2LongFunctions.SynchronizedFunction implements Float2LongMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Float2LongMap.Entry > float2LongEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.float2LongEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public long getOrDefault(final float key, final long defaultValue) { synchronized(sync) { return map.getOrDefault(key, defaultValue); } }

	 @Override
	 public void forEach(final java.util.function.BiConsumer<? super Float, ? super Long> action) { synchronized (sync) { map.forEach(action); } }

	 @Override
	 public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> function) { synchronized (sync) { map.replaceAll(function); } }

	 @Override
	 public long putIfAbsent(final float key, final long value) { synchronized(sync) { return map.putIfAbsent(key, value); } }

	 @Override
	 public boolean remove(final float key, final long value) { synchronized(sync) { return map.remove(key, value); } }

	 @Override
	 public long replace(final float key, final long value) { synchronized(sync) { return map.replace(key, value); } }

	 @Override
	 public boolean replace(final float key, final long oldValue, final long newValue) { synchronized(sync) { return map.replace(key, oldValue, newValue); } }


	 @Override
	 public long computeIfAbsent(final float key, final java.util.function.DoubleToLongFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }



	 @Override
	 public long computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Long> mappingFunction) { synchronized(sync) { return map.computeIfAbsentNullable(key, mappingFunction); } }



	 @Override
	 public long computeIfAbsentPartial(final float key, final Float2LongFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }


	 @Override
	 public long computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
	  synchronized (sync) { return map.computeIfPresent(key, remappingFunction); }
	 }

	 @Override
	 public long compute(final float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
	  synchronized (sync) { return map.compute(key, remappingFunction); }
	 }

	 @Override
	 public long merge(final float key, final long value, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
	 ...
	 @Override
	 public Long computeIfAbsent(final Float key, final java.util.function.Function<? super Float, ? extends Long> mappingFunction) { synchronized (sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 ...
	 @Override
	 public Long computeIfPresent(final Float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) { synchronized (sync) { return map.computeIfPresent(key, remappingFunction); } }
	 ...
	 @Override
	 public Long compute(final Float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) { synchronized (sync) { return map.compute(key, remappingFunction); } }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Long merge(final Float key, final Long value, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) { synchronized (sync) { return map.merge(key, value, remappingFunction); } }
	...
	public static class UnmodifiableMap extends Float2LongFunctions.UnmodifiableFunction implements Float2LongMap , java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final float key, final long defaultValue) { return map.getOrDefault(key, defaultValue); }

	 @Override
	 public void forEach(final java.util.function.BiConsumer<? super Float, ? super Long> action) { map.forEach(action); }

	 @Override
	 public void replaceAll(final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> function) { throw new UnsupportedOperationException(); }

	 @Override
	 public long putIfAbsent(final float key, final long value) { throw new UnsupportedOperationException(); }

	 @Override
	 public boolean remove(final float key, final long value) { throw new UnsupportedOperationException(); }

	 @Override
	 public long replace(final float key, final long value) { throw new UnsupportedOperationException(); }

	 @Override
	 public boolean replace(final float key, final long oldValue, final long newValue) { throw new UnsupportedOperationException(); }


	 @Override
	 public long computeIfAbsent(final float key, final java.util.function.DoubleToLongFunction mappingFunction) { throw new UnsupportedOperationException(); }



	 @Override
	 public long computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Long> mappingFunction) { throw new UnsupportedOperationException(); }



	 @Override
	 public long computeIfAbsentPartial(final float key, final Float2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }


	 @Override
	 public long computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) { throw new UnsupportedOperationException(); }

	 @Override
	 public long compute(final float key, final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) { throw new UnsupportedOperationException(); }

	 @Override
	 public long merge(final float key, final long value, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 @Override
	 public Long computeIfAbsent(final Float key, final java.util.function.Function<? super Float, ? extends Long> mappingFunction) { throw new UnsupportedOperationException(); }
