...
public final class Float2DoubleMaps {
	...
	public static class SynchronizedMap extends Float2DoubleFunctions.SynchronizedFunction implements Float2DoubleMap , java.io.Serializable {
	 ...
	 @Override
	 public double computeIfAbsentPartial(final float key, final Float2DoubleFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Float2DoubleFunctions.UnmodifiableFunction implements Float2DoubleMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Float2DoubleMap.Entry > float2DoubleEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.float2DoubleEntrySet()); return entries; }
	 ...
	 @Override
	 public double computeIfAbsentPartial(final float key, final Float2DoubleFunction mappingFunction) { throw new UnsupportedOperationException(); }
