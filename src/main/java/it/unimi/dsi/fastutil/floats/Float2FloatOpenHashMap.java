...
public class Float2FloatOpenHashMap extends AbstractFloat2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	public float addTo(final float k, final float incr) {
	 ...
	 if (( Float.floatToIntBits(k) == 0 )) {
	  ...
	  if (! ( Float.floatToIntBits(curr = key[pos = it.unimi.dsi.fastutil.HashCommon.mix( it.unimi.dsi.fastutil.HashCommon.float2int(k) ) & mask]) == 0 )) {
	   if (( Float.floatToIntBits(curr) == Float.floatToIntBits(k) )) return addToValue(pos, incr);
	...
	public boolean remove(final float k, final float v) {
	 ...
	 // The starting point.
	 if (( Float.floatToIntBits(curr = key[pos = it.unimi.dsi.fastutil.HashCommon.mix( it.unimi.dsi.fastutil.HashCommon.float2int(k) ) & mask]) == 0 )) return false;
	 if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) ) && ( Float.floatToIntBits(v) == Float.floatToIntBits(value[pos]) )) {
	  removeEntry(pos);
	  return true;
	 }
	 while(true) {
	...
	final class MapEntry implements Float2FloatMap.Entry , Map.Entry<Float, Float> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key[index]) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( Float.floatToIntBits(value[index]) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }

	 @Override
	 public int hashCode() {
	  return it.unimi.dsi.fastutil.HashCommon.float2int(key[index]) ^ it.unimi.dsi.fastutil.HashCommon.float2int(value[index]);
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Float.floatToIntBits(k) == 0 )) return Float2FloatOpenHashMap.this.containsNullKey && ( Float.floatToIntBits(value[n]) == Float.floatToIntBits(v) );
	  ...
	  // The starting point.
	  if (( Float.floatToIntBits(curr = key[pos = it.unimi.dsi.fastutil.HashCommon.mix( it.unimi.dsi.fastutil.HashCommon.float2int(k) ) & mask]) == 0 )) return false;
	  if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) )) return ( Float.floatToIntBits(value[pos]) == Float.floatToIntBits(v) );
	  // There's always an unused entry.
	  while(true) {
	   if (( Float.floatToIntBits(curr = key[pos = (pos + 1) & mask]) == 0 )) return false;
	   if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) )) return ( Float.floatToIntBits(value[pos]) == Float.floatToIntBits(v) );
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2FloatOpenHashMap.this.clear();}
	}
