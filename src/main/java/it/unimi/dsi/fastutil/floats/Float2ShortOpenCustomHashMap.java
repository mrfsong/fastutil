...
public class Float2ShortOpenCustomHashMap extends AbstractFloat2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2ShortOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ShortOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ShortOpenCustomHashMap(final Map<? extends Float, ? extends Short> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ShortOpenCustomHashMap(final Map<? extends Float, ? extends Short> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ShortOpenCustomHashMap(final Float2ShortMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2ShortOpenCustomHashMap(final Float2ShortMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2ShortOpenCustomHashMap(final float[] k, final short[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ShortOpenCustomHashMap(final float[] k, final short[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public short compute(final float k, final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public short merge(final float k, final short v, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2ShortMap.Entry , Map.Entry<Float, Short> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).shortValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2ShortMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2ShortMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2ShortOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2ShortMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2ShortMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2ShortMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2ShortOpenCustomHashMap.this.clear();}
	}
