...
public interface FloatPriorityQueue extends PriorityQueue<Float> {
	...
	default float lastFloat() { throw new UnsupportedOperationException(); }
	...
	@Deprecated
	@Override
	default void enqueue(final Float x) { enqueue(x.floatValue()); }
	...
	@Deprecated
	@Override
	default Float dequeue() { return Float.valueOf(dequeueFloat()); }
	...
	@Deprecated
	@Override
	default Float first() { return Float.valueOf(firstFloat()); }
