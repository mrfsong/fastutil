...
public abstract class AbstractFloat2ReferenceSortedMap <V> extends AbstractFloat2ReferenceMap <V> implements Float2ReferenceSortedMap <V> {
	...
	protected class KeySet extends AbstractFloatSortedSet {
	 ...
	 @Override
	 public FloatBidirectionalIterator iterator(final float from) { return new KeySetIterator <>(float2ReferenceEntrySet().iterator(new BasicEntry <>(from, (null)))); }

	 @Override
	 public FloatBidirectionalIterator iterator() { return new KeySetIterator <>(Float2ReferenceSortedMaps.fastIterator(AbstractFloat2ReferenceSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractReferenceCollection <V> {
	 @Override
	 public ObjectIterator <V> iterator() { return new ValuesIterator <>(Float2ReferenceSortedMaps.fastIterator(AbstractFloat2ReferenceSortedMap.this)); }
