...
public abstract class AbstractFloatBigList extends AbstractFloatCollection implements FloatBigList , FloatStack {
	 ...
	 */
	@Override
	public boolean contains(final float k) { return indexOf(k) >= 0; }
	 ...
	 */
	@Override
	public boolean addAll(final long index, final FloatCollection c) { return addAll(index, (Collection<? extends Float>)c); }
	 ...
	 */
	@Override
	public boolean addAll(final long index, final FloatBigList l) { return addAll(index, (FloatCollection)l); }
	 ...
	 */
	@Override
	public boolean addAll(final FloatCollection c) { return addAll(size64(), c); }
	 ...
	 */
	@Override
	public boolean addAll(final FloatBigList l) { return addAll(size64(), l); }
	...
	@Deprecated
	@Override
	public void add(final long index, final Float ok) { add(index, ok.floatValue()); }
	...
	@Deprecated
	@Override
	public Float set(final long index, final Float ok) { return Float.valueOf(set(index, ok.floatValue())); }
	...
	@Deprecated
	@Override
	public Float get(final long index) { return Float.valueOf(getFloat(index)); }
	...
	@Deprecated
	@Override
	public long indexOf(final Object ok) { return indexOf(((Float)(ok)).floatValue()); }
	...
	@Deprecated
	@Override
	public long lastIndexOf(final Object ok) { return lastIndexOf(((Float)(ok)).floatValue()); }
	...
	@Deprecated
	@Override
	public Float remove(final long index) { return Float.valueOf(removeFloat(index)); }
	...
	@Deprecated
	@Override
	public void push(Float o) { push(o.floatValue()); }
	...
	@Deprecated
	@Override
	public Float pop() { return Float.valueOf(popFloat()); }
	...
	@Deprecated
	@Override
	public Float top() { return Float.valueOf(topFloat()); }
	...
	@Deprecated
	@Override
	public Float peek(int i) { return Float.valueOf(peekFloat(i)); }
