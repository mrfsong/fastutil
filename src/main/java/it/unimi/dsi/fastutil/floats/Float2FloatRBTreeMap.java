...
public class Float2FloatRBTreeMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry >() {
	   final Comparator<? super Float2FloatMap.Entry > comparator = (Comparator<Float2FloatMap.Entry >) (x, y) -> Float2FloatRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
	   ...
	   @Override
	   public void clear() { Float2FloatRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Float2FloatMap.Entry > comparator() { return Float2FloatRBTreeMap.this.float2FloatEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final float k) { return in( k) && Float2FloatRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2FloatRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2FloatRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
