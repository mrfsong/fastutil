...
public final class FloatComparators {
	...
	protected static class OppositeComparator implements FloatComparator , java.io.Serializable {
	 ...
	 protected OppositeComparator(final FloatComparator c) { comparator = c; }

	 @Override
	 public final int compare(final float a, final float b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static FloatComparator oppositeComparator(final FloatComparator c) { return new OppositeComparator (c); }
