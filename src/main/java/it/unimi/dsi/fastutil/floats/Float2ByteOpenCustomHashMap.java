...
public class Float2ByteOpenCustomHashMap extends AbstractFloat2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2ByteOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ByteOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ByteOpenCustomHashMap(final Map<? extends Float, ? extends Byte> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ByteOpenCustomHashMap(final Map<? extends Float, ? extends Byte> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ByteOpenCustomHashMap(final Float2ByteMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2ByteOpenCustomHashMap(final Float2ByteMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2ByteOpenCustomHashMap(final float[] k, final byte[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ByteOpenCustomHashMap(final float[] k, final byte[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Byte> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Byte, ? extends Byte> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public byte compute(final float k, final java.util.function.BiFunction<? super Float, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public byte merge(final float k, final byte v, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2ByteMap.Entry , Map.Entry<Float, Byte> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).byteValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2ByteMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2ByteMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2ByteOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2ByteMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2ByteMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2ByteMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2ByteOpenCustomHashMap.this.clear();}
	}
