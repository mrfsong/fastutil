...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2BooleanOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2BooleanOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2BooleanOpenCustomHashMap(final Map<? extends Float, ? extends Boolean> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2BooleanOpenCustomHashMap(final Map<? extends Float, ? extends Boolean> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2BooleanOpenCustomHashMap(final Float2BooleanMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2BooleanOpenCustomHashMap(final Float2BooleanMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2BooleanOpenCustomHashMap(final float[] k, final boolean[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2BooleanOpenCustomHashMap(final float[] k, final boolean[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	final class MapEntry implements Float2BooleanMap.Entry , Map.Entry<Float, Boolean> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).booleanValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2BooleanMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2BooleanMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2BooleanOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2BooleanMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2BooleanMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2BooleanMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2BooleanOpenCustomHashMap.this.clear();}
	}
