...
public final class Float2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final float k) { return (false); }
	...
	public static class Singleton extends AbstractFloat2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Float2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean test(double operand) { synchronized(sync) { return function.test(operand); } }
	 ...
	 @Override
	 public Boolean apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public boolean put(final float k, final boolean v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public boolean get(final float k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public boolean remove(final float k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Float2BooleanFunction synchronize(final Float2BooleanFunction f) { return new SynchronizedFunction (f); }
	...
	public static Float2BooleanFunction synchronize(final Float2BooleanFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractFloat2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean get(final float k) { return function.get(k); }
	 ...
	 */
	public static Float2BooleanFunction unmodifiable(final Float2BooleanFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Float2BooleanFunction {
	 ...
	 @Deprecated
	 @Override
	 public Boolean put(final Float key, final Boolean value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Float2BooleanFunction primitive(final java.util.function.Function<? super Float, ? extends Boolean> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Float2BooleanFunction) return (Float2BooleanFunction ) f;
