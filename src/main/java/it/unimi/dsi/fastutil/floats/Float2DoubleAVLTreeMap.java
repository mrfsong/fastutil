...
public class Float2DoubleAVLTreeMap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	public boolean containsValue(final double v) {
	 ...
	 while(j-- != 0) {
	  ev = i.nextDouble();
	  if (( Double.doubleToLongBits(ev) == Double.doubleToLongBits(v) )) return true;
	 }
	...
	private static final class Entry extends AbstractFloat2DoubleMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2DoubleMap.Entry > {
	 ...
	 @Override
	 public Float2DoubleMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2DoubleMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2DoubleMap.Entry > float2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry >() {
	   final Comparator<? super Float2DoubleMap.Entry > comparator = (Comparator<Float2DoubleMap.Entry >) (x, y) -> Float2DoubleAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2DoubleMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2DoubleMap.Entry > iterator(final Float2DoubleMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   public boolean remove(final Object o) {
	    ...
	    final Entry f = findKey(((Float)(e.getKey())).floatValue());
	    if (f == null || ! ( Double.doubleToLongBits(f.getDoubleValue()) == Double.doubleToLongBits(((Double)(e.getValue())).doubleValue()) )) return false;
	   ...
	   @Override
	   public void clear() { Float2DoubleAVLTreeMap.this.clear(); }

	   @Override
	   public Float2DoubleMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2DoubleMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2DoubleMap.Entry > subSet(Float2DoubleMap.Entry from, Float2DoubleMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2DoubleMap.Entry > headSet(Float2DoubleMap.Entry to) { return headMap(to.getFloatKey()).float2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2DoubleMap.Entry > tailSet(Float2DoubleMap.Entry from) { return tailMap(from.getFloatKey()).float2DoubleEntrySet(); }
	  };
	...
	@Override
	public Float2DoubleSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2DoubleSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2DoubleSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2DoubleMap.Entry > float2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2DoubleMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2DoubleMap.Entry > iterator(final Float2DoubleMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2DoubleMap.Entry > comparator() { return Float2DoubleAVLTreeMap.this.float2DoubleEntrySet().comparator(); }
	    @Override
	 ...
	 public DoubleCollection values() {
	  if (values == null) values = new AbstractDoubleCollection () {
	    @Override
	    public DoubleIterator iterator() { return new SubmapValueIterator(); }
	    @Override
	    public boolean contains(final double k) { return containsValue(k); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2DoubleAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2DoubleAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
