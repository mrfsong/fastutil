...
public final class Float2ByteSortedMaps {
	...
	public static class Singleton extends Float2ByteMaps.Singleton implements Float2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ByteMap.Entry > float2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ByteMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2ByteMap.Entry >)entries; }
	...
	public static Float2ByteSortedMap singleton(final Float key, Byte value) { return new Singleton ((key).floatValue(), (value).byteValue());}
	...
	public static Float2ByteSortedMap singleton(final Float key, Byte value, FloatComparator comparator) { return new Singleton ((key).floatValue(), (value).byteValue(), comparator); }
