...
public final class Float2FloatMaps {
	...
	public static class SynchronizedMap extends Float2FloatFunctions.SynchronizedFunction implements Float2FloatMap , java.io.Serializable {
	 ...
	 @Override
	 public float computeIfAbsentPartial(final float key, final Float2FloatFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	...
	public static class UnmodifiableMap extends Float2FloatFunctions.UnmodifiableFunction implements Float2FloatMap , java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Float2FloatMap.Entry > float2FloatEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.float2FloatEntrySet()); return entries; }
	 ...
	 @Override
	 public float computeIfAbsentPartial(final float key, final Float2FloatFunction mappingFunction) { throw new UnsupportedOperationException(); }
