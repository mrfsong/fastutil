...
public final class FloatBigListIterators {
	 ...
	 */
	public static FloatBigListIterator unmodifiable(final FloatBigListIterator i) { return new UnmodifiableBigListIterator (i); }
	...
	public static class BigListIteratorListIterator implements FloatBigListIterator {
	 ...
	 @Override
	 public void set(float ok) { i.set(ok); }

	 @Override
	 public void add(float ok) { i.add(ok); }
	  ...
	  */
	public static FloatBigListIterator asBigListIterator(final FloatListIterator i) { return new BigListIteratorListIterator (i); }
}
