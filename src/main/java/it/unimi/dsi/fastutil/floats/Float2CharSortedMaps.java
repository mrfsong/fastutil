...
public final class Float2CharSortedMaps {
	...
	public static class Singleton extends Float2CharMaps.Singleton implements Float2CharSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2CharMap.Entry > float2CharEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2CharMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2CharMap.Entry >)entries; }
	...
	public static Float2CharSortedMap singleton(final Float key, Character value) { return new Singleton ((key).floatValue(), (value).charValue());}
	...
	public static Float2CharSortedMap singleton(final Float key, Character value, FloatComparator comparator) { return new Singleton ((key).floatValue(), (value).charValue(), comparator); }
