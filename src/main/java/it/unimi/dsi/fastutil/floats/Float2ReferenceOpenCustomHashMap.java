...
public class Float2ReferenceOpenCustomHashMap <V> extends AbstractFloat2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2ReferenceOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ReferenceOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ReferenceOpenCustomHashMap(final Map<? extends Float, ? extends V> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ReferenceOpenCustomHashMap(final Map<? extends Float, ? extends V> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ReferenceOpenCustomHashMap(final Float2ReferenceMap <V> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2ReferenceOpenCustomHashMap(final Float2ReferenceMap <V> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2ReferenceOpenCustomHashMap(final float[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2ReferenceOpenCustomHashMap(final float[] k, final V[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 @Override
	 public ObjectIterator<Float2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2ReferenceMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2ReferenceMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2ReferenceOpenCustomHashMap.this.clear();}
	}
