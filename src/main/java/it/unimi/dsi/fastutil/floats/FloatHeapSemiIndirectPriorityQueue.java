...
public class FloatHeapSemiIndirectPriorityQueue implements FloatIndirectPriorityQueue {
	...
	@Override
	public void allChanged() { FloatSemiIndirectHeaps.makeHeap(refArray, heap, size, c); }
	 ...
	 */
	@Override
	public int front(final int[] a) { return c == null ? FloatSemiIndirectHeaps.front(refArray, heap, size, a) : FloatSemiIndirectHeaps.front(refArray, heap, size, a, c); }
