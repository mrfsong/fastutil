...
public final class Float2DoubleSortedMaps {
	...
	public static class Singleton extends Float2DoubleMaps.Singleton implements Float2DoubleSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2DoubleMap.Entry > float2DoubleEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2DoubleMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2DoubleMap.Entry >)entries; }
	...
	public static Float2DoubleSortedMap singleton(final Float key, Double value) { return new Singleton ((key).floatValue(), (value).doubleValue());}
	...
	public static Float2DoubleSortedMap singleton(final Float key, Double value, FloatComparator comparator) { return new Singleton ((key).floatValue(), (value).doubleValue(), comparator); }
