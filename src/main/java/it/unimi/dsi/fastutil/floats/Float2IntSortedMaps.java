...
public final class Float2IntSortedMaps {
	...
	public static class Singleton extends Float2IntMaps.Singleton implements Float2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2IntMap.Entry > float2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2IntMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2IntMap.Entry >)entries; }
	...
	public static Float2IntSortedMap singleton(final Float key, Integer value) { return new Singleton ((key).floatValue(), (value).intValue());}
	...
	public static Float2IntSortedMap singleton(final Float key, Integer value, FloatComparator comparator) { return new Singleton ((key).floatValue(), (value).intValue(), comparator); }
