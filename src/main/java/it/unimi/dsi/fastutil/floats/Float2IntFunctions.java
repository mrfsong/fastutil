...
public final class Float2IntFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final float k) { return (0); }
	...
	public static class Singleton extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Float2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public Integer apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public int put(final float k, final int v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public int get(final float k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public int remove(final float k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Float k, final Integer v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Float2IntFunction synchronize(final Float2IntFunction f) { return new SynchronizedFunction (f); }
	...
	public static Float2IntFunction synchronize(final Float2IntFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractFloat2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int get(final float k) { return function.get(k); }
	 ...
	 */
	public static Float2IntFunction unmodifiable(final Float2IntFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Float2IntFunction {
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Float key, final Integer value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Float2IntFunction primitive(final java.util.function.Function<? super Float, ? extends Integer> f) {
	 ...
	 if (f instanceof Float2IntFunction) return (Float2IntFunction ) f;
