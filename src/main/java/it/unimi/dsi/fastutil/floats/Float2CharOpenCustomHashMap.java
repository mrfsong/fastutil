...
public class Float2CharOpenCustomHashMap extends AbstractFloat2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2CharOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2CharOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2CharOpenCustomHashMap(final Map<? extends Float, ? extends Character> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2CharOpenCustomHashMap(final Map<? extends Float, ? extends Character> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2CharOpenCustomHashMap(final Float2CharMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2CharOpenCustomHashMap(final Float2CharMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2CharOpenCustomHashMap(final float[] k, final char[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2CharOpenCustomHashMap(final float[] k, final char[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Character> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final float k, final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 final Character newValue = remappingFunction.apply(Float.valueOf(k), pos >= 0 ? Character.valueOf(value[pos]) : null);
	 if (newValue == null) {
	  if (pos >= 0) {
	   if (( strategy.equals( (k), (0) ) )) removeNullEntry();
	   else removeEntry(pos);
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final float k, final char v, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2CharMap.Entry , Map.Entry<Float, Character> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).charValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2CharMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2CharMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2CharOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2CharMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2CharMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2CharMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2CharOpenCustomHashMap.this.clear();}
	}
