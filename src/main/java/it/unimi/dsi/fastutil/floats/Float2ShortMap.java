...
public interface Float2ShortMap extends Float2ShortFunction , Map<Float,Short> {
	...
	default short replace(final float key, final short value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default short computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final short v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default short computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> remappingFunction) {
	...
	default short compute(final float key, final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default short merge(final float key, final short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Short computeIfAbsent(final Float key, final java.util.function.Function<? super Float, ? extends Short> mappingFunction) {
