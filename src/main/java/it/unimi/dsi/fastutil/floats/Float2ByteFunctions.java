...
public final class Float2ByteFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final float k) { return ((byte)0); }
	...
	public static class Singleton extends AbstractFloat2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Float2ByteFunction , java.io.Serializable {
	 ...
	 @Override
	 public Byte apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public byte put(final float k, final byte v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public byte get(final float k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public byte remove(final float k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Float2ByteFunction synchronize(final Float2ByteFunction f) { return new SynchronizedFunction (f); }
	...
	public static Float2ByteFunction synchronize(final Float2ByteFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractFloat2ByteFunction implements java.io.Serializable {
	 ...
	 @Override
	 public byte get(final float k) { return function.get(k); }
	 ...
	 */
	public static Float2ByteFunction unmodifiable(final Float2ByteFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Float2ByteFunction {
	 ...
	 @Deprecated
	 @Override
	 public Byte put(final Float key, final Byte value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Float2ByteFunction primitive(final java.util.function.Function<? super Float, ? extends Byte> f) {
	 ...
	 if (f instanceof Float2ByteFunction) return (Float2ByteFunction ) f;

	 if (f instanceof java.util.function.DoubleToIntFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToByte(((java.util.function.DoubleToIntFunction ) f).applyAsInt(key));
