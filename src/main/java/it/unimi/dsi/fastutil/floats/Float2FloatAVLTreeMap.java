...
public class Float2FloatAVLTreeMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractFloat2FloatMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( Float.floatToIntBits(value) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2FloatMap.Entry > {
	 ...
	 @Override
	 public Float2FloatMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2FloatMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry >() {
	   final Comparator<? super Float2FloatMap.Entry > comparator = (Comparator<Float2FloatMap.Entry >) (x, y) -> Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2FloatMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2FloatMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2FloatMap.Entry > iterator(final Float2FloatMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   @Override
	   public void clear() { Float2FloatAVLTreeMap.this.clear(); }

	   @Override
	   public Float2FloatMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2FloatMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2FloatMap.Entry > subSet(Float2FloatMap.Entry from, Float2FloatMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2FloatMap.Entry > headSet(Float2FloatMap.Entry to) { return headMap(to.getFloatKey()).float2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2FloatMap.Entry > tailSet(Float2FloatMap.Entry from) { return tailMap(from.getFloatKey()).float2FloatEntrySet(); }
	  };
	...
	@Override
	public Float2FloatSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2FloatSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2FloatSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2FloatMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2FloatMap.Entry > iterator(final Float2FloatMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2FloatMap.Entry > comparator() { return Float2FloatAVLTreeMap.this.float2FloatEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2FloatAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2FloatAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
