...
public interface FloatBigListIterator extends FloatBidirectionalIterator , BigListIterator<Float> {
	...
	default void set(@SuppressWarnings("unused") final float k) { throw new UnsupportedOperationException(); }
	...
	default void add(@SuppressWarnings("unused") final float k) { throw new UnsupportedOperationException(); }
