...
public class Float2IntAVLTreeMap extends AbstractFloat2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractFloat2IntMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value) == ((e.getValue()).intValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2IntMap.Entry > {
	 ...
	 @Override
	 public Float2IntMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2IntMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2IntMap.Entry > float2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2IntMap.Entry >() {
	   final Comparator<? super Float2IntMap.Entry > comparator = (Comparator<Float2IntMap.Entry >) (x, y) -> Float2IntAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2IntMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2IntMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2IntMap.Entry > iterator(final Float2IntMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   public boolean remove(final Object o) {
	    ...
	    final Entry f = findKey(((Float)(e.getKey())).floatValue());
	    if (f == null || ! ( (f.getIntValue()) == (((Integer)(e.getValue())).intValue()) )) return false;
	   ...
	   @Override
	   public void clear() { Float2IntAVLTreeMap.this.clear(); }

	   @Override
	   public Float2IntMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2IntMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2IntMap.Entry > subSet(Float2IntMap.Entry from, Float2IntMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2IntMap.Entry > headSet(Float2IntMap.Entry to) { return headMap(to.getFloatKey()).float2IntEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2IntMap.Entry > tailSet(Float2IntMap.Entry from) { return tailMap(from.getFloatKey()).float2IntEntrySet(); }
	  };
	...
	@Override
	public Float2IntSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2IntSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2IntSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2IntSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2IntAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2IntMap.Entry > float2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2IntMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2IntMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2IntMap.Entry > iterator(final Float2IntMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2IntMap.Entry > comparator() { return Float2IntAVLTreeMap.this.float2IntEntrySet().comparator(); }
	    @Override
	 ...
	 public IntCollection values() {
	  if (values == null) values = new AbstractIntCollection () {
	    @Override
	    public IntIterator iterator() { return new SubmapValueIterator(); }
	    @Override
	    public boolean contains(final int k) { return containsValue(k); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2IntAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2IntAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
