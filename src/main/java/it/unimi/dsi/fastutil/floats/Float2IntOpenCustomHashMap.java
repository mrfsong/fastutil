...
public class Float2IntOpenCustomHashMap extends AbstractFloat2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2IntOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2IntOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2IntOpenCustomHashMap(final Map<? extends Float, ? extends Integer> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2IntOpenCustomHashMap(final Map<? extends Float, ? extends Integer> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2IntOpenCustomHashMap(final Float2IntMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2IntOpenCustomHashMap(final Float2IntMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2IntOpenCustomHashMap(final float[] k, final int[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2IntOpenCustomHashMap(final float[] k, final int[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public int computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Integer> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public int computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public int compute(final float k, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 final Integer newValue = remappingFunction.apply(Float.valueOf(k), pos >= 0 ? Integer.valueOf(value[pos]) : null);
	 if (newValue == null) {
	  if (pos >= 0) {
	   if (( strategy.equals( (k), (0) ) )) removeNullEntry();
	   else removeEntry(pos);
	...
	/** {@inheritDoc} */
	@Override
	public int merge(final float k, final int v, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2IntMap.Entry , Map.Entry<Float, Integer> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( (value[index]) == ((e.getValue()).intValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2IntMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2IntMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2IntOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Float2IntMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2IntMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2IntMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2IntOpenCustomHashMap.this.clear();}
	}
