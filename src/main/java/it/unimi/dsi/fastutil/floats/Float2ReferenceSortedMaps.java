...
public final class Float2ReferenceSortedMaps {
	...
	public static class EmptySortedMap <V> extends Float2ReferenceMaps.EmptyMap <V> implements Float2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { return ObjectSortedSets.EMPTY_SET; }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> subMap(final float from, final float to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> headMap(final float to) { return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> tailMap(final float from) { return EMPTY_MAP; }
	 ...
	 @Deprecated
	 @Override
	 public Float2ReferenceSortedMap <V> headMap(Float oto) { return headMap((oto).floatValue()); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Float2ReferenceSortedMap <V> tailMap(Float ofrom) { return tailMap((ofrom).floatValue()); }

	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Float2ReferenceSortedMap <V> subMap(Float ofrom, Float oto) { return subMap((ofrom).floatValue(), (oto).floatValue()); }
	...
	public static class Singleton <V> extends Float2ReferenceMaps.Singleton <V> implements Float2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Float2ReferenceMap.Entry <V> >)entries; }
	 ...
	 public ObjectSortedSet<Map.Entry<Float, V>> entrySet() { return (ObjectSortedSet)float2ReferenceEntrySet(); }
	 ...
	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> subMap(final float from, final float to) { if (compare(from, key) <= 0 && compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> headMap(final float to) { if (compare(key, to) < 0) return this; return EMPTY_MAP; }

	 @SuppressWarnings("unchecked")
	 @Override
	 public Float2ReferenceSortedMap <V> tailMap(final float from) { if (compare(from, key) <= 0) return this; return EMPTY_MAP; }
	...
	public static <V> Float2ReferenceSortedMap <V> singleton(final float key, final V value, FloatComparator comparator) {
	...
	public static class SynchronizedSortedMap <V> extends Float2ReferenceMaps.SynchronizedMap <V> implements Float2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.float2ReferenceEntrySet(), sync); return (ObjectSortedSet<Float2ReferenceMap.Entry <V> >)entries; }
	 ...
	 @Override
	 public Float2ReferenceSortedMap <V> subMap(final float from, final float to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Float2ReferenceSortedMap <V> headMap(final float to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Float2ReferenceSortedMap <V> tailMap(final float from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	...
	public static class UnmodifiableSortedMap <V> extends Float2ReferenceMaps.UnmodifiableMap <V> implements Float2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable(sortedMap.float2ReferenceEntrySet()); return (ObjectSortedSet<Float2ReferenceMap.Entry <V> >)entries; }
	 ...
	 @Override
	 public Float2ReferenceSortedMap <V> subMap(final float from, final float to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Float2ReferenceSortedMap <V> headMap(final float to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Float2ReferenceSortedMap <V> tailMap(final float from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
