...
public class Float2DoubleOpenHashMap extends AbstractFloat2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	public boolean remove(final float k, final double v) {
	 ...
	 // The starting point.
	 if (( Float.floatToIntBits(curr = key[pos = it.unimi.dsi.fastutil.HashCommon.mix( it.unimi.dsi.fastutil.HashCommon.float2int(k) ) & mask]) == 0 )) return false;
	 if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) ) && ( Double.doubleToLongBits(v) == Double.doubleToLongBits(value[pos]) )) {
	  removeEntry(pos);
	  return true;
	 }
	 while(true) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( Float.floatToIntBits(k) == 0 )) return Float2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	  ...
	  // The starting point.
	  if (( Float.floatToIntBits(curr = key[pos = it.unimi.dsi.fastutil.HashCommon.mix( it.unimi.dsi.fastutil.HashCommon.float2int(k) ) & mask]) == 0 )) return false;
	  if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) )) return ( Double.doubleToLongBits(value[pos]) == Double.doubleToLongBits(v) );
	  // There's always an unused entry.
	  while(true) {
	   if (( Float.floatToIntBits(curr = key[pos = (pos + 1) & mask]) == 0 )) return false;
	   if (( Float.floatToIntBits(k) == Float.floatToIntBits(curr) )) return ( Double.doubleToLongBits(value[pos]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2DoubleOpenHashMap.this.clear();}
	}
