...
public final class Float2CharFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final float k) { return ((char)0); }
	...
	public static class Singleton extends AbstractFloat2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Float2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public int applyAsInt(double operand) { synchronized(sync) { return function.applyAsInt(operand); } }
	 ...
	 @Override
	 public Character apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public char put(final float k, final char v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public char get(final float k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public char remove(final float k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Float k, final Character v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Float2CharFunction synchronize(final Float2CharFunction f) { return new SynchronizedFunction (f); }
	...
	public static Float2CharFunction synchronize(final Float2CharFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractFloat2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char get(final float k) { return function.get(k); }
	 ...
	 */
	public static Float2CharFunction unmodifiable(final Float2CharFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Float2CharFunction {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Float key, final Character value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Float2CharFunction primitive(final java.util.function.Function<? super Float, ? extends Character> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Float2CharFunction) return (Float2CharFunction ) f;

	 if (f instanceof java.util.function.DoubleToIntFunction)


	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.DoubleToIntFunction ) f).applyAsInt(key));
