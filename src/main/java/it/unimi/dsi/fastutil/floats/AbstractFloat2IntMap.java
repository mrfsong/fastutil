	...
	public static class BasicEntry implements Float2IntMap.Entry {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Float2IntMap.Entry) {
	   ...
	   return ( Float.floatToIntBits(key) == Float.floatToIntBits(e.getFloatKey()) ) && ( (value) == (e.getIntValue()) );
	  }
	  ...
	  return ( Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)(key)).floatValue()) ) && ( (this.value) == (((Integer)(value)).intValue()) );
	 }
