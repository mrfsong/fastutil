...
public final class Float2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final float k) { return ((short)0); }
	...
	public static class Singleton extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Float2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public Short apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public short put(final float k, final short v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public short get(final float k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public short remove(final float k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Float2ShortFunction synchronize(final Float2ShortFunction f) { return new SynchronizedFunction (f); }
	...
	public static Float2ShortFunction synchronize(final Float2ShortFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractFloat2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short get(final float k) { return function.get(k); }
	 ...
	 */
	public static Float2ShortFunction unmodifiable(final Float2ShortFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Float2ShortFunction {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Float key, final Short value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Float2ShortFunction primitive(final java.util.function.Function<? super Float, ? extends Short> f) {
	 ...
	 if (f instanceof Float2ShortFunction) return (Float2ShortFunction ) f;
