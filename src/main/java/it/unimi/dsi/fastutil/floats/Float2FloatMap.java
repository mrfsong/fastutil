...
public interface Float2FloatMap extends Float2FloatFunction , Map<Float,Float> {
	...
	default float replace(final float key, final float value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default float computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Float> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final float v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default float computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	...
	default float compute(final float key, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final float oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default float merge(final float key, final float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
