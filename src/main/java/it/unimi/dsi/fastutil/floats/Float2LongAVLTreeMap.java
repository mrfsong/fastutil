...
public class Float2LongAVLTreeMap extends AbstractFloat2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractFloat2LongMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value) == ((e.getValue()).longValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2LongMap.Entry > {
	 ...
	 @Override
	 public Float2LongMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2LongMap.Entry previous() { return previousEntry(); }
	...
	public ObjectSortedSet<Float2LongMap.Entry > float2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2LongMap.Entry >() {
	   final Comparator<? super Float2LongMap.Entry > comparator = (Comparator<Float2LongMap.Entry >) (x, y) -> Float2LongAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2LongMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2LongMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2LongMap.Entry > iterator(final Float2LongMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   @Override
	   public void clear() { Float2LongAVLTreeMap.this.clear(); }

	   @Override
	   public Float2LongMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2LongMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2LongMap.Entry > subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2LongMap.Entry > headSet(Float2LongMap.Entry to) { return headMap(to.getFloatKey()).float2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2LongMap.Entry > tailSet(Float2LongMap.Entry from) { return tailMap(from.getFloatKey()).float2LongEntrySet(); }
	  };
	...
	@Override
	public Float2LongSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2LongSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2LongSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2LongSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2LongMap.Entry > float2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2LongMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2LongMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2LongMap.Entry > iterator(final Float2LongMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2LongMap.Entry > comparator() { return Float2LongAVLTreeMap.this.float2LongEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2LongAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2LongAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
