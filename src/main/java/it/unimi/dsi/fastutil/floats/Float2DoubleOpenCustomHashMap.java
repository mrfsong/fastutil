...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2DoubleOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2DoubleOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	public boolean containsValue(final double v) {
	 ...
	 for(int i = n; i-- != 0;) if (! ( Float.floatToIntBits(key[i]) == 0 ) && ( Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v) )) return true;
	 return false;
	}
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final float k, final java.util.function.DoubleFunction<? extends Double> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super Double, ? extends Double> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final float k, final java.util.function.BiFunction<? super Float, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final float k, final double v, final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Float2DoubleMap.Entry , Map.Entry<Float, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Float2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Float2DoubleMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2DoubleOpenCustomHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	 ...
	 public void forEach(final Consumer<? super Float2DoubleMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2DoubleMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2DoubleMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 @Override
	 public void clear() { Float2DoubleOpenCustomHashMap.this.clear();}
	}
