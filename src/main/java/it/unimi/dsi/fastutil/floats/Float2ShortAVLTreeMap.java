...
public class Float2ShortAVLTreeMap extends AbstractFloat2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractFloat2ShortMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value) == ((e.getValue()).shortValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2ShortMap.Entry > {
	 ...
	 @Override
	 public Float2ShortMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2ShortMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2ShortMap.Entry > float2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2ShortMap.Entry >() {
	   final Comparator<? super Float2ShortMap.Entry > comparator = (Comparator<Float2ShortMap.Entry >) (x, y) -> Float2ShortAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2ShortMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2ShortMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2ShortMap.Entry > iterator(final Float2ShortMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   @Override
	   public void clear() { Float2ShortAVLTreeMap.this.clear(); }

	   @Override
	   public Float2ShortMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2ShortMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2ShortMap.Entry > subSet(Float2ShortMap.Entry from, Float2ShortMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2ShortMap.Entry > headSet(Float2ShortMap.Entry to) { return headMap(to.getFloatKey()).float2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2ShortMap.Entry > tailSet(Float2ShortMap.Entry from) { return tailMap(from.getFloatKey()).float2ShortEntrySet(); }
	  };
	...
	@Override
	public Float2ShortSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2ShortSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2ShortSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2ShortSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2ShortMap.Entry > float2ShortEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2ShortMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2ShortMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2ShortMap.Entry > iterator(final Float2ShortMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2ShortMap.Entry > comparator() { return Float2ShortAVLTreeMap.this.float2ShortEntrySet().comparator(); }
	    @Override
	 ...
	 public ShortCollection values() {
	  if (values == null) values = new AbstractShortCollection () {
	    @Override
	    public ShortIterator iterator() { return new SubmapValueIterator(); }
	    @Override
	    public boolean contains(final short k) { return containsValue(k); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2ShortAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2ShortAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
