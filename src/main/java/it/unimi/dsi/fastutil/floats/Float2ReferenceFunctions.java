...
public final class Float2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public static <V> Float2ReferenceFunction <V> synchronize(final Float2ReferenceFunction <V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <V> Float2ReferenceFunction <V> synchronize(final Float2ReferenceFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 */
	public static <V> Float2ReferenceFunction <V> unmodifiable(final Float2ReferenceFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static <V> Float2ReferenceFunction <V> primitive(final java.util.function.Function<? super Float, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Float2ReferenceFunction) return (Float2ReferenceFunction <V>) f;
