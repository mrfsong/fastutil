...
public interface Float2IntMap extends Float2IntFunction , Map<Float,Integer> {
	...
	default int replace(final float key, final int value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default int computeIfAbsentNullable(final float key, final java.util.function.DoubleFunction<? extends Integer> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default int computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	default int compute(final float key, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Integer newValue = remappingFunction.apply(Float.valueOf(key), contained ? Integer.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default int merge(final float key, final int value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Float key, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Float key, final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Float key, final Integer value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
