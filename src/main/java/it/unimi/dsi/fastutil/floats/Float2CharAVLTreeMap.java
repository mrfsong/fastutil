...
public class Float2CharAVLTreeMap extends AbstractFloat2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractFloat2CharMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value) == ((e.getValue()).charValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2CharMap.Entry > {
	 ...
	 @Override
	 public Float2CharMap.Entry next() { return nextEntry(); }

	 @Override
	 public Float2CharMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2CharMap.Entry > float2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2CharMap.Entry >() {
	   final Comparator<? super Float2CharMap.Entry > comparator = (Comparator<Float2CharMap.Entry >) (x, y) -> Float2CharAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2CharMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2CharMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2CharMap.Entry > iterator(final Float2CharMap.Entry from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   @Override
	   public void clear() { Float2CharAVLTreeMap.this.clear(); }

	   @Override
	   public Float2CharMap.Entry first() { return firstEntry; }

	   @Override
	   public Float2CharMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2CharMap.Entry > subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2CharMap.Entry > headSet(Float2CharMap.Entry to) { return headMap(to.getFloatKey()).float2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2CharMap.Entry > tailSet(Float2CharMap.Entry from) { return tailMap(from.getFloatKey()).float2CharEntrySet(); }
	  };
	...
	@Override
	public Float2CharSortedMap headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2CharSortedMap tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2CharSortedMap subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2CharSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2CharMap.Entry > float2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2CharMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2CharMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2CharMap.Entry > iterator(final Float2CharMap.Entry from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2CharMap.Entry > comparator() { return Float2CharAVLTreeMap.this.float2CharEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2CharAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2CharAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
