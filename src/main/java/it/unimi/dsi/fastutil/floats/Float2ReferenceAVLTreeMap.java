...
public class Float2ReferenceAVLTreeMap <V> extends AbstractFloat2ReferenceSortedMap <V> implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry <V> extends AbstractFloat2ReferenceMap.BasicEntry <V> implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()) ) && ( (value) == ((e.getValue())) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2ReferenceMap.Entry <V> > {
	 ...
	 @Override
	 public Float2ReferenceMap.Entry <V> next() { return nextEntry(); }

	 @Override
	 public Float2ReferenceMap.Entry <V> previous() { return previousEntry(); }

	 @Override
	 public void set(Float2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Float2ReferenceMap.Entry <V> ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Float2ReferenceMap.Entry <V> > comparator = (Comparator<Float2ReferenceMap.Entry <V> >) (x, y) -> Float2ReferenceAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());

	   @Override
	   public Comparator<? super Float2ReferenceMap.Entry <V> > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Float2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Float2ReferenceMap.Entry <V> > iterator(final Float2ReferenceMap.Entry <V> from) { return new EntryIterator(from.getFloatKey()); }
	   ...
	   @Override
	   public void clear() { Float2ReferenceAVLTreeMap.this.clear(); }

	   @Override
	   public Float2ReferenceMap.Entry <V> first() { return firstEntry; }

	   @Override
	   public Float2ReferenceMap.Entry <V> last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Float2ReferenceMap.Entry <V> > subSet(Float2ReferenceMap.Entry <V> from, Float2ReferenceMap.Entry <V> to) { return subMap(from.getFloatKey(), to.getFloatKey()).float2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2ReferenceMap.Entry <V> > headSet(Float2ReferenceMap.Entry <V> to) { return headMap(to.getFloatKey()).float2ReferenceEntrySet(); }

	   @Override
	   public ObjectSortedSet<Float2ReferenceMap.Entry <V> > tailSet(Float2ReferenceMap.Entry <V> from) { return tailMap(from.getFloatKey()).float2ReferenceEntrySet(); }
	  };
	...
	@Override
	public FloatComparator comparator() { return actualComparator; }

	@Override
	public Float2ReferenceSortedMap <V> headMap(float to) { return new Submap((0), true, to, false); }

	@Override
	public Float2ReferenceSortedMap <V> tailMap(float from) { return new Submap(from, false, (0), true); }

	@Override
	public Float2ReferenceSortedMap <V> subMap(float from, float to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractFloat2ReferenceSortedMap <V> implements java.io.Serializable {
	 ...
	 public Submap(final float from, final boolean bottom, final float to, final boolean top) {
	  if (! bottom && ! top && Float2ReferenceAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry <V> >() {
	    @Override
	    public ObjectBidirectionalIterator<Float2ReferenceMap.Entry <V> > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Float2ReferenceMap.Entry <V> > iterator(final Float2ReferenceMap.Entry <V> from) { return new SubmapEntryIterator(from.getFloatKey()); }
	    @Override
	    public Comparator<? super Float2ReferenceMap.Entry <V> > comparator() { return Float2ReferenceAVLTreeMap.this.float2ReferenceEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Float2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Float2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }

	 private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Float2ReferenceMap.Entry <V> > {
	  SubmapEntryIterator() {}
	  SubmapEntryIterator(final float k) { super(k); }
