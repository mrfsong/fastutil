...
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2DoubleOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2DoubleOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2DoubleOpenCustomHashMap(final Map<? extends Short, ? extends Double> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2DoubleOpenCustomHashMap(final Map<? extends Short, ? extends Double> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2DoubleOpenCustomHashMap(final Short2DoubleMap m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Short2DoubleOpenCustomHashMap(final Short2DoubleMap m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Short2DoubleOpenCustomHashMap(final short[] k, final double[] v, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2DoubleOpenCustomHashMap(final short[] k, final double[] v, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public boolean containsValue(final double v) {
	 ...
	 for(int i = n; i-- != 0;) if (! ( (key[i]) == ((short)0) ) && ( Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v) )) return true;
	 return false;
	}
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final short k, final java.util.function.IntFunction<? extends Double> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final short k, final java.util.function.BiFunction<? super Short, ? super Double, ? extends Double> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final short k, final java.util.function.BiFunction<? super Short, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final short k, final double v, final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Short2DoubleMap.Entry , Map.Entry<Short, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).shortValue()) ) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Short2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Short2DoubleMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), ((short)0) ) )) return Short2DoubleOpenCustomHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	 ...
	 public void forEach(final Consumer<? super Short2DoubleMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractShort2DoubleMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == ((short)0) )) consumer.accept(new AbstractShort2DoubleMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2DoubleOpenCustomHashMap.this.clear();}
	}
