...
public interface ShortPriorityQueue extends PriorityQueue<Short> {
	...
	@Deprecated
	@Override
	default void enqueue(final Short x) { enqueue(x.shortValue()); }
	...
	@Deprecated
	@Override
	default Short dequeue() { return Short.valueOf(dequeueShort()); }
	...
	@Deprecated
	@Override
	default Short first() { return Short.valueOf(firstShort()); }
