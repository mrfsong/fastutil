...
public final class Short2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractShort2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	...
	public static class Singleton <V> extends AbstractShort2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public static <V> Short2ReferenceFunction <V> synchronize(final Short2ReferenceFunction <V> f) { return new SynchronizedFunction <>(f); }
	...
	public static <V> Short2ReferenceFunction <V> synchronize(final Short2ReferenceFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }



	/** An unmodifiable wrapper class for functions. */

	public static class UnmodifiableFunction <V> extends AbstractShort2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 */
	public static <V> Short2ReferenceFunction <V> unmodifiable(final Short2ReferenceFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static <V> Short2ReferenceFunction <V> primitive(final java.util.function.Function<? super Short, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Short2ReferenceFunction) return (Short2ReferenceFunction <V>) f;
