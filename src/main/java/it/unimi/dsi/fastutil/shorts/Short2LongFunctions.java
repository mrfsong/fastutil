...
public final class Short2LongFunctions {
	...
	public static class Singleton extends AbstractShort2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public Long apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	...
	public static class PrimitiveFunction implements Short2LongFunction {
	 ...
	 @Deprecated
	 @Override
	 public Long put(final Short key, final Long value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2LongFunction primitive(final java.util.function.Function<? super Short, ? extends Long> f) {
	 ...
	 if (f instanceof Short2LongFunction) return (Short2LongFunction ) f;
