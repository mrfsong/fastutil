...
public class ShortLinkedOpenCustomHashSet extends AbstractShortSortedSet implements java.io.Serializable, Cloneable, Hash {
	...
	public ShortLinkedOpenCustomHashSet(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final Collection<? extends Short> c, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final Collection<? extends Short> c, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final ShortCollection c, final float f, it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	this(c.size(), f, strategy);
	 addAll(c);
	}
	/** Creates a new hash set  with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor
	...
	public ShortLinkedOpenCustomHashSet(final ShortCollection c, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public ShortLinkedOpenCustomHashSet(final ShortIterator i, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final ShortIterator i, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final Iterator<?> i, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final Iterator<?> i, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final short[] a, final int offset, final int length, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final short[] a, final int offset, final int length, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final short[] a, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortLinkedOpenCustomHashSet(final short[] a, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private class SetIterator implements ShortListIterator {
	 ...
	 public short nextShort() {
	  ...
	  if (index >= 0) index++;
	  if (ASSERTS) assert curr == n || ! ( (key[curr]) == ((short)0) ) : "Position " + curr + " is not used";
	  return key[curr];
	 }
	...
	protected void rehash(final int newN) {
	 ...
	 for(int j = size; j-- != 0;) {
	  if (( strategy.equals( (key[i]), ((short)0) ) )) pos = newN;
	  else {
