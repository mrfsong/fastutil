...
public final class Short2ByteFunctions {
	...
	public static class EmptyFunction extends AbstractShort2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final short k) { return ((byte)0); }
	...
	public static class Singleton extends AbstractShort2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2ByteFunction , java.io.Serializable {
	 ...
	 @Override
	 public Byte apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public byte put(final short k, final byte v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public byte get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public byte remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Short2ByteFunction synchronize(final Short2ByteFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2ByteFunction synchronize(final Short2ByteFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2ByteFunction implements java.io.Serializable {
	 ...
	 @Override
	 public byte get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2ByteFunction unmodifiable(final Short2ByteFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2ByteFunction {
	 ...
	 @Deprecated
	 @Override
	 public Byte put(final Short key, final Byte value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2ByteFunction primitive(final java.util.function.Function<? super Short, ? extends Byte> f) {
	 ...
	 if (f instanceof Short2ByteFunction) return (Short2ByteFunction ) f;
