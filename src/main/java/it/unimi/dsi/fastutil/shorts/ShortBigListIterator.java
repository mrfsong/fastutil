...
public interface ShortBigListIterator extends ShortBidirectionalIterator , BigListIterator<Short> {
	...
	default void set(@SuppressWarnings("unused") final short k) { throw new UnsupportedOperationException(); }
	...
	default void add(@SuppressWarnings("unused") final short k) { throw new UnsupportedOperationException(); }
