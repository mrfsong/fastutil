...
public class Short2FloatRBTreeMap extends AbstractShort2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2FloatMap.Entry > short2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry >() {
	   final Comparator<? super Short2FloatMap.Entry > comparator = (Comparator<Short2FloatMap.Entry >) (x, y) -> Short2FloatRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2FloatRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2FloatRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2FloatMap.Entry > short2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2FloatMap.Entry > comparator() { return Short2FloatRBTreeMap.this.short2FloatEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2FloatRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2FloatRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2FloatRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
