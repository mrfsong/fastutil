...
public class Short2ByteAVLTreeMap extends AbstractShort2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2ByteMap.Entry > {
	 ...
	 @Override
	 public Short2ByteMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2ByteMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2ByteMap.Entry >() {
	   final Comparator<? super Short2ByteMap.Entry > comparator = (Comparator<Short2ByteMap.Entry >) (x, y) -> Short2ByteAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2ByteMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2ByteMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2ByteMap.Entry > iterator(final Short2ByteMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2ByteAVLTreeMap.this.clear(); }

	   @Override
	   public Short2ByteMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2ByteMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2ByteMap.Entry > subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2ByteEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2ByteMap.Entry > headSet(Short2ByteMap.Entry to) { return headMap(to.getShortKey()).short2ByteEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2ByteMap.Entry > tailSet(Short2ByteMap.Entry from) { return tailMap(from.getShortKey()).short2ByteEntrySet(); }
	  };
	...
	@Override
	public Short2ByteSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2ByteSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2ByteSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2ByteSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2ByteAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2ByteMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2ByteMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2ByteMap.Entry > iterator(final Short2ByteMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2ByteMap.Entry > comparator() { return Short2ByteAVLTreeMap.this.short2ByteEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2ByteAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2ByteAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
