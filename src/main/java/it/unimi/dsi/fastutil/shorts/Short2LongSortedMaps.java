...
public final class Short2LongSortedMaps {
	...
	public static class Singleton extends Short2LongMaps.Singleton implements Short2LongSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2LongMap.Entry > short2LongEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2LongMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Short2LongMap.Entry >)entries; }
	...
	public static Short2LongSortedMap singleton(final Short key, Long value) { return new Singleton ((key).shortValue(), (value).longValue());}
	...
	public static Short2LongSortedMap singleton(final Short key, Long value, ShortComparator comparator) { return new Singleton ((key).shortValue(), (value).longValue(), comparator); }
