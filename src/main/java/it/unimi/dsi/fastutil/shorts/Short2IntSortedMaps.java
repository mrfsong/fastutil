...
public final class Short2IntSortedMaps {
	...
	public static class Singleton extends Short2IntMaps.Singleton implements Short2IntSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2IntMap.Entry > short2IntEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2IntMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Short2IntMap.Entry >)entries; }
	...
	public static Short2IntSortedMap singleton(final Short key, Integer value) { return new Singleton ((key).shortValue(), (value).intValue());}
	...
	public static Short2IntSortedMap singleton(final Short key, Integer value, ShortComparator comparator) { return new Singleton ((key).shortValue(), (value).intValue(), comparator); }
