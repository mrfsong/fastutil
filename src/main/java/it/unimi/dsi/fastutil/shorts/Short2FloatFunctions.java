...
public final class Short2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final short k) { return (0); }
	...
	public static class Singleton extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public Float apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public float put(final short k, final float v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public float get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public float remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Short2FloatFunction synchronize(final Short2FloatFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2FloatFunction synchronize(final Short2FloatFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2FloatFunction unmodifiable(final Short2FloatFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2FloatFunction {
	 ...
	 @Deprecated
	 @Override
	 public Float put(final Short key, final Float value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2FloatFunction primitive(final java.util.function.Function<? super Short, ? extends Float> f) {
	 ...
	 if (f instanceof Short2FloatFunction) return (Short2FloatFunction ) f;
