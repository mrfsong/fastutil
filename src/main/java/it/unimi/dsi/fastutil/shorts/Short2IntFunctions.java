...
public final class Short2IntFunctions {
	...
	public static class EmptyFunction extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final short k) { return (0); }
	...
	public static class Singleton extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public Integer apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public int put(final short k, final int v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public int get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public int remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Short k, final Integer v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Short2IntFunction synchronize(final Short2IntFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2IntFunction synchronize(final Short2IntFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2IntFunction unmodifiable(final Short2IntFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2IntFunction {
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final Short key, final Integer value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2IntFunction primitive(final java.util.function.Function<? super Short, ? extends Integer> f) {
	 ...
	 if (f instanceof Short2IntFunction) return (Short2IntFunction ) f;
