...
public final class Short2CharFunctions {
	...
	public static class EmptyFunction extends AbstractShort2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final short k) { return ((char)0); }
	...
	public static class Singleton extends AbstractShort2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public Character apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public char put(final short k, final char v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public char get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public char remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Short k, final Character v) { synchronized(sync) { return function.put(k, v); } }
	 ...
	 */
	public static Short2CharFunction synchronize(final Short2CharFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2CharFunction synchronize(final Short2CharFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2CharFunction unmodifiable(final Short2CharFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2CharFunction {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final Short key, final Character value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2CharFunction primitive(final java.util.function.Function<? super Short, ? extends Character> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Short2CharFunction) return (Short2CharFunction ) f;
