...
public final class Short2ShortFunctions {
	...
	public static class Singleton extends AbstractShort2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public Short apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	...
	public static class PrimitiveFunction implements Short2ShortFunction {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final Short key, final Short value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2ShortFunction primitive(final java.util.function.Function<? super Short, ? extends Short> f) {
	 ...
	 if (f instanceof Short2ShortFunction) return (Short2ShortFunction ) f;
