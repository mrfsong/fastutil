...
public class Short2ByteRBTreeMap extends AbstractShort2ByteSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2ByteMap.Entry >() {
	   final Comparator<? super Short2ByteMap.Entry > comparator = (Comparator<Short2ByteMap.Entry >) (x, y) -> Short2ByteRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2ByteRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2ByteSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2ByteRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2ByteMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2ByteMap.Entry > comparator() { return Short2ByteRBTreeMap.this.short2ByteEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2ByteRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2ByteRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2ByteRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
