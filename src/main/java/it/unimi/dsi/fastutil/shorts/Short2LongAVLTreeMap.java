...
public class Short2LongAVLTreeMap extends AbstractShort2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2LongMap.Entry > {
	 ...
	 @Override
	 public Short2LongMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2LongMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2LongMap.Entry > short2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2LongMap.Entry >() {
	   final Comparator<? super Short2LongMap.Entry > comparator = (Comparator<Short2LongMap.Entry >) (x, y) -> Short2LongAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2LongMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2LongMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2LongMap.Entry > iterator(final Short2LongMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2LongAVLTreeMap.this.clear(); }

	   @Override
	   public Short2LongMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2LongMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2LongMap.Entry > subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2LongMap.Entry > headSet(Short2LongMap.Entry to) { return headMap(to.getShortKey()).short2LongEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2LongMap.Entry > tailSet(Short2LongMap.Entry from) { return tailMap(from.getShortKey()).short2LongEntrySet(); }
	  };
	...
	@Override
	public Short2LongSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2LongSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2LongSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2LongSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2LongAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2LongMap.Entry > short2LongEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2LongMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2LongMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2LongMap.Entry > iterator(final Short2LongMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2LongMap.Entry > comparator() { return Short2LongAVLTreeMap.this.short2LongEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2LongAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2LongAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
