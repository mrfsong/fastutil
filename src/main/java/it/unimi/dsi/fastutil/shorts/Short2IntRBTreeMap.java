...
public class Short2IntRBTreeMap extends AbstractShort2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2IntMap.Entry > short2IntEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2IntMap.Entry >() {
	   final Comparator<? super Short2IntMap.Entry > comparator = (Comparator<Short2IntMap.Entry >) (x, y) -> Short2IntRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2IntRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2IntSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2IntRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2IntMap.Entry > short2IntEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2IntMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2IntMap.Entry > comparator() { return Short2IntRBTreeMap.this.short2IntEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2IntRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2IntRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2IntRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
