...
public abstract class AbstractShort2BooleanSortedMap extends AbstractShort2BooleanMap implements Short2BooleanSortedMap {
	...
	protected class KeySet extends AbstractShortSortedSet {
	 ...
	 @Override
	 public int size() { return AbstractShort2BooleanSortedMap.this.size(); }

	 @Override
	 public void clear() { AbstractShort2BooleanSortedMap.this.clear(); }

	 @Override
	 public ShortComparator comparator() { return AbstractShort2BooleanSortedMap.this.comparator(); }
	 ...
	 @Override
	 public ShortBidirectionalIterator iterator(final short from) { return new KeySetIterator (short2BooleanEntrySet().iterator(new BasicEntry (from, (false)))); }

	 @Override
	 public ShortBidirectionalIterator iterator() { return new KeySetIterator (Short2BooleanSortedMaps.fastIterator(AbstractShort2BooleanSortedMap.this)); }
	}
	...
	protected class ValuesCollection extends AbstractBooleanCollection {
	 @Override
	 public BooleanIterator iterator() { return new ValuesIterator (Short2BooleanSortedMaps.fastIterator(AbstractShort2BooleanSortedMap.this)); }
