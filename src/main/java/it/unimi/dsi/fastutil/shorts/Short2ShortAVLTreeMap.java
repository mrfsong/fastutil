...
public class Short2ShortAVLTreeMap extends AbstractShort2ShortSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2ShortMap.Entry > {
	 ...
	 @Override
	 public Short2ShortMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2ShortMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2ShortMap.Entry > short2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2ShortMap.Entry >() {
	   final Comparator<? super Short2ShortMap.Entry > comparator = (Comparator<Short2ShortMap.Entry >) (x, y) -> Short2ShortAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2ShortMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2ShortMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2ShortMap.Entry > iterator(final Short2ShortMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2ShortAVLTreeMap.this.clear(); }

	   @Override
	   public Short2ShortMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2ShortMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2ShortMap.Entry > subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2ShortMap.Entry > headSet(Short2ShortMap.Entry to) { return headMap(to.getShortKey()).short2ShortEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2ShortMap.Entry > tailSet(Short2ShortMap.Entry from) { return tailMap(from.getShortKey()).short2ShortEntrySet(); }
	  };
	...
	@Override
	public Short2ShortSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2ShortSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2ShortSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2ShortSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2ShortAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2ShortMap.Entry > short2ShortEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2ShortMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2ShortMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2ShortMap.Entry > iterator(final Short2ShortMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2ShortMap.Entry > comparator() { return Short2ShortAVLTreeMap.this.short2ShortEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2ShortAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2ShortAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
