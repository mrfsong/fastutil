...
public class ShortAVLTreeSet extends AbstractShortSortedSet implements java.io.Serializable, Cloneable, ShortSortedSet {
	...
	*/
	...
	@Override
	public ShortBidirectionalIterator iterator() { return new SetIterator(); }

	@Override
	public ShortBidirectionalIterator iterator(final short from) { return new SetIterator(from); }

	@Override
	public ShortComparator comparator() { return actualComparator; }

	@Override
	public ShortSortedSet headSet(final short to) { return new Subset(((short)0), true, to, false); }

	@Override
	public ShortSortedSet tailSet(final short from) { return new Subset(from, false, ((short)0), true); }

	@Override
	public ShortSortedSet subSet(final short from, final short to) { return new Subset(from, false, to, false); }
	...
	private final class Subset extends AbstractShortSortedSet implements java.io.Serializable, ShortSortedSet {
	 ...
	 @Override
	 public ShortBidirectionalIterator iterator() { return new SubsetIterator(); }

	 @Override
	 public ShortBidirectionalIterator iterator(final short from) { return new SubsetIterator(from); }
