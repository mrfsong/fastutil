...
public final class ShortIndirectHeaps {
	...
	public static int downHeap(final short[] refArray, final int[] heap, final int[] inv, final int size, int i, final ShortComparator c) {
	 assert i < size;
	...
	public static int upHeap(final short[] refArray, final int[] heap, final int[] inv, final int size, int i, final ShortComparator c) {
	 assert i < size;
	...
	public static void makeHeap(final short[] refArray, final int offset, final int length, final int[] heap, final int[] inv, final ShortComparator c) {
	...
	public static void makeHeap(final short[] refArray, final int[] heap, final int[] inv, final int size, final ShortComparator c) {
	 int i = size >>> 1;
