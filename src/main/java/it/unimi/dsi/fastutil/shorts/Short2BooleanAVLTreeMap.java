...
public class Short2BooleanAVLTreeMap extends AbstractShort2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2BooleanMap.Entry > {
	 ...
	 @Override
	 public Short2BooleanMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2BooleanMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry >() {
	   final Comparator<? super Short2BooleanMap.Entry > comparator = (Comparator<Short2BooleanMap.Entry >) (x, y) -> Short2BooleanAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2BooleanMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2BooleanMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2BooleanMap.Entry > iterator(final Short2BooleanMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2BooleanAVLTreeMap.this.clear(); }

	   @Override
	   public Short2BooleanMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2BooleanMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2BooleanMap.Entry > subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2BooleanMap.Entry > headSet(Short2BooleanMap.Entry to) { return headMap(to.getShortKey()).short2BooleanEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2BooleanMap.Entry > tailSet(Short2BooleanMap.Entry from) { return tailMap(from.getShortKey()).short2BooleanEntrySet(); }
	  };
	...
	@Override
	public Short2BooleanSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2BooleanSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2BooleanSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2BooleanSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2BooleanAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2BooleanMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2BooleanMap.Entry > iterator(final Short2BooleanMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2BooleanMap.Entry > comparator() { return Short2BooleanAVLTreeMap.this.short2BooleanEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2BooleanAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2BooleanAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
