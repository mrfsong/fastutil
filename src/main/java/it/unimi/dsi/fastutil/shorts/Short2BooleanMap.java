...
public interface Short2BooleanMap extends Short2BooleanFunction , Map<Short,Boolean> {
	...
	default boolean replace(final short key, final boolean value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default boolean computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Boolean> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final boolean v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default boolean computeIfPresent(final short key, final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	default boolean compute(final short key, final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final boolean oldValue = get(key), drv = defaultReturnValue();
	 final boolean contained = oldValue != drv || containsKey(key);
	 final Boolean newValue = remappingFunction.apply(Short.valueOf(key), contained ? Boolean.valueOf(oldValue) : null);
	 ...
	 * @since 8.0.0
	 */
	default boolean merge(final short key, final boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
