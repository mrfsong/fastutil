...
public class Short2BooleanRBTreeMap extends AbstractShort2BooleanSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry >() {
	   final Comparator<? super Short2BooleanMap.Entry > comparator = (Comparator<Short2BooleanMap.Entry >) (x, y) -> Short2BooleanRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2BooleanRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2BooleanSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2BooleanRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2BooleanMap.Entry > comparator() { return Short2BooleanRBTreeMap.this.short2BooleanEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2BooleanRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2BooleanRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2BooleanRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
