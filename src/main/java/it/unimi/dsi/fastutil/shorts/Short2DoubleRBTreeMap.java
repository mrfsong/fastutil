...
public class Short2DoubleRBTreeMap extends AbstractShort2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2DoubleMap.Entry > short2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry >() {
	   final Comparator<? super Short2DoubleMap.Entry > comparator = (Comparator<Short2DoubleMap.Entry >) (x, y) -> Short2DoubleRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2DoubleRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2DoubleRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2DoubleMap.Entry > short2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2DoubleMap.Entry > comparator() { return Short2DoubleRBTreeMap.this.short2DoubleEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2DoubleRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2DoubleRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2DoubleRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
