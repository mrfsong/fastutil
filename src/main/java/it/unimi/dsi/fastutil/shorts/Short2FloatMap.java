...
public interface Short2FloatMap extends Short2FloatFunction , Map<Short,Float> {
	...
	default float replace(final short key, final float value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default float computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Float> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final float v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default float computeIfPresent(final short key, final java.util.function.BiFunction<? super Short, ? super Float, ? extends Float> remappingFunction) {
	...
	default float compute(final short key, final java.util.function.BiFunction<? super Short, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final float oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default float merge(final short key, final float value, final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
