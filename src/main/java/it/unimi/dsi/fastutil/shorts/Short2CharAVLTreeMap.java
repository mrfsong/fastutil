...
public class Short2CharAVLTreeMap extends AbstractShort2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2CharMap.Entry > {
	 ...
	 @Override
	 public Short2CharMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2CharMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2CharMap.Entry > short2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2CharMap.Entry >() {
	   final Comparator<? super Short2CharMap.Entry > comparator = (Comparator<Short2CharMap.Entry >) (x, y) -> Short2CharAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2CharMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2CharMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2CharMap.Entry > iterator(final Short2CharMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2CharAVLTreeMap.this.clear(); }

	   @Override
	   public Short2CharMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2CharMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2CharMap.Entry > subSet(Short2CharMap.Entry from, Short2CharMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2CharMap.Entry > headSet(Short2CharMap.Entry to) { return headMap(to.getShortKey()).short2CharEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2CharMap.Entry > tailSet(Short2CharMap.Entry from) { return tailMap(from.getShortKey()).short2CharEntrySet(); }
	  };
	...
	@Override
	public Short2CharSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2CharSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2CharSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2CharSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2CharAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2CharMap.Entry > short2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2CharMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2CharMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2CharMap.Entry > iterator(final Short2CharMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2CharMap.Entry > comparator() { return Short2CharAVLTreeMap.this.short2CharEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2CharAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2CharAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
