...
public final class Short2ShortSortedMaps {
	...
	public static class Singleton extends Short2ShortMaps.Singleton implements Short2ShortSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ShortMap.Entry > short2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ShortMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Short2ShortMap.Entry >)entries; }
	...
	public static Short2ShortSortedMap singleton(final Short key, Short value) { return new Singleton ((key).shortValue(), (value).shortValue());}
	...
	public static Short2ShortSortedMap singleton(final Short key, Short value, ShortComparator comparator) { return new Singleton ((key).shortValue(), (value).shortValue(), comparator); }
