...
public final class Short2ReferenceSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Short2ReferenceMap.Entry <V> > fastIterator(Short2ReferenceSortedMap <V> map) {
	 ...
	 return entries instanceof Short2ReferenceSortedMap.FastSortedEntrySet ? ((Short2ReferenceSortedMap.FastSortedEntrySet <V>) entries).fastIterator() : entries.iterator();
	}
	...
	public static <V> ObjectBidirectionalIterable<Short2ReferenceMap.Entry <V> > fastIterable(Short2ReferenceSortedMap <V> map) {
	 final ObjectSortedSet<Short2ReferenceMap.Entry <V> > entries = map.short2ReferenceEntrySet();
	 return entries instanceof Short2ReferenceSortedMap.FastSortedEntrySet ? ((Short2ReferenceSortedMap.FastSortedEntrySet <V>)entries)::fastIterator : entries;
	}
	...
	public static class Singleton <V> extends Short2ReferenceMaps.Singleton <V> implements Short2ReferenceSortedMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ReferenceMap.BasicEntry <>(key, value), entryComparator(comparator)); return (ObjectSortedSet<Short2ReferenceMap.Entry <V> >)entries; }
	...
	public static <V> Short2ReferenceSortedMap <V> singleton(final Short key, V value) { return new Singleton <>((key).shortValue(), (value));}
	...
	public static <V> Short2ReferenceSortedMap <V> singleton(final Short key, V value, ShortComparator comparator) { return new Singleton <>((key).shortValue(), (value), comparator); }
	...
	public static class SynchronizedSortedMap <V> extends Short2ReferenceMaps.SynchronizedMap <V> implements Short2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Short2ReferenceSortedMap <V> subMap(final short from, final short to) { return new SynchronizedSortedMap <>(sortedMap.subMap(from, to), sync); }

	 @Override
	 public Short2ReferenceSortedMap <V> headMap(final short to) { return new SynchronizedSortedMap <>(sortedMap.headMap(to), sync); }

	 @Override
	 public Short2ReferenceSortedMap <V> tailMap(final short from) { return new SynchronizedSortedMap <>(sortedMap.tailMap(from), sync); }
	 ...
	 */
	public static <V> Short2ReferenceSortedMap <V> synchronize(final Short2ReferenceSortedMap <V> m) { return new SynchronizedSortedMap <>(m); }
	...
	public static <V> Short2ReferenceSortedMap <V> synchronize(final Short2ReferenceSortedMap <V> m, final Object sync) { return new SynchronizedSortedMap <>(m, sync); }
	...
	public static class UnmodifiableSortedMap <V> extends Short2ReferenceMaps.UnmodifiableMap <V> implements Short2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public Short2ReferenceSortedMap <V> subMap(final short from, final short to) { return new UnmodifiableSortedMap <>(sortedMap.subMap(from, to)); }

	 @Override
	 public Short2ReferenceSortedMap <V> headMap(final short to) { return new UnmodifiableSortedMap <>(sortedMap.headMap(to)); }

	 @Override
	 public Short2ReferenceSortedMap <V> tailMap(final short from) { return new UnmodifiableSortedMap <>(sortedMap.tailMap(from)); }
	 ...
	 */
	public static <V> Short2ReferenceSortedMap <V> unmodifiable(final Short2ReferenceSortedMap <V> m) { return new UnmodifiableSortedMap <>(m); }
}
