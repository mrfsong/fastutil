...
public class Short2FloatAVLTreeMap extends AbstractShort2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractShort2FloatMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key) == ((e.getKey()).shortValue()) ) && ( Float.floatToIntBits(value) == Float.floatToIntBits((e.getValue()).floatValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2FloatMap.Entry > {
	 ...
	 @Override
	 public Short2FloatMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2FloatMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2FloatMap.Entry > short2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry >() {
	   final Comparator<? super Short2FloatMap.Entry > comparator = (Comparator<Short2FloatMap.Entry >) (x, y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2FloatMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2FloatMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2FloatMap.Entry > iterator(final Short2FloatMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2FloatAVLTreeMap.this.clear(); }

	   @Override
	   public Short2FloatMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2FloatMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2FloatMap.Entry > subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2FloatMap.Entry > headSet(Short2FloatMap.Entry to) { return headMap(to.getShortKey()).short2FloatEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2FloatMap.Entry > tailSet(Short2FloatMap.Entry from) { return tailMap(from.getShortKey()).short2FloatEntrySet(); }
	  };
	...
	@Override
	public Short2FloatSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2FloatSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2FloatSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2FloatSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2FloatAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2FloatMap.Entry > short2FloatEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2FloatMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2FloatMap.Entry > iterator(final Short2FloatMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2FloatMap.Entry > comparator() { return Short2FloatAVLTreeMap.this.short2FloatEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2FloatAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2FloatAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
