...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Short2DoubleMap.Entry , Map.Entry<Short, Double> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).shortValue()) ) && ( Double.doubleToLongBits(value[index]) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == ((short)0) )) return Short2DoubleOpenHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2DoubleOpenHashMap.this.clear();}
	}
