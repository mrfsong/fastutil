...
public class ShortOpenCustomHashSet extends AbstractShortSet implements java.io.Serializable, Cloneable, Hash {
	...
	public ShortOpenCustomHashSet(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final Collection<? extends Short> c, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final Collection<? extends Short> c, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final ShortCollection c, final float f, it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	this(c.size(), f, strategy);
	 addAll(c);
	}
	/** Creates a new hash set  with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor
	...
	public ShortOpenCustomHashSet(final ShortCollection c, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public ShortOpenCustomHashSet(final ShortIterator i, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final ShortIterator i, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final Iterator<?> i, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final short[] a, final int offset, final int length, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final short[] a, final int offset, final int length, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public ShortOpenCustomHashSet(final short[] a, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public boolean contains(final short k) {
	 if (( strategy.equals( (k), ((short)0) ) )) return containsNull;
	...
	private class SetIterator implements ShortIterator {
	 ...
	 public short nextShort() {
	  ...
	  for(;;) {
	   ...
	   if (! ( (key[pos]) == ((short)0) )) return key[last = pos];
	  }
	 }
	...
	private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
	 ...
	 for(int j = size; j-- != 0;) s.writeShort(i.nextShort());
	}
