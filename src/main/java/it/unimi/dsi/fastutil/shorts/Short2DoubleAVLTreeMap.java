...
public class Short2DoubleAVLTreeMap extends AbstractShort2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	*/
	...
	private static final class Entry extends AbstractShort2DoubleMap.BasicEntry implements Cloneable {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key) == ((e.getKey()).shortValue()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()) );
	 }
	...
	*/
	...
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2DoubleMap.Entry > {
	 ...
	 @Override
	 public Short2DoubleMap.Entry next() { return nextEntry(); }

	 @Override
	 public Short2DoubleMap.Entry previous() { return previousEntry(); }

	 @Override
	 public void set(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }

	 @Override
	 public void add(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
	}


	@Override
	public ObjectSortedSet<Short2DoubleMap.Entry > short2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry >() {
	   final Comparator<? super Short2DoubleMap.Entry > comparator = (Comparator<Short2DoubleMap.Entry >) (x, y) -> Short2DoubleAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());

	   @Override
	   public Comparator<? super Short2DoubleMap.Entry > comparator() { return comparator; }

	   @Override
	   public ObjectBidirectionalIterator<Short2DoubleMap.Entry > iterator() { return new EntryIterator(); }

	   @Override
	   public ObjectBidirectionalIterator<Short2DoubleMap.Entry > iterator(final Short2DoubleMap.Entry from) { return new EntryIterator(from.getShortKey()); }
	   ...
	   @Override
	   public void clear() { Short2DoubleAVLTreeMap.this.clear(); }

	   @Override
	   public Short2DoubleMap.Entry first() { return firstEntry; }

	   @Override
	   public Short2DoubleMap.Entry last() { return lastEntry; }

	   @Override
	   public ObjectSortedSet<Short2DoubleMap.Entry > subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry to) { return subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2DoubleMap.Entry > headSet(Short2DoubleMap.Entry to) { return headMap(to.getShortKey()).short2DoubleEntrySet(); }

	   @Override
	   public ObjectSortedSet<Short2DoubleMap.Entry > tailSet(Short2DoubleMap.Entry from) { return tailMap(from.getShortKey()).short2DoubleEntrySet(); }
	  };
	...
	@Override
	public ShortComparator comparator() { return actualComparator; }

	@Override
	public Short2DoubleSortedMap headMap(short to) { return new Submap(((short)0), true, to, false); }

	@Override
	public Short2DoubleSortedMap tailMap(short from) { return new Submap(from, false, ((short)0), true); }

	@Override
	public Short2DoubleSortedMap subMap(short from, short to) { return new Submap(from, false, to, false); }
	...
	private final class Submap extends AbstractShort2DoubleSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2DoubleAVLTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2DoubleMap.Entry > short2DoubleEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry >() {
	    @Override
	    public ObjectBidirectionalIterator<Short2DoubleMap.Entry > iterator() { return new SubmapEntryIterator(); }
	    @Override
	    public ObjectBidirectionalIterator<Short2DoubleMap.Entry > iterator(final Short2DoubleMap.Entry from) { return new SubmapEntryIterator(from.getShortKey()); }
	    @Override
	    public Comparator<? super Short2DoubleMap.Entry > comparator() { return Short2DoubleAVLTreeMap.this.short2DoubleEntrySet().comparator(); }
	    @Override
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2DoubleAVLTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2DoubleAVLTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }

	 private class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Short2DoubleMap.Entry > {
	  SubmapEntryIterator() {}
	  SubmapEntryIterator(final short k) { super(k); }
