...
public abstract class AbstractShortBigList extends AbstractShortCollection implements ShortBigList , ShortStack {
	 ...
	 */
	@Override
	public boolean contains(final short k) { return indexOf(k) >= 0; }
	 ...
	 */
	@Override
	public boolean addAll(final long index, final ShortCollection c) { return addAll(index, (Collection<? extends Short>)c); }
	 ...
	 */
	@Override
	public boolean addAll(final long index, final ShortBigList l) { return addAll(index, (ShortCollection)l); }
	 ...
	 */
	@Override
	public boolean addAll(final ShortCollection c) { return addAll(size64(), c); }
	 ...
	 */
	@Override
	public boolean addAll(final ShortBigList l) { return addAll(size64(), l); }
	...
	@Deprecated
	@Override
	public void add(final long index, final Short ok) { add(index, ok.shortValue()); }
	...
	@Deprecated
	@Override
	public Short set(final long index, final Short ok) { return Short.valueOf(set(index, ok.shortValue())); }
	...
	@Deprecated
	@Override
	public Short get(final long index) { return Short.valueOf(getShort(index)); }
	...
	@Deprecated
	@Override
	public long indexOf(final Object ok) { return indexOf(((Short)(ok)).shortValue()); }
	...
	@Deprecated
	@Override
	public long lastIndexOf(final Object ok) { return lastIndexOf(((Short)(ok)).shortValue()); }
	...
	@Deprecated
	@Override
	public Short remove(final long index) { return Short.valueOf(removeShort(index)); }
	...
	@Deprecated
	@Override
	public void push(Short o) { push(o.shortValue()); }
	...
	@Deprecated
	@Override
	public Short pop() { return Short.valueOf(popShort()); }
	...
	@Deprecated
	@Override
	public Short top() { return Short.valueOf(topShort()); }
	...
	@Deprecated
	@Override
	public Short peek(int i) { return Short.valueOf(peekShort(i)); }
