...
public final class ShortSemiIndirectHeaps {
	...
	public static int downHeap(final short[] refArray, final int[] heap, final int size, int i, final ShortComparator c) {
	 assert i < size;
	...
	public static void makeHeap(final short[] refArray, final int offset, final int length, final int[] heap, final ShortComparator c) {
	 ...
	 * @return the number of elements actually written (starting from the first position of {@code a}).
	 */
	public static int front(final short[] refArray, final int[] heap, final int size, final int[] a, final ShortComparator c) {
	 final short top = refArray[heap[0]];
	 int j = 0, // The current position in a
	  l = 0, // The first position to visit in the next level (inclusive)
	  r = 1, // The last position to visit in the next level (exclusive)
