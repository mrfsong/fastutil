...
public interface Short2ShortMap extends Short2ShortFunction , Map<Short,Short> {
	...
	default short replace(final short key, final short value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default short computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Short> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final short v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default short computeIfPresent(final short key, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	...
	default short compute(final short key, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default short merge(final short key, final short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
