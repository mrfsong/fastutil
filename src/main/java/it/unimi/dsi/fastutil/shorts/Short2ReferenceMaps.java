...
public final class Short2ReferenceMaps {
	...
	public static <V> ObjectIterable<Short2ReferenceMap.Entry <V> > fastIterable(Short2ReferenceMap <V> map) {
	 ...
	 return entries instanceof Short2ReferenceMap.FastEntrySet ? new ObjectIterable<Short2ReferenceMap.Entry <V> >() {
	  public ObjectIterator<Short2ReferenceMap.Entry <V> > iterator() { return ((Short2ReferenceMap.FastEntrySet <V>)entries).fastIterator(); }
	  public void forEach(final Consumer<? super Short2ReferenceMap.Entry <V> > consumer) { ((Short2ReferenceMap.FastEntrySet <V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <V> extends Short2ReferenceFunctions.Singleton <V> implements Short2ReferenceMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractShort2ReferenceMap.BasicEntry <>(key, value)); return entries; }
	...
	public static <V> Short2ReferenceMap <V> singleton(final short key, V value) { return new Singleton <>(key, value); }
	...
	public static <V> Short2ReferenceMap <V> singleton(final Short key, final V value) { return new Singleton <>((key).shortValue(), (value)); }
	...
	public static class SynchronizedMap <V> extends Short2ReferenceFunctions.SynchronizedFunction <V> implements Short2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.short2ReferenceEntrySet(), sync); return entries; } }
	 ...
	 @Override
	 public V computeIfAbsentPartial(final short key, final Short2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 ...
	 */
	public static <V> Short2ReferenceMap <V> synchronize(final Short2ReferenceMap <V> m) { return new SynchronizedMap <>(m); }
	...
	public static <V> Short2ReferenceMap <V> synchronize(final Short2ReferenceMap <V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <V> extends Short2ReferenceFunctions.UnmodifiableFunction <V> implements Short2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final short key, final Short2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 ...
	 */
	public static <V> Short2ReferenceMap <V> unmodifiable(final Short2ReferenceMap <V> m) { return new UnmodifiableMap <>(m); }
