...
public final class Short2ByteSortedMaps {
	...
	public static class Singleton extends Short2ByteMaps.Singleton implements Short2ByteSortedMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public ObjectSortedSet<Short2ByteMap.Entry > short2ByteEntrySet() { if (entries == null) entries = ObjectSortedSets.singleton(new AbstractShort2ByteMap.BasicEntry (key, value), entryComparator(comparator)); return (ObjectSortedSet<Short2ByteMap.Entry >)entries; }
	...
	public static Short2ByteSortedMap singleton(final Short key, Byte value) { return new Singleton ((key).shortValue(), (value).byteValue());}
	...
	public static Short2ByteSortedMap singleton(final Short key, Byte value, ShortComparator comparator) { return new Singleton ((key).shortValue(), (value).byteValue(), comparator); }
