...
public class Short2CharRBTreeMap extends AbstractShort2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Short2CharMap.Entry > short2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2CharMap.Entry >() {
	   final Comparator<? super Short2CharMap.Entry > comparator = (Comparator<Short2CharMap.Entry >) (x, y) -> Short2CharRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
	   ...
	   @Override
	   public void clear() { Short2CharRBTreeMap.this.clear(); }
	...
	private final class Submap extends AbstractShort2CharSortedMap implements java.io.Serializable {
	 ...
	 public Submap(final short from, final boolean bottom, final short to, final boolean top) {
	  if (! bottom && ! top && Short2CharRBTreeMap.this.compare(from, to) > 0) throw new IllegalArgumentException("Start key (" + from + ") is larger than end key (" + to + ")");
	 ...
	 public ObjectSortedSet<Short2CharMap.Entry > short2CharEntrySet() {
	  if (entries == null) entries = new AbstractObjectSortedSet<Short2CharMap.Entry >() {
	    ...
	    @Override
	    public Comparator<? super Short2CharMap.Entry > comparator() { return Short2CharRBTreeMap.this.short2CharEntrySet().comparator(); }
	 ...
	 public boolean containsKey(final short k) { return in( k) && Short2CharRBTreeMap.this.containsKey(k); }
	 ...
	 private class SubmapIterator extends TreeIterator {
	  ...
	  void updatePrevious() {
	   prev = prev.prev();
	   if (! bottom && prev != null && Short2CharRBTreeMap.this.compare(prev.key, from) < 0) prev = null;
	  }

	  @Override
	  void updateNext() {
	   next = next.next();
	   if (! top && next != null && Short2CharRBTreeMap.this.compare(next.key, to) >= 0) next = null;
	  }
	 }
