...
public final class ShortBigListIterators {
	 ...
	 */
	public static ShortBigListIterator unmodifiable(final ShortBigListIterator i) { return new UnmodifiableBigListIterator (i); }
	...
	public static class BigListIteratorListIterator implements ShortBigListIterator {
	 ...
	 @Override
	 public void set(short ok) { i.set(ok); }

	 @Override
	 public void add(short ok) { i.add(ok); }
	  ...
	  */
	public static ShortBigListIterator asBigListIterator(final ShortListIterator i) { return new BigListIteratorListIterator (i); }
}
