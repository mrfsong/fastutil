...
public class Short2ByteOpenCustomHashMap extends AbstractShort2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2ByteOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ByteOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ByteOpenCustomHashMap(final Map<? extends Short, ? extends Byte> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ByteOpenCustomHashMap(final Map<? extends Short, ? extends Byte> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ByteOpenCustomHashMap(final Short2ByteMap m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Short2ByteOpenCustomHashMap(final Short2ByteMap m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Short2ByteOpenCustomHashMap(final short[] k, final byte[] v, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ByteOpenCustomHashMap(final short[] k, final byte[] v, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfAbsentNullable(final short k, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final int pos = find(k);
	 if (pos >= 0) return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfPresent(final short k, final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public byte compute(final short k, final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public byte merge(final short k, final byte v, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	final class MapEntry implements Short2ByteMap.Entry , Map.Entry<Short, Byte> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).shortValue()) ) ) && ( (value[index]) == ((e.getValue()).byteValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry > implements FastEntrySet {
	 ...
	 @Override
	 public ObjectIterator<Short2ByteMap.Entry > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Short2ByteMap.Entry > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), ((short)0) ) )) return Short2ByteOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Short2ByteMap.Entry > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractShort2ByteMap.BasicEntry (key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == ((short)0) )) consumer.accept(new AbstractShort2ByteMap.BasicEntry (key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2ByteOpenCustomHashMap.this.clear();}
	}
