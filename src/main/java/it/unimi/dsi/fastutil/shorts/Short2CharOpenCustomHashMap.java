...
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2CharOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2CharOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2CharOpenCustomHashMap(final Map<? extends Short, ? extends Character> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2CharOpenCustomHashMap(final Map<? extends Short, ? extends Character> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2CharOpenCustomHashMap(final Short2CharMap m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Short2CharOpenCustomHashMap(final Short2CharMap m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Short2CharOpenCustomHashMap(final short[] k, final char[] v, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2CharOpenCustomHashMap(final short[] k, final char[] v, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	final class MapEntry implements Short2CharMap.Entry , Map.Entry<Short, Character> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).shortValue()) ) ) && ( (value[index]) == ((e.getValue()).charValue()) );
	 }
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry > implements FastEntrySet {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), ((short)0) ) )) return Short2CharOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2CharOpenCustomHashMap.this.clear();}
	}
