...
public final class Short2DoubleFunctions {
	...
	public static class EmptyFunction extends AbstractShort2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double get(final short k) { return (0); }
	...
	public static class Singleton extends AbstractShort2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2DoubleFunction , java.io.Serializable {
	 ...
	 @Override
	 public Double apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public double put(final short k, final double v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public double get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public double remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Short2DoubleFunction synchronize(final Short2DoubleFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2DoubleFunction synchronize(final Short2DoubleFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2DoubleFunction implements java.io.Serializable {
	 ...
	 @Override
	 public double get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2DoubleFunction unmodifiable(final Short2DoubleFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2DoubleFunction {
	 ...
	 @Deprecated
	 @Override
	 public Double put(final Short key, final Double value) { throw new UnsupportedOperationException(); }
	}
