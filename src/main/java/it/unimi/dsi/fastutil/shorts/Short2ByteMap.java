...
public interface Short2ByteMap extends Short2ByteFunction , Map<Short,Byte> {
	...
	default byte replace(final short key, final byte value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default byte computeIfAbsentNullable(final short key, final java.util.function.IntFunction<? extends Byte> mappingFunction) {
	 java.util.Objects.requireNonNull(mappingFunction);
	 final byte v = get(key), drv = defaultReturnValue();
	 if (v != drv || containsKey(key)) return v;
	...
	default byte computeIfPresent(final short key, final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> remappingFunction) {
	...
	default byte compute(final short key, final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final byte oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default byte merge(final short key, final byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	...
	@Deprecated
	@Override
	default Byte computeIfAbsent(final Short key, final java.util.function.Function<? super Short, ? extends Byte> mappingFunction) {
