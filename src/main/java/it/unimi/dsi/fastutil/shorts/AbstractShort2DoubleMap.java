	...
	public static class BasicEntry implements Short2DoubleMap.Entry {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Short2DoubleMap.Entry) {
	   ...
	   return ( (key) == (e.getShortKey()) ) && ( Double.doubleToLongBits(value) == Double.doubleToLongBits(e.getDoubleValue()) );
	  }
	  ...
	  return ( (this.key) == (((Short)(key)).shortValue()) ) && ( Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double)(value)).doubleValue()) );
	 }
