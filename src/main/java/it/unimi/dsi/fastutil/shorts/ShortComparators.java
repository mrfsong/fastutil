...
public final class ShortComparators {
	...
	protected static class OppositeComparator implements ShortComparator , java.io.Serializable {
	 ...
	 protected OppositeComparator(final ShortComparator c) { comparator = c; }

	 @Override
	 public final int compare(final short a, final short b) { return comparator.compare(b, a); }
	};
	 ...
	 */
	public static ShortComparator oppositeComparator(final ShortComparator c) { return new OppositeComparator (c); }
	...
	public static ShortComparator asShortComparator(final Comparator<? super Short> c) {
	 if (c == null || c instanceof ShortComparator) return (ShortComparator) c;

	 return new ShortComparator() {
	   @Override
	   public int compare(short x, short y) { return c.compare(Short.valueOf(x), Short.valueOf(y)); }
	   @SuppressWarnings("deprecation")
	   @Override
	   public int compare(Short x, Short y) { return c.compare(x, y); }
	  };
	}
