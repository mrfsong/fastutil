...
public final class Short2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractShort2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final short k) { return (false); }
	...
	public static class Singleton extends AbstractShort2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	...
	public static class SynchronizedFunction implements Short2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean test(int operand) { synchronized(sync) { return function.test(operand); } }
	 ...
	 @Override
	 public Boolean apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 ...
	 @Override
	 public boolean put(final short k, final boolean v) { synchronized(sync) { return function.put(k, v); } }

	 @Override
	 public boolean get(final short k) { synchronized(sync) { return function.get(k); } }

	 @Override
	 public boolean remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 ...
	 */
	public static Short2BooleanFunction synchronize(final Short2BooleanFunction f) { return new SynchronizedFunction (f); }
	...
	public static Short2BooleanFunction synchronize(final Short2BooleanFunction f, final Object sync) { return new SynchronizedFunction (f, sync); }
	...
	public static class UnmodifiableFunction extends AbstractShort2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean get(final short k) { return function.get(k); }
	 ...
	 */
	public static Short2BooleanFunction unmodifiable(final Short2BooleanFunction f) { return new UnmodifiableFunction (f); }
	...
	public static class PrimitiveFunction implements Short2BooleanFunction {
	 ...
	 @Deprecated
	 @Override
	 public Boolean put(final Short key, final Boolean value) { throw new UnsupportedOperationException(); }
	}
	...
	public static Short2BooleanFunction primitive(final java.util.function.Function<? super Short, ? extends Boolean> f) {
	 java.util.Objects.requireNonNull(f);

	 if (f instanceof Short2BooleanFunction) return (Short2BooleanFunction ) f;
