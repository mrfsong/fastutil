...
public class Short2ReferenceOpenCustomHashMap <V> extends AbstractShort2ReferenceMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2ReferenceOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ReferenceOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ReferenceOpenCustomHashMap(final Map<? extends Short, ? extends V> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ReferenceOpenCustomHashMap(final Map<? extends Short, ? extends V> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ReferenceOpenCustomHashMap(final Short2ReferenceMap <V> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	public Short2ReferenceOpenCustomHashMap(final Short2ReferenceMap <V> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	...
	public Short2ReferenceOpenCustomHashMap(final short[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public Short2ReferenceOpenCustomHashMap(final short[] k, final V[] v, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 @Override
	 public ObjectIterator<Short2ReferenceMap.Entry <V> > iterator() { return new EntryIterator(); }

	 @Override
	 public ObjectIterator<Short2ReferenceMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), ((short)0) ) )) return Short2ReferenceOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	 ...
	 public void forEach(final Consumer<? super Short2ReferenceMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractShort2ReferenceMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == ((short)0) )) consumer.accept(new AbstractShort2ReferenceMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2ReferenceOpenCustomHashMap.this.clear();}
	}
